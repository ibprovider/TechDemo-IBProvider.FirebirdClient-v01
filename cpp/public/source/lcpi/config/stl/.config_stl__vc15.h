...
#ifndef _cpp_public_lcpi_config__config_stl__vc15_H_
#define _cpp_public_lcpi_config__config_stl__vc15_H_
...
//------------------------------------------------------------------------
#define LCPI_STL_HAS_ENABLE_IF                         1

//------------------------------------------------------------------------
#define LCPI_STL_HAS_NEGATION                          1

//------------------------------------------------------------------------
#define LCPI_STL_TO_STRING(value) ::std::to_string(value)

//------------------------------------------------------------------------
#define LCPI_STL_TO_WSTRING(value) ::std::to_wstring(value)
