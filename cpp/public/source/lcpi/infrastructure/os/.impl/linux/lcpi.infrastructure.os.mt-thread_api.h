...
#ifndef _lcpi_infrastructure_os_mt_impl_linux__thread_api_H_
#define _lcpi_infrastructure_os_mt_impl_linux__thread_api_H_
...
class LCPI_OS__ThreadApi LCPI_CPP_CFG__CLASS__FINAL
{
 ...
 public: //Thread functions ----------------------------------------------
  using THREAD_ROUTINE=void* (*) (void* pArg);
