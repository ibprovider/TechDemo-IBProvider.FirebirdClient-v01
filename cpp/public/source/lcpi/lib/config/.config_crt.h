...
#ifndef _cpp_public_lcpi_lib__config_crt_H_
#define _cpp_public_lcpi_lib__config_crt_H_

#include <lcpi/config/.config.h>
...
# include <lcpi/lib/config/crt/.config_crt__vc9.h>
#else
