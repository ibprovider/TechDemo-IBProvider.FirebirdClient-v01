...
#ifndef _cpp_public_lcpi_lib_structure__t_list_external_H_
#define _cpp_public_lcpi_lib_structure__t_list_external_H_
...
template<class ListTraits,class TBase=t_list_external_base__with_size>
...
#ifndef NDEBUG
  void debug__verify_size__eq(size_type x)const;

  void debug__verify_size__eq_or_large(size_type x)const;
#endif
 ...
 :public TBase
{
 ...
 private:
#ifndef NDEBUG
  void debug__verify(const traits_type& traits)const;

  void debug__verify_item(const traits_type& traits,
...
{
 private:
  using self_type=t_list_external__traits_std<TNode>;
...
////////////////////////////////////////////////////////////////////////////////
#include <lcpi/lib/structure/t_list_external.cc>
////////////////////////////////////////////////////////////////////////////////
#endif
