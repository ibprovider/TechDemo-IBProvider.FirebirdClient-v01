...
struct t_char_traits2<char>
{
 ...
 public:
  static char_type* int_to_str(int value,char_type* s,size_type n,int radix)
   {
    LCPI__VERIFY_EQ(LCPI_GCRT_itoa_s(value,s,n,radix),0L);
  ...
  static char_type* long_to_str(long value,char_type* s,size_type n,int radix)
   {
    LCPI__VERIFY_EQ(LCPI_GCRT_ltoa_s(value,s,n,radix),0L);
  ...
  static char_type* ulong_to_str(unsigned long value,char_type* s,size_type n,int radix)
   {
    LCPI__VERIFY_EQ(LCPI_GCRT_ultoa_s(value,s,n,radix),0L);
  ...
  static char_type* int64_to_str(__int64 value,char_type* s,size_type n,int radix)
   {
    LCPI__VERIFY_EQ(LCPI_GCRT_i64toa_s(value,s,n,radix),0L);
  ...
  static char_type* uint64_to_str(unsigned __int64 value,char_type* s,size_type n,int radix)
   {
    LCPI__VERIFY_EQ(LCPI_GCRT_ui64toa_s(value,s,n,radix),0L);
...
struct t_char_traits2<wchar_t>
{
 ...
 public:
  static char_type* int_to_str(int value,char_type* s,size_type n,int radix)
   {
    LCPI__VERIFY_EQ(LCPI_GCRT_itow_s(value,s,n,radix),0L);
  ...
  static char_type* long_to_str(long value,char_type* s,size_type n,int radix)
   {
    LCPI__VERIFY_EQ(LCPI_GCRT_ltow_s(value,s,n,radix),0L);
  ...
  static char_type* ulong_to_str(unsigned long value,char_type* s,size_type n,int radix)
   {
    LCPI__VERIFY_EQ(LCPI_GCRT_ultow_s(value,s,n,radix),0L);
  ...
  static char_type* int64_to_str(__int64 value,char_type* s,size_type n,int radix)
   {
    LCPI__VERIFY_EQ(LCPI_GCRT_i64tow_s(value,s,n,radix),0L);
  ...
  static char_type* uint64_to_str(unsigned __int64 value,char_type* s,size_type n,int radix)
   {
    LCPI__VERIFY_EQ(LCPI_GCRT_ui64tow_s(value,s,n,radix),0L);
...
////////////////////////////////////////////////////////////////////////////////
#include <lcpi/lib/structure/t_char_traits2.cc>
////////////////////////////////////////////////////////////////////////////////
#endif
