////////////////////////////////////////////////////////////////////////////////
//Type converter ARRAY|TYPE->ARRAY|STR
//                                                 Kovalenko Dmitry. 29.05.2008
////////////////////////////////////////////////////////////////////////////////

HRESULT OLEDB_TYPE_CONVERTER_NAME(array_common,array_str)::internal__convert_value_to_array
                                             ...
                                             result_type*   const result)const
{
 ...
 assert(m_wToType==(DBTYPE_ARRAY|DBTYPE_STR));
 ...
 typedef DBVARIANT::value_cpp_str_n_type                            string_n_type;
 ...
 for(size_t x=0;x!=n;++x)
 {
  ...
  const HRESULT cvt_hr=DBVariant__to_STR_ex(pConvCtx,UnpackSourceElement,&tmp_str);
