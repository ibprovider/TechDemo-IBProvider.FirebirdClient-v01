////////////////////////////////////////////////////////////////////////////////
//Type converter DBTYPE_BYTES->IUnknown implementation.
//                                                  Kovalenko Dmitry, 24.04.2008
////////////////////////////////////////////////////////////////////////////////

HRESULT OLEDB_TYPE_CONVERTER_NAME(bytes,iunknown)::internal__convert_value_to_iunknown
                                             ...
                                             result_type*   const result)const
{
 ...
 //default stream
 return impl_helper::Create_DEFAULT_SEQ_STREAM(dbvar.bytesVal.byte_count(),
                                               dbvar.bytesVal.ptr,
                                               result_iid,
                                               result);
...
//------------------------------------------------------------------------
bool OLEDB_TYPE_CONVERTER_NAME(bytes,iunknown)::CanConvertTo
                                            (LPCCONVCONTEXT const /*pConvCtx*/,
...
//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_CONVERTER_OBJ(bytes,iunknown)
