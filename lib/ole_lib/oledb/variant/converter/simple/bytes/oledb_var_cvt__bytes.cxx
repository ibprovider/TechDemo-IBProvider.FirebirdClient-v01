////////////////////////////////////////////////////////////////////////////////
//Include implementation DBTYPE_BYTES type converters.
//                                                     Roman Piminov, 14.03.2008
////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes.hxx>

////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__error.cxx>

#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__i1.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__i2.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__i4.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__i8.cxx>

#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__ui1.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__ui2.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__ui4.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__ui8.cxx>

#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__r4.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__r8.cxx>

#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__cy.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__decimal.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__numeric.cxx>

#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__date.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__filetime.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__dbdate.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__dbtime.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__dbtime2.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__dbtimestamp.cxx>

#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__str.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__wstr.cxx>
#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__bstr.cxx>

#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__bool.cxx>

#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__guid.cxx>

#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__bytes.cxx>

#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__variant.cxx>

#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__iunknown.cxx>

#include <ole_lib/oledb/variant/converter/simple/bytes/oledb_var_cvt__bytes__array_ui1.cxx>

////////////////////////////////////////////////////////////////////////////////

static const DBVARIANT::LPCTYPECONVERTER g_converters__bytes_to_simple[146]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
/*  2*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,i2)                 //I2
/*  3*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,i4)                 //I4
/*  4*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,r4)                 //R4
/*  5*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,r8)                 //R8
/*  6*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,cy)                 //CY
/*  7*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,date)               //DATE
/*  8*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,bstr)               //BSTR
/*  9*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(9)                    //IDISPATCH
/* 10*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,error)              //ERROR
/* 11*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,bool)               //BOOL
/* 12*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,variant)            //VARIANT
/* 13*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,iunknown)           //IUNKNOWN
/* 14*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,decimal)            //DECIMAL
/* 15*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(15)
/* 16*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,i1)                 //I1
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,ui1)                //UI1
/* 18*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,ui2)                //UI2
/* 19*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,ui4)                //UI4
/* 20*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,i8)                 //I8
/* 21*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,ui8)                //UI8
...
/* 64*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,filetime)           //FILETIME
...
/* 72*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,guid)               //GUID
...
/*128*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,bytes)              //BYTES
/*129*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,str)                //STR
/*130*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,wstr)               //WSTR
/*131*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,numeric)            //NUMERIC
/*132*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(132)                  //UDT
/*133*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,dbdate)             //DBDATE
/*134*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,dbtime)             //DBTIME
/*135*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,dbtimestamp)        //DBTIMESTAMP
...
/*145*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,dbtime2)            //DBTIME2
};//g_converters__bytes_to_simple

//------------------------------------------------------------------------
static const DBVARIANT::LPCTYPECONVERTER g_converters__bytes_to_array[18]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
...
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bytes,array_ui1)          //UI1
};//g_converters__bytes_to_array
