////////////////////////////////////////////////////////////////////////////////
//Type converter DBTYPE_UI1->IUnknown implementation.
//                                                  Kovalenko Dmitry, 24.04.2008
////////////////////////////////////////////////////////////////////////////////

HRESULT OLEDB_TYPE_CONVERTER_NAME(ui1,iunknown)::internal__convert_value_to_iunknown
                                             ...
                                             result_type*   const result)const
{
 ...
 return impl_helper::Create_DEFAULT_SEQ_STREAM(sizeof(dbvar.valUI1),
                                               &dbvar.valUI1,
                                               result_iid,
                                               result);
...
//------------------------------------------------------------------------
bool OLEDB_TYPE_CONVERTER_NAME(ui1,iunknown)::CanConvertTo
                                            (LPCCONVCONTEXT const /*pConvCtx*/,
...
//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_CONVERTER_OBJ(ui1,iunknown)
