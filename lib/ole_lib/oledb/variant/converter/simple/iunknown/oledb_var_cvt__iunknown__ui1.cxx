////////////////////////////////////////////////////////////////////////////////
//Type converter DBTYPE_IUNKNOWN->ui1 implementation.
//                                                     Roman Piminov, 04.04.2008
////////////////////////////////////////////////////////////////////////////////
//class tag_cvt_funcs

class OLEDB_TYPE_CONVERTER_NAME(iunknown,ui1)::tag_cvt_funcs
{
 public: //typedefs ------------------------------------------------------
  typedef OLEDB_TYPE_CONVERTER_NAME(iunknown,ui1)::LPCCONVCONTEXT LPCCONVCONTEXT;
  typedef OLEDB_TYPE_CONVERTER_NAME(iunknown,ui1)::result_type    result_type;
...
HRESULT OLEDB_TYPE_CONVERTER_NAME(iunknown,ui1)::internal__convert_value_to_ui1
                                            (LPCCONVCONTEXT const pConvCtx,
...
//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_CONVERTER_OBJ(iunknown,ui1)
