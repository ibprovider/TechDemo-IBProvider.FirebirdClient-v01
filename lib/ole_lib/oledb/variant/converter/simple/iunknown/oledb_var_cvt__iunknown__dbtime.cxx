////////////////////////////////////////////////////////////////////////////////
//Type converter DBTYPE_IUNKNOWN->dbtime implementation.
//                                                     Roman Piminov, 23.04.2008
////////////////////////////////////////////////////////////////////////////////
//class tag_cvt_funcs

class OLEDB_TYPE_CONVERTER_NAME(iunknown,dbtime)::tag_cvt_funcs
{
 public: //typedefs ------------------------------------------------------
  typedef OLEDB_TYPE_CONVERTER_NAME(iunknown,dbtime)::LPCCONVCONTEXT LPCCONVCONTEXT;
  typedef OLEDB_TYPE_CONVERTER_NAME(iunknown,dbtime)::result_type    result_type;
...
HRESULT OLEDB_TYPE_CONVERTER_NAME(iunknown,dbtime)::internal__convert_value_to_dbtime
                                            (LPCCONVCONTEXT const pConvCtx,
...
//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_CONVERTER_OBJ(iunknown,dbtime)
