////////////////////////////////////////////////////////////////////////////////
//Type converter DBTYPE_IUNKNOWN->r8 implementation.
//                                                     Roman Piminov, 03.04.2008
////////////////////////////////////////////////////////////////////////////////
//class tag_cvt_funcs

class OLEDB_TYPE_CONVERTER_NAME(iunknown,r8)::tag_cvt_funcs
{
 public: //typedefs ------------------------------------------------------
  typedef OLEDB_TYPE_CONVERTER_NAME(iunknown,r8)::LPCCONVCONTEXT LPCCONVCONTEXT;
  typedef OLEDB_TYPE_CONVERTER_NAME(iunknown,r8)::result_type    result_type;
...
HRESULT OLEDB_TYPE_CONVERTER_NAME(iunknown,r8)::internal__convert_value_to_r8
                                            (LPCCONVCONTEXT const pConvCtx,
...
//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_CONVERTER_OBJ(iunknown,r8)
