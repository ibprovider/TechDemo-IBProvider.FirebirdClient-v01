////////////////////////////////////////////////////////////////////////////////
//Type converter DBTYPE_IUNKNOWN->i4 implementation.
//                                                     Roman Piminov, 01.04.2008
////////////////////////////////////////////////////////////////////////////////
//class tag_cvt_funcs

class OLEDB_TYPE_CONVERTER_NAME(iunknown,i4)::tag_cvt_funcs
{
 public: //typedefs ------------------------------------------------------
  typedef OLEDB_TYPE_CONVERTER_NAME(iunknown,i4)::LPCCONVCONTEXT LPCCONVCONTEXT;
  typedef OLEDB_TYPE_CONVERTER_NAME(iunknown,i4)::result_type    result_type;
...
HRESULT OLEDB_TYPE_CONVERTER_NAME(iunknown,i4)::internal__convert_value_to_i4
                                            (LPCCONVCONTEXT const pConvCtx,
...
//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_CONVERTER_OBJ(iunknown,i4)
