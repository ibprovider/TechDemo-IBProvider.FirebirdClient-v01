////////////////////////////////////////////////////////////////////////////////
//Include implementation DBTYPE_WSTR type converters.
//                                                     Roman Piminov, 14.03.2008
////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr.hxx>

////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__i1.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__i2.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__i4.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__i8.cxx>

#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__ui1.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__ui2.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__ui4.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__ui8.cxx>

#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__r4.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__r8.cxx>

#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__cy.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__decimal.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__numeric.cxx>

#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__date.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__dbdate.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__dbtime.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__dbtime2.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__dbtimestamp.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__filetime.cxx>

#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__str.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__wstr.cxx>
#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__bstr.cxx>

#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__bool.cxx>

#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__guid.cxx>

#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__bytes.cxx>

#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__iunknown.cxx>

#include <ole_lib/oledb/variant/converter/simple/wstr/oledb_var_cvt__wstr__array_ui1.cxx>

////////////////////////////////////////////////////////////////////////////////

static const DBVARIANT::LPCTYPECONVERTER g_converters__wstr_to_simple[146]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
/*  2*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,i2)                  //I2
/*  3*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,i4)                  //I4
/*  4*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,r4)                  //R4
/*  5*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,r8)                  //R8
/*  6*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,cy)                  //CY
/*  7*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,date)                //DATE
/*  8*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,bstr)                //BSTR
/*  9*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(9)                    //IDISPATCH
/* 10*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(10)                   //ERROR
/* 11*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,bool)                //BOOL
/* 12*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(common,variant)           //VARIANT
/* 13*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,iunknown)            //IUNKNOWN
/* 14*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,decimal)             //DECIMAL
/* 15*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(15)
/* 16*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,i1)                  //I1
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,ui1)                 //UI1
/* 18*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,ui2)                 //UI2
/* 19*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,ui4)                 //UI4
/* 20*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,i8)                  //I8
/* 21*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,ui8)                 //UI8
...
/* 64*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,filetime)            //FILETIME
...
/* 72*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,guid)                //GUID
...
/*128*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,bytes)               //BYTES
/*129*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,str)                 //STR
/*130*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,wstr)                //WSTR
/*131*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,numeric)             //NUMERIC
/*132*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(132)                  //UDT
/*133*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,dbdate)              //DBDATE
/*134*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,dbtime)              //DBTIME
/*135*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,dbtimestamp)         //DBTIMESTAMP
...
/*145*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,dbtime2)             //DBTIME2
};//g_converters__wstr_to_simple

//------------------------------------------------------------------------
static const DBVARIANT::LPCTYPECONVERTER g_converters__wstr_to_array[18]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
...
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(wstr,array_ui1)           //UI1
};//g_converters__wstr_to_array
