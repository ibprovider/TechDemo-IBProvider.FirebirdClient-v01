////////////////////////////////////////////////////////////////////////////////
//Include implementation DBTYPE_I2 type converters.
//                                                     Roman Piminov, 14.03.2008
////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2.hxx>

////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__i1.cxx>
#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__i2.cxx>
#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__i4.cxx>
#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__i8.cxx>

#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__ui1.cxx>
#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__ui2.cxx>
#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__ui4.cxx>
#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__ui8.cxx>

#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__r4.cxx>
#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__r8.cxx>

#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__cy.cxx>
#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__decimal.cxx>
#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__numeric.cxx>

#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__str.cxx>
#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__wstr.cxx>
#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__bstr.cxx>

#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__bool.cxx>

#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__bytes.cxx>

#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__variant.cxx>

#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__iunknown.cxx>

#include <ole_lib/oledb/variant/converter/simple/i2/oledb_var_cvt__i2__array_ui1.cxx>

////////////////////////////////////////////////////////////////////////////////

static const DBVARIANT::LPCTYPECONVERTER g_converters__i2_to_simple[/*146*/]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
/*  2*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,i2)                    //I2
/*  3*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,i4)                    //I4
/*  4*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,r4)                    //R4
/*  5*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,r8)                    //R8
/*  6*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,cy)                    //CY
/*  7*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(7)                    //DATE
/*  8*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,bstr)                  //BSTR
/*  9*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(9)                    //IDISPATCH
/* 10*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(10)                   //ERROR
/* 11*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,bool)                  //BOOL
/* 12*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,variant)               //VARIANT
/* 13*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,iunknown)              //IUNKNOWN
/* 14*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,decimal)               //DECIMAL
/* 15*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(15)
/* 16*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,i1)                    //I1
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,ui1)                   //UI1
/* 18*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,ui2)                   //UI2
/* 19*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,ui4)                   //UI4
/* 20*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,i8)                    //I8
/* 21*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,ui8)                   //UI8
...
/*128*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,bytes)                 //BYTES
/*129*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,str)                   //STR
/*130*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,wstr)                  //WSTR
/*131*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,numeric)               //NUMERIC
#if 0
...
#endif
};//g_converters__i2_to_simple

//------------------------------------------------------------------------
static const DBVARIANT::LPCTYPECONVERTER g_converters__i2_to_array[18]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
...
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(i2,array_ui1)             //UI1
};//g_converters__i2_to_array
