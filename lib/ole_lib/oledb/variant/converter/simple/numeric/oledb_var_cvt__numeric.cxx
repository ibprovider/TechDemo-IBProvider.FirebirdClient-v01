////////////////////////////////////////////////////////////////////////////////
//Include implementation DBTYPE_NUMERIC type converters.
//                                                     Roman Piminov, 14.03.2008
////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric.hxx>

////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__i1.cxx>
#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__i2.cxx>
#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__i4.cxx>
#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__i8.cxx>

#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__ui1.cxx>
#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__ui2.cxx>
#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__ui4.cxx>
#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__ui8.cxx>

#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__r4.cxx>
#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__r8.cxx>

#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__cy.cxx>
#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__decimal.cxx>
#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__numeric.cxx>

#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__str.cxx>
#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__wstr.cxx>

#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__bool.cxx>

#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__bytes.cxx>

#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__variant.cxx>

#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__iunknown.cxx>

#include <ole_lib/oledb/variant/converter/simple/numeric/oledb_var_cvt__numeric__array_ui1.cxx>

////////////////////////////////////////////////////////////////////////////////

static const DBVARIANT::LPCTYPECONVERTER g_converters__numeric_to_simple[/*146*/]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
/*  2*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,i2)               //I2
/*  3*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,i4)               //I4
/*  4*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,r4)               //R4
/*  5*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,r8)               //R8
/*  6*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,cy)               //CY
...
/* 11*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,bool)             //BOOL
/* 12*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,variant)          //VARIANT
/* 13*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,iunknown)         //IUNKNOWN
/* 14*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,decimal)          //DECIMAL
/* 15*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(15)
/* 16*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,i1)               //I1
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,ui1)              //UI1
/* 18*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,ui2)              //UI2
/* 19*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,ui4)              //UI4
/* 20*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,i8)               //I8
/* 21*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,ui8)              //UI8
...
/*128*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,bytes)            //BYTES
/*129*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,str)              //STR
/*130*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,wstr)             //WSTR
/*131*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,numeric)          //NUMERIC
#if 0
...
#endif
};//g_converters__numeric_to_simple

//------------------------------------------------------------------------
static const DBVARIANT::LPCTYPECONVERTER g_converters__numeric_to_array[18]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
...
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(numeric,array_ui1)        //UI1
};//g_converters__numeric_to_array
