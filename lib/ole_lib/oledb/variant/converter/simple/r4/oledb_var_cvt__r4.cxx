////////////////////////////////////////////////////////////////////////////////
//Include implementation DBTYPE_R4 type converters.
//                                                     Roman Piminov, 14.03.2008
////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4.hxx>

////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__i1.cxx>
#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__i2.cxx>
#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__i4.cxx>
#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__i8.cxx>

#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__ui1.cxx>
#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__ui2.cxx>
#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__ui4.cxx>
#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__ui8.cxx>

#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__r4.cxx>
#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__r8.cxx>

#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__cy.cxx>
#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__decimal.cxx>
#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__numeric.cxx>

#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__str.cxx>
#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__wstr.cxx>
#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__bstr.cxx>

#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__bool.cxx>

#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__bytes.cxx>

#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__variant.cxx>

#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__iunknown.cxx>

#include <ole_lib/oledb/variant/converter/simple/r4/oledb_var_cvt__r4__array_ui1.cxx>

////////////////////////////////////////////////////////////////////////////////

static const DBVARIANT::LPCTYPECONVERTER g_converters__r4_to_simple[/*146*/]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
/*  2*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,i2)                    //I2
/*  3*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,i4)                    //I4
/*  4*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,r4)                    //R4
/*  5*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,r8)                    //R8
/*  6*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,cy)                    //CY
/*  7*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(7)                    //DATE
/*  8*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,bstr)                  //BSTR
/*  9*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(9)                    //IDISPATCH
/* 10*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(10)                   //ERROR
/* 11*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,bool)                  //BOOL
/* 12*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,variant)               //VARIANT
/* 13*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,iunknown)              //IUNKNOWN
/* 14*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,decimal)               //DECIMAL
/* 15*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(15)
/* 16*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,i1)                    //I1
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,ui1)                   //UI1
/* 18*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,ui2)                   //UI2
/* 19*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,ui4)                   //UI4
/* 20*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,i8)                    //I8
/* 21*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,ui8)                   //UI8
...
/*128*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,bytes)                 //BYTES
/*129*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,str)                   //STR
/*130*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,wstr)                  //WSTR
/*131*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,numeric)               //NUMERIC
#if 0
...
#endif
};//g_converters__r4_to_simple

//------------------------------------------------------------------------
static const DBVARIANT::LPCTYPECONVERTER g_converters__r4_to_array[18]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
...
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(r4,array_ui1)             //UI1
};//g_converters__r4_to_array
