////////////////////////////////////////////////////////////////////////////////
//Type converter DBTYPE_UI8->IUnknown implementation.
//                                                  Kovalenko Dmitry, 24.04.2008
////////////////////////////////////////////////////////////////////////////////

HRESULT OLEDB_TYPE_CONVERTER_NAME(ui8,iunknown)::internal__convert_value_to_iunknown
                                             ...
                                             result_type*   const result)const
{
 ...
 //default stream
 return impl_helper::Create_DEFAULT_SEQ_STREAM(sizeof(dbvar.valUI8),
                                               &dbvar.valUI8,
                                               result_iid,
                                               result);
...
//------------------------------------------------------------------------
bool OLEDB_TYPE_CONVERTER_NAME(ui8,iunknown)::CanConvertTo
                                            (LPCCONVCONTEXT const /*pConvCtx*/,
...
//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_CONVERTER_OBJ(ui8,iunknown)
