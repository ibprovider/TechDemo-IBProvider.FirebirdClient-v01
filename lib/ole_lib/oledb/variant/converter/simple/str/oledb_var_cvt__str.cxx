////////////////////////////////////////////////////////////////////////////////
//Include implementation DBTYPE_STR type converters.
//                                                     Roman Piminov, 14.03.2008
////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str.hxx>

////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__i1.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__i2.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__i4.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__i8.cxx>

#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__ui1.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__ui2.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__ui4.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__ui8.cxx>

#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__r4.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__r8.cxx>

#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__cy.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__decimal.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__numeric.cxx>

#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__date.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__dbdate.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__dbtime.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__dbtime2.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__dbtimestamp.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__filetime.cxx>

#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__str.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__wstr.cxx>
#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__bstr.cxx>

#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__bool.cxx>

#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__guid.cxx>

#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__bytes.cxx>

#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__iunknown.cxx>

#include <ole_lib/oledb/variant/converter/simple/str/oledb_var_cvt__str__array_ui1.cxx>

////////////////////////////////////////////////////////////////////////////////

static const DBVARIANT::LPCTYPECONVERTER g_converters__str_to_simple[146]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
/*  2*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,i2)                   //I2
/*  3*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,i4)                   //I4
/*  4*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,r4)                   //R4
/*  5*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,r8)                   //R8
/*  6*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,cy)                   //CY
/*  7*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,date)                 //DATE
/*  8*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,bstr)                 //BSTR
/*  9*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(9)                    //IDISPATCH
/* 10*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(10)                   //ERROR
/* 11*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,bool)                 //BOOL
/* 12*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(common,variant)           //VARIANT
/* 13*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,iunknown)             //IUNKNOWN
/* 14*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,decimal)              //DECIMAL
/* 15*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(15)
/* 16*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,i1)                   //I1
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,ui1)                  //UI1
/* 18*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,ui2)                  //UI2
/* 19*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,ui4)                  //UI4
/* 20*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,i8)                   //I8
/* 21*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,ui8)                  //UI8
...
/* 64*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,filetime)             //FILETIME
...
/* 72*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,guid)                 //GUID
...
/*128*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,bytes)                //BYTES
/*129*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,str)                  //STR
/*130*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,wstr)                 //WSTR
/*131*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,numeric)              //NUMERIC
/*132*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(132)                  //UDT
/*133*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,dbdate)               //DBDATE
/*134*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,dbtime)               //DBTIME
/*135*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,dbtimestamp)          //DBTIMESTAMP
...
/*145*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,dbtime2)              //DBTIME2
};//g_converters__str_to_simple

//------------------------------------------------------------------------
static const DBVARIANT::LPCTYPECONVERTER g_converters__str_to_array[18]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
...
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(str,array_ui1)            //UI1
};//g_converters__str_to_array
