////////////////////////////////////////////////////////////////////////////////
//Include implementation DBTYPE_FILETIME type converters.
//                                                 Kovalenko Dmitry, 25.04.2008
////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/filetime/oledb_var_cvt__filetime.hxx>

////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/filetime/oledb_var_cvt__filetime__date.cxx>
#include <ole_lib/oledb/variant/converter/simple/filetime/oledb_var_cvt__filetime__filetime.cxx>
#include <ole_lib/oledb/variant/converter/simple/filetime/oledb_var_cvt__filetime__dbdate.cxx>
#include <ole_lib/oledb/variant/converter/simple/filetime/oledb_var_cvt__filetime__dbtime.cxx>
#include <ole_lib/oledb/variant/converter/simple/filetime/oledb_var_cvt__filetime__dbtime2.cxx>
#include <ole_lib/oledb/variant/converter/simple/filetime/oledb_var_cvt__filetime__dbtimestamp.cxx>

#include <ole_lib/oledb/variant/converter/simple/filetime/oledb_var_cvt__filetime__str.cxx>

#include <ole_lib/oledb/variant/converter/simple/filetime/oledb_var_cvt__filetime__bytes.cxx>

#include <ole_lib/oledb/variant/converter/simple/filetime/oledb_var_cvt__filetime__variant.cxx>

#include <ole_lib/oledb/variant/converter/simple/filetime/oledb_var_cvt__filetime__iunknown.cxx>

#include <ole_lib/oledb/variant/converter/simple/filetime/oledb_var_cvt__filetime__array_ui1.cxx>

////////////////////////////////////////////////////////////////////////////////

static const DBVARIANT::LPCTYPECONVERTER g_converters__filetime_to_simple[146]=
{
...
/*  7*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(filetime,date)            //DATE
...
/* 12*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(filetime,variant)         //VARIANT
/* 13*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(filetime,iunknown)        //IUNKNOWN
...
/* 64*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(filetime,filetime)        //FILETIME
...
/*128*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(filetime,bytes)           //BYTES
/*129*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(filetime,str)             //STR
...
/*133*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(filetime,dbdate)          //DBDATE
/*134*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(filetime,dbtime)          //DBTIME
/*135*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(filetime,dbtimestamp)     //DBTIMESTAMP
...
/*145*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(filetime,dbtime2)         //DBTIME2
};//g_converters__filetime_to_simple

//------------------------------------------------------------------------
static const DBVARIANT::LPCTYPECONVERTER g_converters__filetime_to_array[18]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
/*  2*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(2)                    //I2
...
/* 15*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(15)
/* 16*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(16)                   //I1
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(filetime,array_ui1)       //UI1
};//g_converters__filetime_to_array
