////////////////////////////////////////////////////////////////////////////////
//Include implementation DBTYPE_DECIMAL type converters.
//                                                     Roman Piminov, 14.03.2008
////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal.hxx>

////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__i1.cxx>
#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__i2.cxx>
#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__i4.cxx>
#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__i8.cxx>

#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__ui1.cxx>
#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__ui2.cxx>
#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__ui4.cxx>
#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__ui8.cxx>

#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__r4.cxx>
#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__r8.cxx>

#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__cy.cxx>
#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__decimal.cxx>
#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__numeric.cxx>

#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__str.cxx>
#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__wstr.cxx>

#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__bool.cxx>

#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__bytes.cxx>

#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__variant.cxx>

#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__iunknown.cxx>

#include <ole_lib/oledb/variant/converter/simple/decimal/oledb_var_cvt__decimal__array_ui1.cxx>

////////////////////////////////////////////////////////////////////////////////

static const DBVARIANT::LPCTYPECONVERTER g_converters__decimal_to_simple[/*146*/]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
/*  2*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,i2)               //I2
/*  3*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,i4)               //I4
/*  4*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,r4)               //R4
/*  5*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,r8)               //R8
/*  6*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,cy)               //CY
...
/* 11*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,bool)             //BOOL
/* 12*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,variant)          //VARIANT
/* 13*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,iunknown)         //IUNKNOWN
/* 14*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,decimal)          //DECIMAL
/* 15*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(15)
/* 16*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,i1)               //I1
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,ui1)              //UI1
/* 18*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,ui2)              //UI2
/* 19*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,ui4)              //UI4
/* 20*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,i8)               //I8
/* 21*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,ui8)              //UI8
...
/*128*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,bytes)            //BYTES
/*129*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,str)              //STR
/*130*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,wstr)             //WSTR
/*131*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,numeric)          //NUMERIC
#if 0
...
#endif
};//g_converters__decimal_to_simple

//------------------------------------------------------------------------
static const DBVARIANT::LPCTYPECONVERTER g_converters__decimal_to_array[18]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
...
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(decimal,array_ui1)        //UI1
};//g_converters__decimal_to_array
