////////////////////////////////////////////////////////////////////////////////
//Include implementation DBTYPE_BSTR type converters.
//                                                     Roman Piminov, 14.03.2008
////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr.hxx>

////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__i1.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__i2.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__i4.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__i8.cxx>

#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__ui1.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__ui2.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__ui4.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__ui8.cxx>

#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__r4.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__r8.cxx>

#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__cy.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__decimal.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__numeric.cxx>

#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__date.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__dbdate.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__dbtime.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__dbtime2.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__dbtimestamp.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__filetime.cxx>

#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__str.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__wstr.cxx>
#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__bstr.cxx>

#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__bool.cxx>

#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__guid.cxx>

#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__bytes.cxx>

#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__iunknown.cxx>

#include <ole_lib/oledb/variant/converter/simple/bstr/oledb_var_cvt__bstr__array_ui1.cxx>

////////////////////////////////////////////////////////////////////////////////

static const DBVARIANT::LPCTYPECONVERTER g_converters__bstr_to_simple[146]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
/*  2*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,i2)                  //I2
/*  3*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,i4)                  //I4
/*  4*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,r4)                  //R4
/*  5*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,r8)                  //R8
/*  6*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,cy)                  //CY
/*  7*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,date)                //DATE
/*  8*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,bstr)                //BSTR
/*  9*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(9)                    //IDISPATCH
/* 10*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(10)                   //ERROR
/* 11*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,bool)                //BOOL
/* 12*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(common,variant)           //VARIANT
/* 13*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,iunknown)            //IUNKNOWN
/* 14*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,decimal)             //DECIMAL
/* 15*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(15)
/* 16*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,i1)                  //I1
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,ui1)                 //UI1
/* 18*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,ui2)                 //UI2
/* 19*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,ui4)                 //UI4
/* 20*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,i8)                  //I8
/* 21*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,ui8)                 //UI8
...
/* 64*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,filetime)            //FILETIME
...
/* 72*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,guid)                //GUID
...
/*128*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,bytes)               //BYTES
/*129*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,str)                 //STR
/*130*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,wstr)                //WSTR
/*131*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,numeric)             //NUMERIC
/*132*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(132)                  //UDT
/*133*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,dbdate)              //DBDATE
/*134*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,dbtime)              //DBTIME
/*135*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,dbtimestamp)         //DBTIMESTAMP
...
/*145*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,dbtime2)             //DBTIME2
};//g_converters__bstr_to_simple

//------------------------------------------------------------------------
static const DBVARIANT::LPCTYPECONVERTER g_converters__bstr_to_array[18]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
...
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(bstr,array_ui1)           //UI1
};//g_converters__bstr_to_array
