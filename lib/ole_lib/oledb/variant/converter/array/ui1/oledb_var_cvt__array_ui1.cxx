////////////////////////////////////////////////////////////////////////////////
//Include implementation DBTYPE_ARRAY|DBTYPE_UI1 type converters.
//                                                  Dmitry Kovalenko, 14.03.2008
////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1.hxx>

////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__error.cxx>

#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__i1.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__i2.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__i4.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__i8.cxx>

#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__ui1.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__ui2.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__ui4.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__ui8.cxx>

#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__r4.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__r8.cxx>

#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__cy.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__decimal.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__numeric.cxx>

#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__date.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__filetime.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__dbdate.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__dbtime.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__dbtime2.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__dbtimestamp.cxx>

#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__str.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__wstr.cxx>
#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__bstr.cxx>

#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__bool.cxx>

#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__guid.cxx>

#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__bytes.cxx>

#include <ole_lib/oledb/variant/converter/array/ui1/oledb_var_cvt__array_ui1__iunknown.cxx>

////////////////////////////////////////////////////////////////////////////////

static const DBVARIANT::LPCTYPECONVERTER g_converters__array_ui1_to_simple[146]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
/*  2*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,i2)             //I2
/*  3*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,i4)             //I4
/*  4*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,r4)             //R4
/*  5*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,r8)             //R8
/*  6*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,cy)             //CY
/*  7*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,date)           //DATE
/*  8*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,bstr)           //BSTR
/*  9*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(9)                    //IDISPATCH
/* 10*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,error)          //ERROR
/* 11*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,bool)           //BOOL
/* 12*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_common,variant)     //VARIANT
/* 13*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,iunknown)       //IUNKNOWN
/* 14*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,decimal)        //DECIMAL
/* 15*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(15)
/* 16*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,i1)             //I1
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,ui1)            //UI1
/* 18*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,ui2)            //UI2
/* 19*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,ui4)            //UI4
/* 20*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,i8)             //I8
/* 21*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,ui8)            //UI8
...
/* 64*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,filetime)       //FILETIME
...
/* 72*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,guid)           //GUID
...
/*128*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,bytes)          //BYTES
/*129*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,str)            //STR
/*130*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,wstr)           //WSTR
/*131*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,numeric)        //NUMERIC
/*132*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(132)                  //UDT
/*133*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,dbdate)         //DBDATE
/*134*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,dbtime)         //DBTIME
/*135*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,dbtimestamp)    //DBTIMESTAMP
...
/*145*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,dbtime2)        //DBTIME2
};//g_converters__array_ui1_to_simple
...
//------------------------------------------------------------------------
static const DBVARIANT::LPCTYPECONVERTER g_converters__array_ui1_to_array[/*146*/]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                            //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                            //NULL
/*  2*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_i2)               //I2
/*  3*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_i4)               //I4
/*  4*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_r4)               //R4
/*  5*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_r8)               //R8
/*  6*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_cy)               //CY
/*  7*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(7)                            //DATE
/*  8*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_bstr)             //BSTR
/*  9*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(9)                            //IDISPATCH
/* 10*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(10)                           //ERROR
/* 11*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_bool)             //BOOL
/* 12*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_variant)          //VARIANT
/* 13*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_iunknown)         //IUNKNOWN
/* 14*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_decimal)          //DECIMAL
/* 15*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(15)
/* 16*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_i1)               //I1
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_ui1)              //UI1 [copy]
/* 18*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_ui2)              //UI2
/* 19*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_ui4)              //UI4
/* 20*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_i8)               //I8
/* 21*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_ui8)              //UI8
/* 22*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(22)
/* 23*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(23)
/* 24*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(24)
/* 25*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(25)
...
/*126*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(126)
/*127*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(127)
/*128*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_bytes)            //BYTES
/*129*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_str)              //STR
/*130*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_wstr)             //WSTR
/*131*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_ui1,array_numeric)          //NUMERIC
#if 0
/*132*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(132)                  //UDT
...
#endif
};//g_converters__array_ui1_to_array
