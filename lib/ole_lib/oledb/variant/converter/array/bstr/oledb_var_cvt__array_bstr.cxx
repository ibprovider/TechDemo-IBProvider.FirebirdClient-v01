////////////////////////////////////////////////////////////////////////////////
//Include implementation DBTYPE_ARRAY|DBTYPE_BSTR type converters.
//                                                  Dmitry Kovalenko, 28.05.2008
////////////////////////////////////////////////////////////////////////////////

#include <ole_lib/oledb/variant/converter/array/bstr/oledb_var_cvt__array_bstr.hxx>

////////////////////////////////////////////////////////////////////////////////

static const DBVARIANT::LPCTYPECONVERTER g_converters__array_bstr_to_simple[/*136*/]=
{
...
#endif
};//g_converters__array_bstr_to_simple
...
//------------------------------------------------------------------------
static const DBVARIANT::LPCTYPECONVERTER g_converters__array_bstr_to_array[146]=
{
/*  0*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(0)                    //EMPTY
/*  1*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(1)                    //NULL
/*  2*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_i2)      //I2
/*  3*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_i4)      //I4
/*  4*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_r4)      //R4
/*  5*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_r8)      //R8
/*  6*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_cy)      //CY
/*  7*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_date)    //DATE
/*  8*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_bstr)    //BSTR [copy]
/*  9*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(9)                    //IDISPATCH
/* 10*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(10)                   //ERROR
/* 11*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_bool)    //BOOL
/* 12*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_variant) //VARIANT
/* 13*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_iunknown)//IUNKNOWN
/* 14*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_decimal) //DECIMAL
/* 15*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(15)
/* 16*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_i1)      //I1
/* 17*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_ui1)     //UI1
/* 18*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_ui2)     //UI2
/* 19*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_ui4)     //UI4
/* 20*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_i8)      //I8
/* 21*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_ui8)     //UI8
/* 22*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(22)
/* 23*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(23)
/* 24*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(24)
/* 25*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(25)
...
/* 62*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(62)
/* 63*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(63)
/* 64*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_filetime)        //FILETIME
/* 65*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(65)
/* 66*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(66)
/* 67*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(67)
/* 68*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(68)
...
/* 70*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(70)
/* 71*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(71)
/* 72*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_guid)            //GUID
/* 73*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(73)
/* 74*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(74)
/* 75*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(75)
/* 76*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(76)
...
/*126*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(126)
/*127*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(127)
/*128*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_bytes)           //BYTES [spec]
/*129*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_str)             //STR [spec]
/*130*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_wstr)            //WST [spec]R
/*131*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_numeric)         //NUMERIC
/*132*/ DEFINE_OLEDB_TYPE_CONVERTER_NOTHING(132)                          //UDT
/*133*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_dbdate)          //DBDATE
/*134*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_dbtime)          //DBTIME
/*135*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_dbtimestamp)     //DBTIMESTAMP
...
/*145*/ DEFINE_OLEDB_TYPE_CONVERTER_REF(array_bstr,array_dbtime2)         //DBTIME2
};//g_converters__array_bstr_to_array
