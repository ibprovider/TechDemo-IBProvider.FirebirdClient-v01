...
#include <ole_lib/oledb/variant/comparator2/impl/simple/i2/oledb_variant_cmp2__i2__i1.cxx>
#include <ole_lib/oledb/variant/comparator2/impl/simple/i2/oledb_variant_cmp2__i2__i2.cxx>
#include <ole_lib/oledb/variant/comparator2/impl/simple/i2/oledb_variant_cmp2__i2__i4.cxx>
#include <ole_lib/oledb/variant/comparator2/impl/simple/i2/oledb_variant_cmp2__i2__i8.cxx>

#include <ole_lib/oledb/variant/comparator2/impl/simple/i2/oledb_variant_cmp2__i2__ui1.cxx>
#include <ole_lib/oledb/variant/comparator2/impl/simple/i2/oledb_variant_cmp2__i2__ui2.cxx>
#include <ole_lib/oledb/variant/comparator2/impl/simple/i2/oledb_variant_cmp2__i2__ui4.cxx>
#include <ole_lib/oledb/variant/comparator2/impl/simple/i2/oledb_variant_cmp2__i2__ui8.cxx>

#include <ole_lib/oledb/variant/comparator2/impl/simple/i2/oledb_variant_cmp2__i2__decimal.cxx>
#include <ole_lib/oledb/variant/comparator2/impl/simple/i2/oledb_variant_cmp2__i2__numeric.cxx>

#include <ole_lib/oledb/variant/comparator2/impl/simple/i2/oledb_variant_cmp2__i2__r4.cxx>
#include <ole_lib/oledb/variant/comparator2/impl/simple/i2/oledb_variant_cmp2__i2__r8.cxx>

////////////////////////////////////////////////////////////////////////////////

extern const TDBVariantComparator2_Descr2 g_DBVariantComparator2_Descrs2__I2__Simple[]=
{
 /*  0*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__NONE(),                  //DBTYPE_EMPTY
 /*  1*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__NULL2(I2),               //DBTYPE_NULL
 /*  2*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__SIMPLE(I2,I2),           //DBTYPE_I2
 /*  3*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__SIMPLE(I2,I4),           //DBTYPE_I4
 /*  4*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__SIMPLE(I2,R4),           //DBTYPE_R4
 /*  5*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__SIMPLE(I2,R8),           //DBTYPE_R8
 ...
 /* 12*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__VARIANT2(I2),
 /* 13*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__NONE(),
 /* 14*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__SIMPLE(I2,DECIMAL),
 /* 15*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__NONE(),
 /* 16*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__SIMPLE(I2,I1),           //DBTYPE_I1
 /* 17*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__SIMPLE(I2,UI1),          //DBTYPE_UI1
 /* 18*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__SIMPLE(I2,UI2),          //DBTYPE_UI2
 /* 19*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__SIMPLE(I2,UI4),          //DBTYPE_UI4
 /* 20*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__SIMPLE(I2,I8),           //DBTYPE_I8
 /* 21*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__SIMPLE(I2,UI8),          //DBTYPE_UI8
 ...
 /*131*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__SIMPLE(I2,NUMERIC)
};//g_DBVariantComparator2_Descrs2__I2__Simple

////////////////////////////////////////////////////////////////////////////////

extern const TDBVariantComparator2_Descr1
 g_DBVariantComparator2_Descr1__I2__Simple
  (_DIM_(g_DBVariantComparator2_Descrs2__I2__Simple),
   g_DBVariantComparator2_Descrs2__I2__Simple
   _DEBUG_ARG(oledb_typeid__I2)
   _DEBUG_ARG(0));
