...
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__INSTANCE(I2,NUMERIC)

//------------------------------------------------------------------------
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__COMPARE_VALUES(I2,NUMERIC)
{
 ...
 const HRESULT hr=DBVARIANT_CVT_UTILS::IntToNumeric(v1.valI2,&dbnumVal1);
