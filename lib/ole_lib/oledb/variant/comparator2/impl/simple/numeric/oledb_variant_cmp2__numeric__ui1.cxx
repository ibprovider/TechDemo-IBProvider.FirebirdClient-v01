...
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__INSTANCE(NUMERIC,UI1)

//------------------------------------------------------------------------
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__COMPARE_VALUES(NUMERIC,UI1)
{
 ...
 const HRESULT hr=DBVARIANT_CVT_UTILS::IntToNumeric(v2.valUI1,&dbnumVal2);
