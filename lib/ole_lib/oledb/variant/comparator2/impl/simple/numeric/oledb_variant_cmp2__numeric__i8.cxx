...
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__INSTANCE(NUMERIC,I8)

//------------------------------------------------------------------------
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__COMPARE_VALUES(NUMERIC,I8)
{
 ...
 const HRESULT hr=DBVARIANT_CVT_UTILS::IntToNumeric(v2.valI8.QuadPart,&dbnumVal2);
