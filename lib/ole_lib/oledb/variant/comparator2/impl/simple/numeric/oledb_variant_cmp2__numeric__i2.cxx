...
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__INSTANCE(NUMERIC,I2)

//------------------------------------------------------------------------
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__COMPARE_VALUES(NUMERIC,I2)
{
 ...
 const HRESULT hr=DBVARIANT_CVT_UTILS::IntToNumeric(v2.valI2,&dbnumVal2);
