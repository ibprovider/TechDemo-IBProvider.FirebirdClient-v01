...
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__INSTANCE(NUMERIC,I1)

//------------------------------------------------------------------------
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__COMPARE_VALUES(NUMERIC,I1)
{
 ...
 const HRESULT hr=DBVARIANT_CVT_UTILS::IntToNumeric(v2.valI1,&dbnumVal2);
