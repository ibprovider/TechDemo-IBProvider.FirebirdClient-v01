...
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__INSTANCE(DECIMAL,UI1)

//------------------------------------------------------------------------
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__COMPARE_VALUES(DECIMAL,UI1)
{
 ...
 const HRESULT hr=DBVARIANT_CVT_UTILS::IntToDecimal(v2.valUI1,&decVal2);
