...
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__INSTANCE(R8,UI2)

//------------------------------------------------------------------------
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__COMPARE_VALUES(R8,UI2)
{
 ...
 const oledb_lib::t_oledb_value__R8 v2_as_R8(v2.valUI2);

 assert(v2_as_R8==v2.valUI2);
