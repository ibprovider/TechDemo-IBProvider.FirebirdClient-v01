...
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__INSTANCE(I1,NUMERIC)

//------------------------------------------------------------------------
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__COMPARE_VALUES(I1,NUMERIC)
{
 ...
 const HRESULT hr=DBVARIANT_CVT_UTILS::IntToNumeric(v1.valI1,&dbnumVal1);
