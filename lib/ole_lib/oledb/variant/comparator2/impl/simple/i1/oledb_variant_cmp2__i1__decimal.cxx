...
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__INSTANCE(I1,DECIMAL)

//------------------------------------------------------------------------
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__COMPARE_VALUES(I1,DECIMAL)
{
 ...
 const HRESULT hr=DBVARIANT_CVT_UTILS::IntToDecimal(v1.valI1,&decVal1);
