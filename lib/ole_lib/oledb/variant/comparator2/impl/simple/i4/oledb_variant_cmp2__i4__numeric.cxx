...
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__INSTANCE(I4,NUMERIC)

//------------------------------------------------------------------------
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__COMPARE_VALUES(I4,NUMERIC)
{
 ...
 const HRESULT hr=DBVARIANT_CVT_UTILS::IntToNumeric(v1.valI4,&dbnumVal1);
