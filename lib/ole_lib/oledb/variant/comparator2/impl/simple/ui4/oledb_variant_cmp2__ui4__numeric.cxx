...
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__INSTANCE(UI4,NUMERIC)

//------------------------------------------------------------------------
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__COMPARE_VALUES(UI4,NUMERIC)
{
 ...
 const HRESULT hr=DBVARIANT_CVT_UTILS::IntToNumeric(v1.valUI4,&dbnumVal1);
