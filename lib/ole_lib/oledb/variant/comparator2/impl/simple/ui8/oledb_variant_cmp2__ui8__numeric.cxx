...
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__INSTANCE(UI8,NUMERIC)

//------------------------------------------------------------------------
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__COMPARE_VALUES(UI8,NUMERIC)
{
 ...
 const HRESULT hr=DBVARIANT_CVT_UTILS::IntToNumeric(v1.valUI8.QuadPart,&dbnumVal1);
