...
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__INSTANCE(I8,DECIMAL)

//------------------------------------------------------------------------
OLEDB_VARIANT_COMPARATOR2_CLASS__SIMPLE__COMPARE_VALUES(I8,DECIMAL)
{
 ...
 const HRESULT hr=DBVARIANT_CVT_UTILS::IntToDecimal(v1.valI8.QuadPart,&decVal1);
