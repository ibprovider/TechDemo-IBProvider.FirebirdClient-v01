...
extern const TDBVariantComparator2_Descr2 g_DBVariantComparator2_Descrs2__ARRAY_VARIANT__Simple[]=
{
 /*  0*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__NONE(),                  //DBTYPE_EMPTY
 /*  1*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__NULL2_A(VARIANT),        //DBTYPE_NULL
 ...
 /* 12*/ OLEDB_VARIANT_COMPARATOR2_DESCR2__VARIANT2_A(VARIANT),     //DBTYPE_VARIANT
};//g_DBVariantComparator2_Descrs2__ARRAY_BYTES__Simple

////////////////////////////////////////////////////////////////////////////////

extern const TDBVariantComparator2_Descr1
 g_DBVariantComparator2_Descr1__ARRAY_VARIANT__Simple
  (_DIM_(g_DBVariantComparator2_Descrs2__ARRAY_VARIANT__Simple),
   g_DBVariantComparator2_Descrs2__ARRAY_VARIANT__Simple
   _DEBUG_ARG(oledb_typeid__ARRAY|oledb_typeid__VARIANT)
   _DEBUG_ARG(0));
