////////////////////////////////////////////////////////////////////////////////
//DBTYPE_NUMERIC Service
//                                                  Kovalenko Dmitry 04.11.2008

////////////////////////////////////////////////////////////////////////////////
//NUMERIC

DEFINE_OLEDB_TYPE_SERVICE_OBJ(NUMERIC)

//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_SERVICE_GET_ALIGN(NUMERIC)

//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_SERVICE_GET_LENGTH(NUMERIC)

//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_SERVICE_GET_BINARY_LENGTH(NUMERIC)

//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_SERVICE_GET_SIZE(NUMERIC)

//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_SERVICE_GET_CONVERTOR(NUMERIC)

//------------------------------------------------------------------------
HRESULT t_oledb_type_service_NUMERIC::internal__get_data__ok
                                            ...
                                            void*       const pBuffer)const
{
  ...
  *reinterpret_cast<const value_type**>(pBuffer)=&dbvar.dbnumVal;         /*!*/
 }
 else
 {
  assert(cbMemSize>=sizeof(value_type));

  *reinterpret_cast<value_type*>(pBuffer)=dbvar.dbnumVal;                 /*!*/
 }

 return S_OK;
}//NUMERIC::internal__get_data__ok

//------------------------------------------------------------------------
HRESULT t_oledb_type_service_NUMERIC::get_element                         //!!!
                                             ...
                                             const void*  const pElement)const
{
 ...
 assert_s(sizeof(value_type)==sizeof(dest->dbnumVal));                    //!!!

 assert(this->get_type()==DBTYPE_NUMERIC);                                //!!!
 ...
 //--------
 memcpy(&dest->dbnumVal,pElement,sizeof(value_type));                     //!!!
...
//------------------------------------------------------------------------
HRESULT t_oledb_type_service_NUMERIC::set_element                         //!!!
                                             ...
                                             status_type*  const pBinding_Status)const
{
 ...
 assert_s(sizeof(source.dbnumVal)==sizeof(value_type));                   //!!!
 ...
 DBVARIANT::value_numeric_n_type elementValue;                            //!!!

 const HRESULT cvt_hr=DBVariant__to_NUMERIC_ex(pConvCtx,source,&elementValue);  //!!!
...
//------------------------------------------------------------------------
std::wstring t_oledb_type_service_NUMERIC::get_print_wstr(const DBVARIANT& dbvar)const
{
 assert(dbvar.wType==this->get_type());

 //-------
 std::wstring result(L"NUM[");
 ...
 HRESULT const hr
  =DBVARIANT_CVT_UTILS::NumericToString(dbvar.dbnumVal,&wnum);            //!!!
