...
DEFINE_OLEDB_TYPE_SERVICE_OBJ(UI2)

//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_SERVICE_GET_ALIGN(UI2)

//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_SERVICE_GET_LENGTH(UI2)

//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_SERVICE_GET_BINARY_LENGTH(UI2)

//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_SERVICE_GET_SIZE(UI2)

//------------------------------------------------------------------------
DEFINE_OLEDB_TYPE_SERVICE_GET_CONVERTOR(UI2)

//------------------------------------------------------------------------
HRESULT t_oledb_type_service_UI2::internal__get_data__ok
                                             ...
                                             void*       const pBuffer)const
{
  ...
  *reinterpret_cast<const value_type**>(pBuffer)=&dbvar.valUI2;           /*!*/
 }
 else
 {
  assert_s(sizeof(value_type)==sizeof(dbvar.valUI2));                     /*!*/
  assert(cbMemSize>=sizeof(value_type));

  *reinterpret_cast<value_type*>(pBuffer)=dbvar.valUI2;                   /*!*/
 }

 return S_OK;
}//UI2::internal__get_data__ok

//------------------------------------------------------------------------
HRESULT t_oledb_type_service_UI2::get_element(DBVARIANT*   const dest,    //!!!
                                              REFIID             /*ElementIID*/,
                                              ...
                                              const void*  const pElement)const
{
 ...
 assert_s(sizeof(value_type)==sizeof(dest->valUI2));                      //!!!

 assert(this->get_type()==DBTYPE_UI2);                                    //!!!
 ...
 //--------
 memcpy(&dest->valUI2,pElement,sizeof(value_type));                       //!!!
...
//------------------------------------------------------------------------
HRESULT t_oledb_type_service_UI2::set_element                             //!!!
                                             ...
                                             status_type*  const pBinding_Status)const
{
 ...
 assert_s(sizeof(source.valUI2)==sizeof(value_type));                     //!!!
 ...
 DBVARIANT::value_ui2_n_type elementValue;                                //!!!

 const HRESULT cvt_hr=DBVariant__to_UI2_ex(pConvCtx,source,&elementValue);//!!!
...
//------------------------------------------------------------------------
std::wstring t_oledb_type_service_UI2::get_print_wstr(const DBVARIANT& dbvar)const
{
 assert(dbvar.wType==this->get_type());

 //-------
 std::wstring result(L"UI2[");
 ...
 //-------
 result+=L"[";
 result+=structure::t_str_args_traits<wchar_t>::arg(dbvar.valUI2);
 result+=L"]";
