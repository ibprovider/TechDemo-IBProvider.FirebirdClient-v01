...
#ifndef _lcpi_lib_structure_utilities__string__miss_space_CC_
#define _lcpi_lib_structure_utilities__string__miss_space_CC_

#include <structure/utilities/string/is_trim_char.h>
