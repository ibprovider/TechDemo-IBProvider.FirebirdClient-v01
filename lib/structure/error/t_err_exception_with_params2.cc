////////////////////////////////////////////////////////////////////////////////
#ifndef _t_err_exception_with_params2_CC_
#define _t_err_exception_with_params2_CC_
...
//------------------------------------------------------------------------
template<class t_record,class charT,class StrCvtTraits,class Allocator>
t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>::~t_err_exception_with_params2()LCPI_STL_EXCEPTION_DCR_THROW_SPEC
{
}

//exception interface ----------------------------------------------------
template<class t_record,class charT,class StrCvtTraits,class Allocator>
const char* t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>::what()const throw()
{
...
template<class t_record,class charT,class StrCvtTraits,class Allocator>
void t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>::raise()const
{
...
template<class t_record,class charT,class StrCvtTraits,class Allocator>
t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>&
 t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>::add_arg
                        (const arg_type& arg)
{
 assert(m_cur_record);
...
template<class t_record,class charT,class StrCvtTraits,class Allocator>
size_t
 t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>::get_record_count()const
{
...
t_err_record::self_ptr
 t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>::get_record
...
//------------------------------------------------------------------------
template<class t_record,class charT,class StrCvtTraits,class Allocator>
void t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>::add_record
                        (t_err_record* const record)
{
 assert(record);
...
template<class t_record,class charT,class StrCvtTraits,class Allocator>
t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>&
 t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>::add_arg__exc
...
template<class t_record,class charT,class StrCvtTraits,class Allocator>
t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>&
 t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>::add_arg__obj
...
template<class t_record,class charT,class StrCvtTraits,class Allocator>
t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>&
 t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>::add_arg__source
...
template<class t_record,class charT,class StrCvtTraits,class Allocator>
t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>&
 t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>::add
                        (const std::exception& exc)
{
 if(&exc==this)
  return *this;
 ...
 using simple_record_type
  =t_err_simple_record2<StrCvtTraits,Allocator>;

 const typename simple_record_type::self_ptr
  simple_err_record
   (structure::not_null_ptr
     (new simple_record_type()));

 str_cvt_traits_type::tstr_to_tstr
  (&simple_err_record->m_source,
   L"unknown");

 str_cvt_traits_type::tstr_to_tstr
  (&simple_err_record->m_description,
   exc.what());
...
template<class t_record,class charT,class StrCvtTraits,class Allocator>
t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>&
 t_err_exception_with_params2<t_record,charT,StrCvtTraits,Allocator>::add_error
                        (source_id_type const source_id,
                         msg_id_type    const msg_id)
{
 record_ptr x
