////////////////////////////////////////////////////////////////////////////////
//Compiler configuration. BCB5.
//                                                Kovalenko Dmitry. 19.10.2012.
#ifndef _config_compiler__bcb5_H_
#define _config_compiler__bcb5_H_

////////////////////////////////////////////////////////////////////////////////

#define  COMP_CONF_SUPPORT_MEMBER_TEMPLATE                        1
#define  COMP_CONF_SUPPORT_TEMPLATE_FUNC_RET_INNER_TYPE           1
#define  COMP_CONF_STABLE_PURE_METHOD_IN_TEMPLATE                 0
#define  COMP_CONF_SUPPORT_TEMPLATE_FUNC_SPECIALIZE_BY_RETURN     1

#define  COMP_CONF_TYPENAME_INIT_ARGUMENT(T)
#define  COMP_CONF_ALLOW_COPY_CTOR_IN_EXCEPTION_BASE_WITHOUT_IMPL 1

#define  COMP_CONF_SUPPORT_OPERATOR_DELETE_EX                     0
#define  COMP_CONF_SUPPORT_PRAGMA_STARTUP                         1
#define  COMP_CONF_SUPPORT_PRAGMA_ARGSUSED                        1
#define  COMP_CONF_SUPPORT_PRAGMA_ONCE                            0

#define  COMP_CONF_DLL_EXPORT                                     __export
...
#define  COMP_CONF_BORLAND__HAS_BUG_IN_W8012_FOR_TWO_UNSIGNED     1

#define  COMP_CONF_HAS_PROBLEM_WITH_CAN_NUMERIC_CAST_I64_UI64     1
