...
class IBP_OLEDB_Props2__Descrs__Data__DBINIT__ALL::tag_data LCPI_CPP_CFG__CLASS__FINAL
{
 public:
...
static void DEBUG__check_IBP_OLEDB_Props2__Descrs__Data__DBINIT__ALL__tag_data__sm_IndexByName__std()
{
 IBP_OLEDB_Props2__DescrData_IndexByName_Item::DEBUG_Check_Range
  (_BEG_END_(IBP_OLEDB_Props2__Descrs__Data__DBINIT__ALL::tag_data::sm_IndexByName__std));
...
{
 IBP_OLEDB_Props2__DescrData_IndexByName_Item::DEBUG_Check_Range
  (_BEG_END_(IBP_OLEDB_Props2__Descrs__Data__DBINIT__ALL::tag_data::sm_IndexByName__ext));
...
#define IBP_OLEDB_PROPS2__DESCR_DATA(InitTag,                             \
                                     ...
                                     ListOfAdditionalParams,              \
                                     POST_INIT_CALLS)                     \
 tag_check::exec(PropDescr.ptr(),DBPROPSET_DBINIT,PropId);
...
#define IBP_OLEDB_PROPS2__DESCR_DATA(InitTag,                             \
                                     ...
                                     ListOfAdditionalParams,              \
                                     POST_INIT_CALLS)                     \
 tag_check::exec(PropDescr.ptr(),ibprovider::IBP_DBPROPSET_INIT,ibprovider::PropId);
...
STARTUP_CODE_EX__DEBUG
 (IBP_OLEDB_Props2__Descrs__Data__DBINIT__ALL__DEBUG__Check_sm_IndexByName,
  IBP_OLEDB_Props2__Descrs__Data__DBINIT__ALL::DEBUG__Check_sm_IndexByName);
