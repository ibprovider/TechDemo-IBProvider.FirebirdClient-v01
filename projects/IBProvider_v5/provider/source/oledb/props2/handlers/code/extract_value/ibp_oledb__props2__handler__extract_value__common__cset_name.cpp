...
//! \file    ibp_oledb__props2__handler__extract_value__common__cset_name.cpp
...
IBP_OLEDB_Props2__Handler__ExtractValue__Common__cset_name
 IBP_OLEDB_Props2__Handler__ExtractValue__Common__cset_name::sm_Instance;

//------------------------------------------------------------------------
IBP_OLEDB_Props2__Handler__ExtractValue__Common__cset_name::IBP_OLEDB_Props2__Handler__ExtractValue__Common__cset_name()
{
}//IBP_OLEDB_Props2__Handler__ExtractValue__Common__cset_name
...
const IBP_OLEDB_Props2__Handler__ExtractValue*
 IBP_OLEDB_Props2__Handler__ExtractValue__Common__cset_name::GetInstancePtr()
{
 return &sm_Instance;
}//GetInstancePtr

//IBP_OLEDB_Props2__Handler__ExtractValue interface ----------------------
bool IBP_OLEDB_Props2__Handler__ExtractValue__Common__cset_name::ExtractValue
                                            ...
                                            VARIANT* const pResultValue)const
{
...

 {
  ...
  if(!IBP_Utils::IsValidCharsetName(ole_lib::BStrToBox(tmpValue.bstrVal)))
  {
   return false;
  }//if
 }//local
