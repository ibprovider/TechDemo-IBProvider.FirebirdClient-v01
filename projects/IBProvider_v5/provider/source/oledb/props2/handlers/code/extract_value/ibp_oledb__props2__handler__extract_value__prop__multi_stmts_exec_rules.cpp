...
//! \file    ibp_oledb__props2__handler__extract_value__prop__multi_stmts_exec_rules.cpp
//! \brief   Реализация ExtractValue для свойства "multi_stmts_exec_rules".
...
////////////////////////////////////////////////////////////////////////////////
//class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__multi_stmts_exec_rules::tag_data
...
const IBP_OLEDB_Props2__Handler__ExtractValue__Common__flags_i4
 IBP_OLEDB_Props2__Handler__ExtractValue__Prop__multi_stmts_exec_rules::tag_data::sm_Instance
  (_BEG_END_(ibprovider::g_IBP_PropFlagsFor__multi_stmts_exec_rules));

////////////////////////////////////////////////////////////////////////////////
//class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__multi_stmts_exec_rules

const IBP_OLEDB_Props2__Handler__ExtractValue*
 IBP_OLEDB_Props2__Handler__ExtractValue__Prop__multi_stmts_exec_rules::GetInstancePtr()
{
