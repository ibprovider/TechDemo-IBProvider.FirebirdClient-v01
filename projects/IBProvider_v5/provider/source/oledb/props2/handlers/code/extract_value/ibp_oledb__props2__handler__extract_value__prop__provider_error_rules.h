...
//! \file    ibp_oledb__props2__handler__extract_value__prop__provider_error_rules.h
//! \brief   Реализация ExtractValue для свойства "provider_error_rules".
//! \author  Kovalenko Dmitry
//! \date    19.12.2018
#ifndef _ibp_oledb__props2__handler__extract_value__prop__provider_error_rules_H_
#define _ibp_oledb__props2__handler__extract_value__prop__provider_error_rules_H_
...
/// <summary>
///  Реализация ExtractValue для свойства "provider_error_rules".
/// </summary>
class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__provider_error_rules
{
 private:
