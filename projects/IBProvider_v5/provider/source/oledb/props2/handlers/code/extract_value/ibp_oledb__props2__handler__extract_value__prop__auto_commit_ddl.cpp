...
//! \file    ibp_oledb__props2__handler__extract_value__prop__auto_commit_ddl.cpp
//! \brief   Реализация ExtractValue для свойства "auto_commit_ddl".
...
////////////////////////////////////////////////////////////////////////////////
//class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__auto_commit_ddl::tag_data
...
const IBP_OLEDB_Props2__Handler__ExtractValue__Common__enum_i4
 IBP_OLEDB_Props2__Handler__ExtractValue__Prop__auto_commit_ddl::tag_data::sm_Instance
  (_BEG_END_(ibprovider::g_IBP_PropValuesFor__auto_commit_ddl));

////////////////////////////////////////////////////////////////////////////////
//class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__auto_commit_ddl

const IBP_OLEDB_Props2__Handler__ExtractValue*
 IBP_OLEDB_Props2__Handler__ExtractValue__Prop__auto_commit_ddl::GetInstancePtr()
{
