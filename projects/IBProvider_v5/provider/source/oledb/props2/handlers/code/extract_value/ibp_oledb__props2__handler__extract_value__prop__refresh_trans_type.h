...
//! \file    ibp_oledb__props2__handler__extract_value__prop__refresh_trans_type.h
//! \brief   Реализация ExtractValue для свойства "refresh_trans_type".
//! \author  Kovalenko Dmitry
//! \date    19.12.2018
#ifndef _ibp_oledb__props2__handler__extract_value__prop__refresh_trans_type_H_
#define _ibp_oledb__props2__handler__extract_value__prop__refresh_trans_type_H_
...
/// <summary>
///  Реализация ExtractValue для свойства "refresh_trans_type".
/// </summary>
class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__refresh_trans_type
{
 private:
