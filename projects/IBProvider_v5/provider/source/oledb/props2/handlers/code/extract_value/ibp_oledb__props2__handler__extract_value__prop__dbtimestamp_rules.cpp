...
//! \file    ibp_oledb__props2__handler__extract_value__prop__dbtimestamp_rules.cpp
//! \brief   Реализация ExtractValue для свойства "dbtimestamp_rules".
...
const IBP_OLEDB_Props2__Handler__ExtractValue__Common__enum_i4
 IBP_OLEDB_Props2__Handler__ExtractValue__Prop__dbtimestamp_rules::tag_data::sm_Instance
  (_BEG_END_(ibprovider::g_IBP_PropValuesFor__dbtimestamp_rules));

////////////////////////////////////////////////////////////////////////////////
//class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__dbtimestamp_rules

const IBP_OLEDB_Props2__Handler__ExtractValue*
 IBP_OLEDB_Props2__Handler__ExtractValue__Prop__dbtimestamp_rules::GetInstancePtr()
{
