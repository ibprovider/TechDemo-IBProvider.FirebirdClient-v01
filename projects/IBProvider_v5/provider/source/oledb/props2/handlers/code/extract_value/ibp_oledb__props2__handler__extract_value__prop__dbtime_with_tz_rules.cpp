...
//! \file    ibp_oledb__props2__handler__extract_value__prop__dbtime_with_tz_rules.cpp
...
class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__dbtime_with_tz_rules::tag_data
{
 public:
...
const IBP_OLEDB_Props2__Handler__ExtractValue__Common__enum_i4
 IBP_OLEDB_Props2__Handler__ExtractValue__Prop__dbtime_with_tz_rules::tag_data::sm_Instance
  (_BEG_END_(ibprovider::g_IBP_PropValuesFor__dbtime_with_tz_rules));

////////////////////////////////////////////////////////////////////////////////
//class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__dbtime_with_tz_rules

const IBP_OLEDB_Props2__Handler__ExtractValue*
 IBP_OLEDB_Props2__Handler__ExtractValue__Prop__dbtime_with_tz_rules::GetInstancePtr()
{
