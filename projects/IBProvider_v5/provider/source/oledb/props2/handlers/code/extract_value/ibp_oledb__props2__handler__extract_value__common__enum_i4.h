...
//! \file    ibp_oledb__props2__handler__extract_value__common__enum_i4.h
//! \brief   Реализация ExtractValue для I4-свойств со списком допустимых значений.
//! \author  Kovalenko Dmitry
//! \date    17.12.2018
#ifndef _ibp_oledb__props2__handler__extract_value__common__enum_i4_H_
#define _ibp_oledb__props2__handler__extract_value__common__enum_i4_H_
...
/// <summary>
///  Реализация ExtractValue для I4-свойств со списком допустимых значений.
/// </summary>
class IBP_OLEDB_Props2__Handler__ExtractValue__Common__enum_i4
 :public IBP_OLEDB_Props2__Handler__ExtractValue
{
 private:
  typedef IBP_OLEDB_Props2__Handler__ExtractValue__Common__enum_i4   self_type;

  IBP_OLEDB_Props2__Handler__ExtractValue__Common__enum_i4(const self_type&);
