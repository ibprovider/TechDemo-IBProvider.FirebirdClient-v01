...
//! \file    ibp_oledb__props2__handler__extract_value__common__dll_lock_rules.cpp
//! \brief   Реализация ExtractValue для свойства с правилами блокировки DLL.
...
////////////////////////////////////////////////////////////////////////////////
//class IBP_OLEDB_Props2__Handler__ExtractValue__Common__dll_lock_rules::tag_data
...
const IBP_OLEDB_Props2__Handler__ExtractValue__Common__enum_i4
 IBP_OLEDB_Props2__Handler__ExtractValue__Common__dll_lock_rules::tag_data::sm_Instance
  (_BEG_END_(ibprovider::g_IBP_PropValuesFor__dll_lock_rules));

////////////////////////////////////////////////////////////////////////////////
//class IBP_OLEDB_Props2__Handler__ExtractValue__Common__dll_lock_rules

const IBP_OLEDB_Props2__Handler__ExtractValue*
 IBP_OLEDB_Props2__Handler__ExtractValue__Common__dll_lock_rules::GetInstancePtr()
{
