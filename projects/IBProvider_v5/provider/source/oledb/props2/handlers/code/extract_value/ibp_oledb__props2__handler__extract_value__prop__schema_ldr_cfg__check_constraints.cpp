...
//! \file    ibp_oledb__props2__handler__extract_value__prop__schema_ldr_cfg__check_constraints.cpp
...
////////////////////////////////////////////////////////////////////////////////
//class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__schema_ldr_cfg__check_constraints::tag_data
...
const IBP_OLEDB_Props2__Handler__ExtractValue__Common__enum_i4
 IBP_OLEDB_Props2__Handler__ExtractValue__Prop__schema_ldr_cfg__check_constraints::tag_data::sm_Instance
  (_BEG_END_(ibprovider::g_IBP_PropValuesFor__schema_ldr_cfg__check_constraints));
...
const IBP_OLEDB_Props2__Handler__ExtractValue*
 IBP_OLEDB_Props2__Handler__ExtractValue__Prop__schema_ldr_cfg__check_constraints::GetInstancePtr()
{
