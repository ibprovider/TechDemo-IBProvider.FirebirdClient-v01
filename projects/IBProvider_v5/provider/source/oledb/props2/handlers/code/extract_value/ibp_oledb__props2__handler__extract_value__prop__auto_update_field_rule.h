...
//! \file    ibp_oledb__props2__handler__extract_value__prop__auto_update_field_rule.h
//! \brief   Реализация ExtractValue для свойства "auto_update_field_rule".
//! \author  Kovalenko Dmitry
//! \date    19.12.2018
#ifndef _ibp_oledb__props2__handler__extract_value__prop__auto_update_field_rule_H_
#define _ibp_oledb__props2__handler__extract_value__prop__auto_update_field_rule_H_
...
/// <summary>
///  Реализация ExtractValue для свойства "auto_update_field_rule".
/// </summary>
class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__auto_update_field_rule
{
 private:
