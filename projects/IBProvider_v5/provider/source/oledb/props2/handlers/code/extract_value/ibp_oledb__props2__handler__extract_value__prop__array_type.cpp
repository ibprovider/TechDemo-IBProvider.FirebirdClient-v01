...
//! \file    ibp_oledb__props2__handler__extract_value__prop__array_type.cpp
//! \brief   Реализация ExtractValue для свойства "array_type".
...
////////////////////////////////////////////////////////////////////////////////
//class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__array_type::tag_data
...
const IBP_OLEDB_Props2__Handler__ExtractValue__Common__enum_i4
 IBP_OLEDB_Props2__Handler__ExtractValue__Prop__array_type::tag_data::sm_Instance
  (_BEG_END_(ibprovider::g_IBP_PropValuesFor__array_type));

////////////////////////////////////////////////////////////////////////////////
//class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__array_type

const IBP_OLEDB_Props2__Handler__ExtractValue*
 IBP_OLEDB_Props2__Handler__ExtractValue__Prop__array_type::GetInstancePtr()
{
