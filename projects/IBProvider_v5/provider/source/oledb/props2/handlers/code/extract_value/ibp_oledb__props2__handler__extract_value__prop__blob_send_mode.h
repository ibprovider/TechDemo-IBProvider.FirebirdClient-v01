...
//! \file    ibp_oledb__props2__handler__extract_value__prop__blob_send_mode.h
//! \brief   Реализация ExtractValue для свойства "blob_send_mode".
//! \author  Kovalenko Dmitry
//! \date    21.02.2024
#ifndef _ibp_oledb__props2__handler__extract_value__prop__blob_send_mode_H_
#define _ibp_oledb__props2__handler__extract_value__prop__blob_send_mode_H_
...
/// <summary>
///  Реализация ExtractValue для свойства "blob_send_mode".
/// </summary>
class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__blob_send_mode
{
 private:
