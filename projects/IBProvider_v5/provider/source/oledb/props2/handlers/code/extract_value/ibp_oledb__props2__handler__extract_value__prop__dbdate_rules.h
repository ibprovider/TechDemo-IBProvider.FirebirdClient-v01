...
//! \file    ibp_oledb__props2__handler__extract_value__prop__dbdate_rules.h
//! \brief   Реализация ExtractValue для свойства "dbdate_rules".
//! \author  Kovalenko Dmitry
//! \date    18.12.2018
#ifndef _ibp_oledb__props2__handler__extract_value__prop__dbdate_rules_H_
#define _ibp_oledb__props2__handler__extract_value__prop__dbdate_rules_H_
...
/// <summary>
///  Реализация ExtractValue для свойства "dbdate_rules".
/// </summary>
class IBP_OLEDB_Props2__Handler__ExtractValue__Prop__dbdate_rules
{
 private:
