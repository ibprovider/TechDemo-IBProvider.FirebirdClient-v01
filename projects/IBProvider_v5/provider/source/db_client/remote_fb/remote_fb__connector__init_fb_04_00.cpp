...
void RemoteFB__Connector::Helper__FinalInitialize__FB_04_00(const cns_type& /*cns*/)
{
 ...
 m_spData->RegService
  (db_obj::__db_guid<isc_base::t_isc_xsqlda_v1_svc__msg_blr01_builder>(),
   db_obj::dbms_fb::v04_0_0::create_xsqlda_v1_svc__msg01_blr01_builder());
 ...
 m_spData->RegService
  (db_obj::__db_guid<isc_base::t_isc_xsqlda_v1_svc__msg_data_descrs_builder>(),
   db_obj::dbms_fb::v04_0_0::create_xsqlda_v1_svc__msg01_data_descrs_builder());

 // 04.00. t_isc_xsqlda_v1_svc__msg_data service -------------------------

 m_spData->RegService
  (db_obj::__db_guid<isc_base::t_isc_xsqlda_v1_svc__msg_data>(),
   db_obj::dbms_fb::v04_0_0::create_xsqlda_v1_svc__msg_data());
