...
//! \file    remote_fb__connector__init_p11_no_lazy.cpp
//! \brief   Инициализация 11-го протокола [NO LAZY MODE].
...
void RemoteFB__Connector::Helper__FinalInitialize__P11__no_lazy()
{
 assert(m_spData);
...
}//Helper__FinalInitialize__P11__no_lazy
