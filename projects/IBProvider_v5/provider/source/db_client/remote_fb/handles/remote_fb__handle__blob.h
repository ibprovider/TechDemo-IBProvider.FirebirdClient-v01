...
//! \file    remote_fb__handle__blob.h
//! \brief   Дескриптор блоба.
//! \author  Kovalenko Dmitry
//! \date    11.09.2015
#ifndef _remote_fb__handle__blob_H_
#define _remote_fb__handle__blob_H_
...
///  Дескриптор блоба.
/// </summary>
using RemoteFB__BlobHandle=RemoteFB__HandleData_Blob::self_ptr;
