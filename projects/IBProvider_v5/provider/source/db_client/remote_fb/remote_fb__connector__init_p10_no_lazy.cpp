...
//! \file    remote_fb__connector__init_p10_no_lazy.cpp
//! \brief   Инициализация 10-го протокола [NO LAZY MODE].
...
void RemoteFB__Connector::Helper__FinalInitialize__P10__no_lazy()
{
 assert(m_spData);
...
}//Helper__FinalInitialize__P10__no_lazy
