...
//! \file    remote_fb__api_p13__stmt__close.cpp
...
RemoteFB__API_P13__CloseStatement RemoteFB__API_P13__CloseStatement::Instance;

//------------------------------------------------------------------------
RemoteFB__API_P13__CloseStatement::RemoteFB__API_P13__CloseStatement()
{;}
...
//interface --------------------------------------------------------------
void RemoteFB__API_P13__CloseStatement::exec(RemoteFB__ConnectorData* const pData,
                                             stmt_handle_type*        const pStmtHandle)
{
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P13__CloseStatement::exec";
