...
//! \date    21.09.2016
#ifndef _remote_fb__api_p13_lazy_send__stmt__close_H_
#define _remote_fb__api_p13_lazy_send__stmt__close_H_
...
/// </summary>
class RemoteFB__API_P13_LAZY_SEND__CloseStatement LCPI_CPP_CFG__CLASS__FINAL
 :public REMOTE_FB__DEF_INTERFACE_IMPL_STATIC(RemoteFB__API__CloseStatement)
{
 private:
  using self_type=RemoteFB__API_P13_LAZY_SEND__CloseStatement;

  RemoteFB__API_P13_LAZY_SEND__CloseStatement(const self_type&)=delete;
 ...
 private:
  RemoteFB__API_P13_LAZY_SEND__CloseStatement();

  virtual ~RemoteFB__API_P13_LAZY_SEND__CloseStatement();
