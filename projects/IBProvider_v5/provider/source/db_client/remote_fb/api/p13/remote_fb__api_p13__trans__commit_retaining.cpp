...
//! \file    remote_fb__api_p13__trans__commit_retaining.cpp
...
RemoteFB__API_P13__CommitRetaining RemoteFB__API_P13__CommitRetaining::Instance;

//------------------------------------------------------------------------
RemoteFB__API_P13__CommitRetaining::RemoteFB__API_P13__CommitRetaining()
{;}
...
//------------------------------------------------------------------------
void RemoteFB__API_P13__CommitRetaining::exec(RemoteFB__ConnectorData* const pData,
                                              tr_handle_type*          const pTrHandle)
{
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P13__CommitRetaining::exec";
 ...
 //-----------------------------------------
 const protocol::set02::P_OP c_OperationID=protocol::set02::op_commit_retaining;
