...
/// </summary>
class RemoteFB__API_P13_LAZY_SEND__CancelBlob LCPI_CPP_CFG__CLASS__FINAL
 :public REMOTE_FB__DEF_INTERFACE_IMPL_STATIC(RemoteFB__API__CancelBlob)
{
 private:
  using self_type=RemoteFB__API_P13_LAZY_SEND__CancelBlob;

  RemoteFB__API_P13_LAZY_SEND__CancelBlob(const self_type&)=delete;
