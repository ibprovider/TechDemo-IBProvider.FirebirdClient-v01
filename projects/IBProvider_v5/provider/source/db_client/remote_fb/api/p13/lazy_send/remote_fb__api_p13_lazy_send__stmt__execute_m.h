...
//! \file    remote_fb__api_p13_lazy_send__stmt__execute_m.h
//! \brief   The API function for a statement execution. The version for a lazy_send-protocol.
//! \author  Kovalenko Dmitry
//! \date    11.04.2023
#ifndef _remote_fb__api_p13_lazy_send__stmt__execute_m_H_
#define _remote_fb__api_p13_lazy_send__stmt__execute_m_H_
...
//! @{
////////////////////////////////////////////////////////////////////////////////
//class RemoteFB__API_P13_LAZY_SEND__ExecuteStatement_M

/// <summary>
///  The API function for a statement execution.
/// </summary>
class RemoteFB__API_P13_LAZY_SEND__ExecuteStatement_M LCPI_CPP_CFG__CLASS__FINAL
 :public REMOTE_FB__DEF_INTERFACE_IMPL_STATIC(RemoteFB__API__ExecuteStatement_M)
{
 private:
  using self_type=RemoteFB__API_P13_LAZY_SEND__ExecuteStatement_M;

  RemoteFB__API_P13_LAZY_SEND__ExecuteStatement_M(const self_type&)=delete;
 ...
 private:
  RemoteFB__API_P13_LAZY_SEND__ExecuteStatement_M();

  virtual ~RemoteFB__API_P13_LAZY_SEND__ExecuteStatement_M();
