...
//! \file    remote_fb__api_p13__trans__rollback.cpp
...
RemoteFB__API_P13__Rollback RemoteFB__API_P13__Rollback::Instance;

//------------------------------------------------------------------------
RemoteFB__API_P13__Rollback::RemoteFB__API_P13__Rollback()
{;}
...
//------------------------------------------------------------------------
void RemoteFB__API_P13__Rollback::exec(RemoteFB__ConnectorData* const pData,
                                       tr_handle_type*          const pTrHandle)
{
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P13__Rollback::exec";
 ...
 //-----------------------------------------
 const protocol::set02::P_OP c_OperationID=protocol::set02::op_rollback;
