...
//! \file    remote_fb__api_p13__array__put_slice.cpp
...
////////////////////////////////////////////////////////////////////////////////
//class RemoteFB__API_P13__PutArraySlice::tagOpGetArraySliceDescr

class RemoteFB__API_P13__PutArraySlice::tagOpGetArraySliceDescr LCPI_CPP_CFG__CLASS__FINAL
...
RemoteFB__API_P13__PutArraySlice::tagOpGetArraySliceDescr::tagOpGetArraySliceDescr()
{;}
...
const RemoteFB__ArraySliceDescr&
 RemoteFB__API_P13__PutArraySlice::tagOpGetArraySliceDescr::GetArraySliceDescr()const
{
 return m_descr;
}//GetArraySliceDescr

////////////////////////////////////////////////////////////////////////////////
//class RemoteFB__API_P13__PutArraySlice

RemoteFB__API_P13__PutArraySlice RemoteFB__API_P13__PutArraySlice::Instance;

//------------------------------------------------------------------------
RemoteFB__API_P13__PutArraySlice::RemoteFB__API_P13__PutArraySlice()
{;}
...
//interface --------------------------------------------------------------
void RemoteFB__API_P13__PutArraySlice::exec(db_obj::t_db_operation_context& opCtx,
                                            ...
                                            const void*               const pArrayData)
{
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P13__PutArraySlice::exec";
 ...
 //-----------------------------------------
 const protocol::set02::P_OP c_OperationID=protocol::set02::op_put_slice;
