...
//! \file    remote_fb__api_p13_lazy_send__stmt__execute.cpp
...
RemoteFB__API_P13_LAZY_SEND__ExecuteStatement RemoteFB__API_P13_LAZY_SEND__ExecuteStatement::Instance;

//------------------------------------------------------------------------
RemoteFB__API_P13_LAZY_SEND__ExecuteStatement::RemoteFB__API_P13_LAZY_SEND__ExecuteStatement()
{;}
...
//interface --------------------------------------------------------------
void RemoteFB__API_P13_LAZY_SEND__ExecuteStatement::exec
                                            ...
                                            const isc_api::XSQLDA_V1* const pOutXSQLDA)
{
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P13_LAZY_SEND__ExecuteStatement::exec";
...
//------------------------------------------------------------------------
protocol::P_USHORT RemoteFB__API_P13_LAZY_SEND__ExecuteStatement::helper__execute
...
//------------------------------------------------------------------------
protocol::P_OBJCT RemoteFB__API_P13_LAZY_SEND__ExecuteStatement::helper__execute2
                                           (RemoteFB__P13__SrvOperation&    serverOperation,
                                            RemoteFB__ConnectorData*  const pData,
                                            tr_handle_type*           const pTrHandle,
                                            stmt_handle_type*         const pStmtHandle,
                                            ...
                                            const isc_api::XSQLDA_V1* const pOutXSQLDA)
{
 ...
 //-----------------------------------------
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P13_LAZY_SEND__ExecuteStatement::helper__execute2";
 ...
 (*pStmtHandle)->m_OutParams__MSG_DATA.alloc
  ((*pStmtHandle)->m_OutParams__MSG_DATA_SIZE);
 ...
 //-----------------------------------------
 const protocol::set02::P_OP c_OperationID1=protocol::set02::op_free_statement;
 const protocol::set02::P_OP c_OperationID2=protocol::set02::op_execute2;

 {
  ...
  //---------------------------------------- 2.2 build packet2 EXECUTE2
  {
   ...
   RemoteFB__P13__Utilities::CheckAndSetLength__CSTRING_CONST_V2
    (&packet2.p_sqldata.p_sqldata__blr,
     (*pStmtHandle)->m_InParams__MSG_BLR.size(),
     ibp_mce_isc__blr_data_for_xsqlda_is_too_long_3,
     L"pInXSQLDA");

   assert(packet2.p_sqldata.p_sqldata__blr.cstr_length==(*pStmtHandle)->m_InParams__MSG_BLR.size());
   ...
   RemoteFB__P13__Utilities::CheckAndSetLength__CSTRING_CONST_V2
    (&packet2.p_sqldata.p_sqldata__out_blr,
     (*pStmtHandle)->m_OutParams__MSG_BLR.size(),
     ibp_mce_isc__blr_data_for_xsqlda_is_too_long_3,
     L"pOutXSQLDA");

   assert(packet2.p_sqldata.p_sqldata__out_blr.cstr_length==(*pStmtHandle)->m_OutParams__MSG_BLR.size());
 ...
 try // сторож сбоев работы с портом
 {
...

  {
   ...
   if(packet2.operation==protocol::set02::op_sql_response)
   {
  ...
  //----------------------------------------- 4.3 get response3
  {
   protocol::set02::PACKET_V02 packet3;
