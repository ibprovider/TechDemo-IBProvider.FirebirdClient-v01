...
RemoteFB__API_P13_LAZY_SEND__FetchStatement RemoteFB__API_P13_LAZY_SEND__FetchStatement::Instance;
                                            ...
                                            const isc_api::XSQLDA_V1* const pOutXSQLDA)
{
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P13_LAZY_SEND__FetchStatement::exec";
...
//helper methods ---------------------------------------------------------
void RemoteFB__API_P13_LAZY_SEND__FetchStatement::helper__fetch_next_rows
                                            ...
                                            stmt_data_type*          const pStmt)
{
 ...
 //-----------------------------------------
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P13_LAZY_SEND__FetchStatement::helper__fetch_next_rows";
 ...
 try //сторож сбоев работы с портом
 {
  ...
  if(send_op2__exec)
  {
   if(packet2__exec.operation==protocol::set02::op_response)
   {
    ...
    spExecuteSrvErr=pset02::RemoteFB__PSET02__ErrorUtilites::BuildServerErrorRecord
                      (pData,
  ...
  if(spExecuteSrvErr)
  {
   ...
   if(packet3__fetch.operation==protocol::set02::op_response)
   {
    const t_ibp_error_element::self_ptr
     spFetchSrvRec=pset02::RemoteFB__PSET02__ErrorUtilites::BuildServerErrorRecord
                    (pData,
