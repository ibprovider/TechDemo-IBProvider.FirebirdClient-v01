...
//! \file    remote_fb__api_p13__array__put_slice.h
//! \brief   —охранение массива.
//! \author  Kovalenko Dmitry.
//! \date    24.09.2016
#ifndef _remote_fb__api_p13__array__put_slice_H_
#define _remote_fb__api_p13__array__put_slice_H_
...
///  —охранение массива.
/// </summary>
class RemoteFB__API_P13__PutArraySlice LCPI_CPP_CFG__CLASS__FINAL
 :public REMOTE_FB__DEF_INTERFACE_IMPL_STATIC(RemoteFB__API__PutArraySlice)
{
 ...
 public:
  ...
  virtual ~RemoteFB__API_P13__PutArraySlice();
