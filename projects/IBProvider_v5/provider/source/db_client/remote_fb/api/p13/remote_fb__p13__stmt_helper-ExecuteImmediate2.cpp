...
//! \file    remote_fb__p13__stmt_helper-ExecuteImmediate.cpp
                              ...
                              RemoteFB__OpSvc__StmtExecuteData_v2* const pStmtExecData)
{
 ...
 if(pStmtExecData->InMsg_BLR.empty())
 {
  ...
  assert(pStmtExecData->InMsg_DATA_DESCRS.empty());
  assert(pStmtExecData->InMsg_NULLS.empty());
 }
 else
 {
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__P13__StmtHelper::ExecuteImmediate2";
