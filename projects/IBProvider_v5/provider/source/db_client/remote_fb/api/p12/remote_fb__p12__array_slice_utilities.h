...
//! \file    remote_fb__p12__array_slice_utilities.h
//! \brief   Набор утилит для работы с массивами базы данных.
//! \author  Kovalenko Dmitry
//! \date    28.09.2015
#ifndef _remote_fb__p12__array_slice_utilities_H_
#define _remote_fb__p12__array_slice_utilities_H_
...
class RemoteFB__P12__ArraySlice_Utilities LCPI_CPP_CFG__CLASS__FINAL
{
 private:
  typedef RemoteFB__P12__ArraySlice_Utilities              self_type;
