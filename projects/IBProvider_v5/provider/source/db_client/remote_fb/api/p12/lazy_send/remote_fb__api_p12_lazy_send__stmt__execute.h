...
//! \file    remote_fb__api_p12_lazy_send__stmt__execute.h
//! \brief   Выполнение запроса. Версия для lazy_send-протокола.
//! \author  Kovalenko Dmitry
//! \date    28.10.2015
#ifndef _remote_fb__api_p12_lazy_send__stmt__execute_H_
#define _remote_fb__api_p12_lazy_send__stmt__execute_H_
...
/// <summary>
///  Выполнение запроса. Версия для lazy_send-протокола.
/// </summary>
class RemoteFB__API_P12_LAZY_SEND__ExecuteStatement LCPI_CPP_CFG__CLASS__FINAL
 :public REMOTE_FB__DEF_INTERFACE_IMPL_STATIC(RemoteFB__API__ExecuteStatement)
{
 private:
  using self_type=RemoteFB__API_P12_LAZY_SEND__ExecuteStatement;

  RemoteFB__API_P12_LAZY_SEND__ExecuteStatement(const self_type&)=delete;
 ...
 private:
  RemoteFB__API_P12_LAZY_SEND__ExecuteStatement();

  virtual ~RemoteFB__API_P12_LAZY_SEND__ExecuteStatement();
 ...
 private:
  ...
  static protocol::P_OBJCT helper__execute2(RemoteFB__P12__SrvOperation&  serverOperation,
                                            RemoteFB__ConnectorData*      pData,
                                            tr_handle_type*               pTrHandle,
                                            stmt_handle_type*             pStmtHandle,
                                            const isc_api::XSQLDA_V1*     pInXSQLDA,
