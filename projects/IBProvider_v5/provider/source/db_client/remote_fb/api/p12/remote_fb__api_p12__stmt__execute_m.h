...
//! \file    remote_fb__api_p12__stmt__execute_m.h
//! \brief   The API function for a statement execution.
//! \author  Kovalenko Dmitry
//! \date    04.04.2023
#ifndef _remote_fb__api_p12__stmt__execute_m_H_
#define _remote_fb__api_p12__stmt__execute_m_H_
...
/// </summary>
class RemoteFB__API_P12__ExecuteStatement_M LCPI_CPP_CFG__CLASS__FINAL
 :public REMOTE_FB__DEF_INTERFACE_IMPL_STATIC(RemoteFB__API__ExecuteStatement_M)
{
 private:
  using self_type=RemoteFB__API_P12__ExecuteStatement_M;

  RemoteFB__API_P12__ExecuteStatement_M(const self_type&)=delete;
 ...
 private:
  RemoteFB__API_P12__ExecuteStatement_M();

  virtual ~RemoteFB__API_P12__ExecuteStatement_M();
