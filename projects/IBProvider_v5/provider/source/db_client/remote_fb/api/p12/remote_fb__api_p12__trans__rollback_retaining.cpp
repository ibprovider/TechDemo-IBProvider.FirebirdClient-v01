...
//! \file    remote_fb__api_p12__trans__rollback_retaining.cpp
...
RemoteFB__API_P12__RollbackRetaining RemoteFB__API_P12__RollbackRetaining::Instance;

//------------------------------------------------------------------------
RemoteFB__API_P12__RollbackRetaining::RemoteFB__API_P12__RollbackRetaining()
{;}
...
//------------------------------------------------------------------------
void RemoteFB__API_P12__RollbackRetaining::exec(RemoteFB__ConnectorData* const pData,
                                                tr_handle_type*          const pTrHandle)
{
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P12__RollbackRetaining::exec";
 ...
 //-----------------------------------------
 const protocol::set01::P_OP c_OperationID=protocol::set01::op_rollback_retaining;
