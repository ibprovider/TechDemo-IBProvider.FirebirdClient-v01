...
//! \file    remote_fb__api_p12_lazy_send__stmt__fetch.h
//! \brief   Выборка результатов выполнения запроса. Версия для lazy_send-протокола.
//! \author  Kovalenko Dmitry
//! \date    29.10.2015
#ifndef _remote_fb__api_p12_lazy_send__stmt__fetch_H_
#define _remote_fb__api_p12_lazy_send__stmt__fetch_H_
...
/// </summary>
class RemoteFB__API_P12_LAZY_SEND__FetchStatement LCPI_CPP_CFG__CLASS__FINAL
 :public REMOTE_FB__DEF_INTERFACE_IMPL_STATIC(RemoteFB__API__FetchStatement)
{
 private:
  typedef RemoteFB__API_P12_LAZY_SEND__FetchStatement              self_type;

  RemoteFB__API_P12_LAZY_SEND__FetchStatement(const self_type&);
 ...
 private:
  RemoteFB__API_P12_LAZY_SEND__FetchStatement();

  virtual ~RemoteFB__API_P12_LAZY_SEND__FetchStatement();
 ...
 private:
  ...
  //! \param[in] pStmt
  //!  Not null.
  static void helper__fetch_next_rows(RemoteFB__P12__SrvOperation&   serverOperation,
                                      RemoteFB__ConnectorData*       pData,
