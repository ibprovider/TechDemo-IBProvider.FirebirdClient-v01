...
//! \file    remote_fb__api_p12__stmt__drop.h
//! \brief   Освобождение дескриптора запроса.
//! \author  Kovalenko Dmitry
//! \date    25.02.2015
#ifndef _remote_fb__api_p12__stmt__drop_H_
#define _remote_fb__api_p12__stmt__drop_H_
...
//! @{
////////////////////////////////////////////////////////////////////////////////
//class RemoteFB__API_P12__DropStatement

/// <summary>
///  Освобождение дескриптора запроса.
/// </summary>
class RemoteFB__API_P12__DropStatement LCPI_CPP_CFG__CLASS__FINAL
 :public REMOTE_FB__DEF_INTERFACE_IMPL_STATIC(RemoteFB__API__DropStatement)
{
 private:
  using self_type=RemoteFB__API_P12__DropStatement;

  RemoteFB__API_P12__DropStatement(const self_type&)=delete;
  self_type& operator = (const self_type&)=delete;

 private:
  RemoteFB__API_P12__DropStatement();

  virtual ~RemoteFB__API_P12__DropStatement();
