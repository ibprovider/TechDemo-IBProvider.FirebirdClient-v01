...
//! \file    remote_fb__api_p12__stmt__drop.cpp
...
RemoteFB__API_P12__DropStatement RemoteFB__API_P12__DropStatement::Instance;

//------------------------------------------------------------------------
RemoteFB__API_P12__DropStatement::RemoteFB__API_P12__DropStatement()
{;}
...
//interface --------------------------------------------------------------
void RemoteFB__API_P12__DropStatement::exec(RemoteFB__ConnectorData* const pData,
                                            stmt_handle_type*        const pStmtHandle)
{
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P12__DropStatement::exec";
