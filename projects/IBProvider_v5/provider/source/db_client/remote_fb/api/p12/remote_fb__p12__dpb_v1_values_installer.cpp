...
//! \file    remote_fb__p12__dpb_v1_values_installer.cpp
//! \brief    ласс установки параметров подключени€.
...
////////////////////////////////////////////////////////////////////////////////
//class RemoteFB__P12__DpbV1_ValuesInstaller

RemoteFB__P12__DpbV1_ValuesInstaller::RemoteFB__P12__DpbV1_ValuesInstaller
                                      (dpb_type*                              const pDPB,
                                       oledb_lib::OLEDB_Props2__Data__Values* const pDsPropValues,
                                       bool                                   const CnUseIntegratedAuth)
 :m_pDPB(pDPB)
 ,m_pDsPropValues(pDsPropValues)
 ,m_CnUseIntegratedAuth(CnUseIntegratedAuth)
{
 assert(m_pDPB);
...
void RemoteFB__P12__DpbV1_ValuesInstaller::set_dbinit_param___auth__integrated(wstr_box_type const UNUSED_ARG(propValue))
{
#ifndef NDEBUG
 ...
 if(!m_CnUseIntegratedAuth)
 {
  IBP_BUG_CHECK__DEBUG
   (L"RemoteFB__P12__DpbV1_ValuesInstaller::set_dbinit_param___auth__integrated",
    L"#001",
    me_bug_check__unexpected_situation_0)
 }//if !m_CnUseIntegratedAuth

 assert_hint(m_CnUseIntegratedAuth);
}//set_dbinit_param___auth__integrated

//------------------------------------------------------------------------
void RemoteFB__P12__DpbV1_ValuesInstaller::set_dbinit_param___auth__user_id(wstr_box_type const propValue)
{
#ifndef NDEBUG
...
//------------------------------------------------------------------------
void RemoteFB__P12__DpbV1_ValuesInstaller::set_dbinit_param___auth__password(wstr_box_type const propValue)
{
#ifndef NDEBUG
 ...
 if(!IBP_Utils::WStrToUtf8__Fast(propValue,&mbc_str))
 {
...
//------------------------------------------------------------------------
void RemoteFB__P12__DpbV1_ValuesInstaller::set_dbinit_param___auth__rolename(wstr_box_type const propValue)
{
#ifndef NDEBUG
...
//------------------------------------------------------------------------
void RemoteFB__P12__DpbV1_ValuesInstaller::set_dbinit_param___ctype(wstr_box_type const propValue)
{
#ifndef NDEBUG
...
//------------------------------------------------------------------------
void RemoteFB__P12__DpbV1_ValuesInstaller::set_dbinit_param___garbage_collect(bool const propValue)
{
#ifndef NDEBUG
...
//------------------------------------------------------------------------
void RemoteFB__P12__DpbV1_ValuesInstaller::set_dbinit_param___num_buffers(long const propValue)
{
#ifndef NDEBUG
...
//------------------------------------------------------------------------
void RemoteFB__P12__DpbV1_ValuesInstaller::set_dbinit_param___enable_db_trigger(long const propValue)
{
#ifndef NDEBUG
...
//------------------------------------------------------------------------
void RemoteFB__P12__DpbV1_ValuesInstaller::set_dbinit_param___sys_encrypt_password(wstr_box_type const UNUSED_ARG(propValue))
{
#ifndef NDEBUG
...
void RemoteFB__P12__DpbV1_ValuesInstaller::set_newdb_param___db_dialect(long const propValue)
{
#ifndef NDEBUG
...
//------------------------------------------------------------------------
void RemoteFB__P12__DpbV1_ValuesInstaller::set_newdb_param___page_size(long const propValue)
{
#ifndef NDEBUG
...
//------------------------------------------------------------------------
void RemoteFB__P12__DpbV1_ValuesInstaller::set_newdb_param___type_of_db_users(long const propValue)
{
#ifndef NDEBUG
