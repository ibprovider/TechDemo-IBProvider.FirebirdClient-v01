...
//! \file    remote_fb__api_p12__dsql__execute_immediate_m.cpp
...
RemoteFB__API_P12__ExecuteImmediate_M RemoteFB__API_P12__ExecuteImmediate_M::Instance;

//------------------------------------------------------------------------
RemoteFB__API_P12__ExecuteImmediate_M::RemoteFB__API_P12__ExecuteImmediate_M()
{
}
...
//interface --------------------------------------------------------------
void RemoteFB__API_P12__ExecuteImmediate_M::exec(db_obj::t_db_operation_context&  OpCtx,
                                                 ...
                                                 const RemoteFB__OutMsg_v1* const pOutMsg)
{
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P12__ExecuteImmediate_M::exec";
...
//helper methods ---------------------------------------------------------
protocol::P_OBJCT
 RemoteFB__API_P12__ExecuteImmediate_M::helper__execute
...
//------------------------------------------------------------------------
protocol::P_OBJCT
 RemoteFB__API_P12__ExecuteImmediate_M::helper__execute2
                             (RemoteFB__P12__SrvOperation&     serverOperation,
                              RemoteFB__ConnectorData*   const pData,
                              tr_handle_type*            const pTrHandle,
                              protocol::P_USHORT         const SQL_dialect,
