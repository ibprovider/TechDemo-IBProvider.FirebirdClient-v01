...
//! \file    remote_fb__api_p12__stmt__get_columns.cpp
...
RemoteFB__API_P12__GetColumns RemoteFB__API_P12__GetColumns::Instance;

//------------------------------------------------------------------------
RemoteFB__API_P12__GetColumns::RemoteFB__API_P12__GetColumns()
{;}
...
//interface --------------------------------------------------------------
void RemoteFB__API_P12__GetColumns::exec(db_obj::t_db_operation_context& OpCtx,
                                         ...
                                         isc_api::XSQLDA_V1*       const xsqlda)
{
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P12__GetColumns::exec";
 ...
 try
 {
  ...
  for(;;)
  {
   ...
   if((*pos)!=isc_api::ibp_isc_info_sql_select)
   {
