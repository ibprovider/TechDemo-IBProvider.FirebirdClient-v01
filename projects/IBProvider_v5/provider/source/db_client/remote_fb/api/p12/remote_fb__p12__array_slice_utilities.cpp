...
//! \file    remote_fb__p12__array_slice_utilities.cpp
...
//! @{
////////////////////////////////////////////////////////////////////////////////
//class RemoteFB__P12__ArraySlice_Utilities

void RemoteFB__P12__ArraySlice_Utilities::ParseSDL
 ...
 for(bool stop=false;!stop;)
 {
  ...
  switch(byte_type op=sdl_reader.read_byte(c_bugcheck_src,L"#004"))
  {
   ...
   case isc_api::ibp_isc_sdl_struct:
   {
    ...
    Helper__ParseSDL__ReadElementType(sdl_reader,
                                      pDescr); //throw
...
//helper methods ---------------------------------------------------------
void RemoteFB__P12__ArraySlice_Utilities::Helper__ParseSDL__ReadElementType
                                            ...
                                            RemoteFB__ArraySliceDescr* const pDescr)
{
 ...
 //-----------------------------------------
 const size_t blrTypeIdOffset=sdlReader.current_offset();

 pDescr->m_element_blr_typeid=sdlReader.read_byte(c_bugcheck_src,
                                                  L"#001");
 ...
 switch(pDescr->m_element_blr_typeid)
 {
  ...
  {
   pDescr->m_element_sql_scale=sdlReader.read_i1(c_bugcheck_src,
                                                 L"#002");
...
//------------------------------------------------------------------------
RemoteFB__P12__ArraySlice_Utilities::value_i4_type
 RemoteFB__P12__ArraySlice_Utilities::Helper__ParseSDL__ReadLiteral(tag_sdl_reader& sdlReader)
{
 const wchar_t* const c_bugcheck_src
...
//------------------------------------------------------------------------
void RemoteFB__P12__ArraySlice_Utilities::Helper__ParseSDL__ReadElement
                                           (tag_sdl_reader&                  sdlReader,
