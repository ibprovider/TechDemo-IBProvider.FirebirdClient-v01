...
//! \file    remote_fb__api_p12__blob__get_info.cpp
...
////////////////////////////////////////////////////////////////////////////////
//class RemoteFB__API_P12__GetBlobInfo::tagOpMemoryBuffer

class RemoteFB__API_P12__GetBlobInfo::tagOpMemoryBuffer:public RemoteFB__MemoryPool
{
 private:
...
RemoteFB__API_P12__GetBlobInfo::tagOpMemoryBuffer::tagOpMemoryBuffer
...
//interface --------------------------------------------------------------
void* RemoteFB__API_P12__GetBlobInfo::tagOpMemoryBuffer::allocate
...
RemoteFB__API_P12__GetBlobInfo RemoteFB__API_P12__GetBlobInfo::Instance;

//------------------------------------------------------------------------
RemoteFB__API_P12__GetBlobInfo::RemoteFB__API_P12__GetBlobInfo()
{;}
...
//interface --------------------------------------------------------------
void RemoteFB__API_P12__GetBlobInfo::exec(RemoteFB__ConnectorData* const pData,
                                          ...
                                          RemoteFB__InfoBuffer&          ResultBuffer)
{
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P12__GetBlobInfo::exec";
 ...
 //-----------------------------------------
 const protocol::set01::P_OP c_OperationID=protocol::set01::op_info_blob;
