...
//! \file    remote_fb__p12__dpb_v1_values_installer.h
//! \brief   Класс установки параметров подключения.
//! \author  Kovalenko Dmitry
//! \date    26.02.2019
#ifndef _remote_fb__p12__dpb_v1_values_installer_H_
#define _remote_fb__p12__dpb_v1_values_installer_H_
...
class RemoteFB__P12__DpbV1_ValuesInstaller LCPI_CPP_CFG__CLASS__FINAL
 :public isc_base::isc_base__dbparams_for_attach__installer
 ,public isc_base::isc_base__dbparams_for_create__installer
{
 private:
  using self_type=RemoteFB__P12__DpbV1_ValuesInstaller;

  RemoteFB__P12__DpbV1_ValuesInstaller(const self_type&)=delete;
 ...
 public:
  ...
  explicit RemoteFB__P12__DpbV1_ValuesInstaller
            (dpb_type*                              pDPB,
