...
size_t RemoteFB__P12__XSQLDA_Utilities::Helper__AddMsgLength
                                           (size_t        cbMsg,
                                            ...
                                            size_t const cbElement)
{
 const wchar_t* const c_bugcheck_src=
  L"RemoteFB__P12__XSQLDA_Utilities::Helper__AddMsgLength";
...
//------------------------------------------------------------------------
size_t RemoteFB__P12__XSQLDA_Utilities::Helper__AlignMsgLength
                                           (size_t        cbMsg,
                                            size_t  const cbAlign,
                                            size_t* const pcbResultAlign)
{
 ...
 const wchar_t* const c_bugcheck_src=
  L"RemoteFB__P12__XSQLDA_Utilities::Helper__AlignMsgLength";
