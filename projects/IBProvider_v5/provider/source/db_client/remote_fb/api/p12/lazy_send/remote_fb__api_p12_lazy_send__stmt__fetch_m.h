...
//! \date    16.04.2023
#ifndef _remote_fb__api_p12_lazy_send__stmt__fetch_m_H_
#define _remote_fb__api_p12_lazy_send__stmt__fetch_m_H_
...
/// <summary>
///  API for fetching the row of result set. The version for the lazy_send-protocol.
/// </summary>
class RemoteFB__API_P12_LAZY_SEND__FetchStatement_M LCPI_CPP_CFG__CLASS__FINAL
 :public REMOTE_FB__DEF_INTERFACE_IMPL_STATIC(RemoteFB__API__FetchStatement_M)
{
 private:
  using self_type=RemoteFB__API_P12_LAZY_SEND__FetchStatement_M;

  RemoteFB__API_P12_LAZY_SEND__FetchStatement_M(const self_type&)=delete;
 ...
 private:
  RemoteFB__API_P12_LAZY_SEND__FetchStatement_M();

  virtual ~RemoteFB__API_P12_LAZY_SEND__FetchStatement_M();
