...
//! \file    remote_fb__api_p12__array__get_slice.cpp
...
////////////////////////////////////////////////////////////////////////////////
//class RemoteFB__API_P12__GetArraySlice::tagOpMemoryBuffer

class RemoteFB__API_P12__GetArraySlice::tagOpMemoryBuffer:public RemoteFB__MemoryPool
{
 private:
...
RemoteFB__API_P12__GetArraySlice::tagOpMemoryBuffer::tagOpMemoryBuffer
...
//interface --------------------------------------------------------------
void* RemoteFB__API_P12__GetArraySlice::tagOpMemoryBuffer::allocate
                                           (enumMemoryID const memID,
                                            size_t       const sz)
{
 const wchar_t* const c_bug_check_src
  =L"RemoteFB__API_P12__GetArraySlice::tagOpMemoryBuffer::allocate";
...
////////////////////////////////////////////////////////////////////////////////
//class RemoteFB__API_P12__GetArraySlice::tagOpGetArraySliceDescr
...
};//RemoteFB__API_P12__GetArraySlice::tagOpGetArraySliceDescr

////////////////////////////////////////////////////////////////////////////////
//class RemoteFB__API_P12__GetArraySlice::tagOpGetArraySliceDescr

RemoteFB__API_P12__GetArraySlice::tagOpGetArraySliceDescr::tagOpGetArraySliceDescr()
{;}
...
const RemoteFB__ArraySliceDescr&
 RemoteFB__API_P12__GetArraySlice::tagOpGetArraySliceDescr::GetArraySliceDescr()const
{
 return m_descr;
}//GetArraySliceDescr
...
RemoteFB__API_P12__GetArraySlice RemoteFB__API_P12__GetArraySlice::Instance;

//------------------------------------------------------------------------
RemoteFB__API_P12__GetArraySlice::RemoteFB__API_P12__GetArraySlice()
{;}
...
//interface --------------------------------------------------------------
void RemoteFB__API_P12__GetArraySlice::exec(db_obj::t_db_operation_context& opCtx,
                                            ...
                                            void*                     const pArrayData)
{
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P12__GetArraySlice::exec";
 ...
 RemoteFB__P12__ArraySlice_Utilities::ParseSDL
  (opCtx,
   szArraySDL,
   pArraySDL,
 ...
 //-----------------------------------------
 const protocol::set01::P_OP c_OperationID=protocol::set01::op_get_slice;

 {
  ...
  structure::static_numeric_cast(&packet.p_get_slc.p_get_slc__length,
                                 szArrayData);

  //---------------------------------------- p_get_slc_sdl
  if(!structure::can_numeric_cast(&packet.p_get_slc.p_get_slc__sdl.cstr_length,
                                  szArraySDL))
  {
   ...
   IBP_ErrorUtils::Throw__Error
    (E_FAIL,
     ...
     szArraySDL,
     structure::get_numeric_limits(packet.p_get_slc.p_get_slc__sdl.cstr_length).max_value());
  }//if

  structure::static_numeric_cast(&packet.p_get_slc.p_get_slc__sdl.cstr_length,
                                 szArraySDL);
 ...
 for(;;)
 {
  ...
  if(packet.operation==protocol::set01::op_slice)
  {
