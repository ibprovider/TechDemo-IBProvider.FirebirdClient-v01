...
//! \file    remote_fb__api_p12_lazy_send__stmt__prepare.cpp
...
RemoteFB__API_P12_LAZY_SEND__PrepareStatement RemoteFB__API_P12_LAZY_SEND__PrepareStatement::Instance;

//------------------------------------------------------------------------
RemoteFB__API_P12_LAZY_SEND__PrepareStatement::RemoteFB__API_P12_LAZY_SEND__PrepareStatement()
{;}
...
//------------------------------------------------------------------------
void RemoteFB__API_P12_LAZY_SEND__PrepareStatement::exec
                                            ...
                                            unsigned long*            const pStmtTypeID)
{
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P12_LAZY_SEND__PrepareStatement::exec";
...
//helper methods ---------------------------------------------------------
void RemoteFB__API_P12_LAZY_SEND__PrepareStatement::helper__exec__prepare
                                            ...
                                            sql_str_box_type         const SQL_str)
{
 ...
 //-----------------------------------------
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P12_LAZY_SEND__PrepareStatement::helper__exec__prepare";
...
//------------------------------------------------------------------------
void RemoteFB__API_P12_LAZY_SEND__PrepareStatement::helper__exec__allocate_and_prepare
                                           (RemoteFB__P12__SrvOperation&   serverOperation,
                                            RemoteFB__ConnectorData* const pData,
                                            tr_handle_type*          const pTrHandle,
                                            stmt_data_type*          const pStmt,
                                            ...
                                            sql_str_box_type         const SQL_str)
{
 ...
 //-----------------------------------------
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P12_LAZY_SEND__PrepareStatement::helper__exec__allocate_and_prepare";

 //-----------------------------------------
 const protocol::set01::P_OP c_OperationID1=protocol::set01::op_allocate_statement;
 const protocol::set01::P_OP c_OperationID2=protocol::set01::op_prepare_statement;
 ...
 try // сторож сбоев работы с портом
 {
  ...
  if(packet1.operation==protocol::set01::op_response)
  {
   isc_api::t_ibp_isc_status const allocateResultCode
    =pset01::RemoteFB__PSET01__ErrorUtilites::GetResultCode
      (pData,
       c_OperationID1,
       packet1.p_resp);
...
//------------------------------------------------------------------------
void RemoteFB__API_P12_LAZY_SEND__PrepareStatement::helper__exec__close_and_prepare
                                           (RemoteFB__P12__SrvOperation&   serverOperation,
                                            RemoteFB__ConnectorData* const pData,
                                            tr_handle_type*          const pTrHandle,
                                            stmt_data_type*          const pStmt,
                                            ...
                                            sql_str_box_type         const SQL_str)
{
 ...
 //-----------------------------------------
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P12_LAZY_SEND__PrepareStatement::helper__exec__close_and_prepare";

 //-----------------------------------------
 const protocol::set01::P_OP c_OperationID1__close   =protocol::set01::op_free_statement;
 const protocol::set01::P_OP c_OperationID2__prepare =protocol::set01::op_prepare_statement;

 {
  ...
  //---------------------------------------- 3. build packet2
  protocol::set01::PACKET_V01 packet2__prepare;
 ...
 try // сторож сбоев работы с портом
 {
  ...
  else
  {
   ...
   assert(packet1__close.operation!=protocol::set01::op_response);
  ...
  if(packet2__prepare.operation==protocol::set01::op_response)
  {
   //в данной точке мы можем уже быть уверены, что порт находится в согласованном состоянии
   PortStateGuardIsActive=false;
  ...
  else
  {
   ...
   assert(packet2__prepare.operation!=protocol::set01::op_response);
