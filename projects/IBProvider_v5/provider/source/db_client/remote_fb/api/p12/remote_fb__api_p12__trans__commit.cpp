...
//! \file    remote_fb__api_p12__trans__commit.cpp
...
RemoteFB__API_P12__Commit RemoteFB__API_P12__Commit::Instance;

//------------------------------------------------------------------------
RemoteFB__API_P12__Commit::RemoteFB__API_P12__Commit()
{;}
...
//------------------------------------------------------------------------
void RemoteFB__API_P12__Commit::exec(RemoteFB__ConnectorData* const pData,
                                     tr_handle_type*          const pTrHandle)
{
 ...
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__API_P12__Commit::exec";
 ...
 //-----------------------------------------
 const protocol::set01::P_OP c_OperationID=protocol::set01::op_commit;
