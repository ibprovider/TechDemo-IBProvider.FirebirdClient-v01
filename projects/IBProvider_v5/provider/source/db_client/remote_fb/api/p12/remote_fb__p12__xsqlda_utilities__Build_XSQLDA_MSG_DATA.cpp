...
//! \file    remote_fb__p12__xsqlda_utilities__Build_XSQLDA_MSG_DATA.cpp
...
void RemoteFB__P12__XSQLDA_Utilities::Build_XSQLDA_MSG_DATA
...
//------------------------------------------------------------------------
size_t RemoteFB__P12__XSQLDA_Utilities::Helper__Build_XSQLDA_MSG_DATA__CalcBufSize
                                           (const isc_api::XSQLDA_V1* const pXSQLDA)
{
 assert(pXSQLDA!=nullptr);
 assert(pXSQLDA->version==isc_api::XSQLDA_V1::c_version_num);
...
//------------------------------------------------------------------------
void RemoteFB__P12__XSQLDA_Utilities::Helper__Build_XSQLDA_MSG_DATA__FillBuf
                                           (const isc_api::XSQLDA_V1* const pXSQLDA,
                                            msg_data_buffer_type&           DataBuffer)
{
 assert(pXSQLDA!=nullptr);
...
//------------------------------------------------------------------------
size_t RemoteFB__P12__XSQLDA_Utilities::Helper__Build_XSQLDA_MSG_DATA__FillBuf
                                           (const isc_api::XSQLVAR_V1* const pXSQLVAR,
                                            msg_data_buffer_type&            DataBuffer,
                                            size_t                           offset)
{
