...
//! \file    remote_fb__api_p10__db__attach.h
//! \brief   Подключение к базе данных.
//! \author  Kovalenko Dmitry
//! \date    03.12.2015
#ifndef _remote_fb__api_p10__db__attach_H_
#define _remote_fb__api_p10__db__attach_H_
...
/// </summary>
class RemoteFB__API_P10__AttachToDatabase LCPI_CPP_CFG__CLASS__FINAL
{
 private:
  typedef RemoteFB__API_P10__AttachToDatabase      self_type;
