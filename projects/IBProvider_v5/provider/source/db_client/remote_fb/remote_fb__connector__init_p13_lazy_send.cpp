...
//! \file    remote_fb__connector__init_p13_lazy_send.cpp
//! \brief   Инициализация 13-го протокола [LAZY SEND MODE].
...
#include "source/db_client/remote_fb/api/p13/lazy_send/remote_fb__api_p13_lazy_send__stmt__drop.h"
...
#include "source/db_client/remote_fb/api/p13/lazy_send/remote_fb__api_p13_lazy_send__stmt__fetch.h"
...
#include "source/db_client/remote_fb/api/p13/lazy_send/remote_fb__api_p13_lazy_send__blob__cancel.h"
...
void RemoteFB__Connector::Helper__FinalInitialize__P13__lazy_send()
{
 assert(m_spData);
 ...
 m_spData->m_API__ExecuteImmediate_M
  .init(&api::p13::RemoteFB__API_P13__ExecuteImmediate_M::Instance);

 //-----------------------------------------
 m_spData->m_API__AllocateStatement
  .init(&api::p13::RemoteFB__API_P13_LAZY_SEND__AllocateStatement::Instance);
 
 //-----------------------------------------
 m_spData->m_API__DropStatement
  .init(&api::p13::RemoteFB__API_P13_LAZY_SEND__DropStatement::Instance);

 //-----------------------------------------
 m_spData->m_API__PrepareStatement
  .init(&api::p13::RemoteFB__API_P13_LAZY_SEND__PrepareStatement::Instance);
 ...
 m_spData->m_API__ExecuteStatement
  .init(&api::p13::RemoteFB__API_P13_LAZY_SEND__ExecuteStatement::Instance);
 
 //-----------------------------------------
 m_spData->m_API__ExecuteStatement_M
  .init(&api::p13::RemoteFB__API_P13_LAZY_SEND__ExecuteStatement_M::Instance);
 
 //-----------------------------------------
 m_spData->m_API__FetchStatement
  .init(&api::p13::RemoteFB__API_P13_LAZY_SEND__FetchStatement::Instance);

 //-----------------------------------------
 m_spData->m_API__FetchStatement_M
  .init(&api::p13::RemoteFB__API_P13_LAZY_SEND__FetchStatement_M::Instance);

 //-----------------------------------------
 m_spData->m_API__CloseStatement
  .init(&api::p13::RemoteFB__API_P13_LAZY_SEND__CloseStatement::Instance);
 ...
 m_spData->m_API__CloseBlob
  .init(&api::p13::RemoteFB__API_P13_LAZY_SEND__CloseBlob::Instance);

 //-----------------------------------------
 m_spData->m_API__CancelBlob
  .init(&api::p13::RemoteFB__API_P13_LAZY_SEND__CancelBlob::Instance);
...
}//Helper__FinalInitialize__P13__lazy_send
