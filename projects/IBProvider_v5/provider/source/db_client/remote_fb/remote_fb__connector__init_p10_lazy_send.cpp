...
//! \file    remote_fb__connector__init_p10_lazy_send.cpp
//! \brief   Инициализация 10-го протокола [LAZY SEND MODE].
...
void RemoteFB__Connector::Helper__FinalInitialize__P10__lazy_send()
{
 assert(m_spData);
 assert(m_spData->GetPort());
 assert(m_spData->GetPort()->get_protocol_version()==protocol::FB_PROTOCOL_VERSION10);
...
}//Helper__FinalInitialize__P10__lazy_send
