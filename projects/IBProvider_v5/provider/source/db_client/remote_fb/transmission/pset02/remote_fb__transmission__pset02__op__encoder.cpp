...
//! \file    remote_fb__transmission__pset02__op__encoder.cpp
...
void RemoteFB__PSET02__OpEncoder::encode__op_connect
                                ...
                                const protocol::set02::PACKET_V02& packet)
{
 ...
 const protocol::set02::P_OP_CNCT* const p_cnct=&packet.p_cnct;
 ...
 //----
 {
  const protocol::set02::P_OP_CNCT::P_OP_CNCT_REPEAT*       p=p_cnct->p_cnct__versions;
  const protocol::set02::P_OP_CNCT::P_OP_CNCT_REPEAT* const e=p+packet.p_cnct.p_cnct__count;
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_cont_auth
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
}//encode__op_cont_auth

//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_crypt
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
 ...
 const protocol::set02::P_OP_CRYPT* const p_crypt=&packet.p_crypt;
 ...
 xdr::encode__p_cstring_const
  (spBuf,
   &p_crypt->p_crypt__plugin);

 xdr::encode__p_cstring_const
  (spBuf,
   &p_crypt->p_crypt__key);
}//encode__op_crypt

//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_attach
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
 ...
 const protocol::set02::P_OP_ATCH* const p_atch=&packet.p_atch;
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_create
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_detach
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
 ...
 const protocol::set02::P_OP_RLSE* const p_rlse=&packet.p_rlse;
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_drop_database
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_info_database
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
 ...
 const protocol::set02::P_OP_INFO* const p_info=&packet.p_info;
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_transaction
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
 ...
 const protocol::set02::P_OP_STTR* const p_sttr=&packet.p_sttr;
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_rollback
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_rollback_retaining
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_commit
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_commit_retaining
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_prepare2
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
 ...
 const protocol::set02::P_OP_PREP* const p_prep=&packet.p_prep;
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_allocate_statement
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_free_statement
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
 ...
 const protocol::set02::P_OP_SQLFREE* const p_sqlfree=&packet.p_sqlfree;
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_prepare_statement
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_info_sql
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_execute__s
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_execute2__s
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_fetch
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_open_blob2
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
 ...
 const protocol::set02::P_OP_BLOB* const p_blob=&packet.p_blob;
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_create_blob2
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_close_blob
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_cancel_blob
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_info_blob
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_get_segment
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
 ...
 const protocol::set02::P_OP_SGMT* const p_sgmt=&packet.p_sgmt;
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_put_segment
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_put_slice__s
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_get_slice
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
 ...
 const protocol::set02::P_OP_GET_SLC* const p_get_slc=&packet.p_get_slc;
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_cancel
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
 ...
 const protocol::set02::P_OP_CANCEL* const p_cancel=&packet.p_cancel;
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_exec_immediate
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__OpEncoder::encode__op_exec_immediate2__s
                               (RemoteFB__PortOperationContext&    op_ctx,
                                const protocol::set02::PACKET_V02& packet)
{
