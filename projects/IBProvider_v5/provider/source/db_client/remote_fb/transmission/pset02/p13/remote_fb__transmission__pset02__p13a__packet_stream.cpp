...
//! \file    remote_fb__transmission__pset02__p13a__packet_stream.cpp
//! \brief   Поток пакетов асимметричного протокола v13.
...
////////////////////////////////////////////////////////////////////////////////
//struct RemoteFB__PSET02__P13A__PacketStream::tag_data

struct RemoteFB__PSET02__P13A__PacketStream::tag_data LCPI_CPP_CFG__CLASS__FINAL
{
 public:
  //упаковщики
...
#define DIRECT_FB__PACKET_ENCODER_DESCR_P13_A(op)  \
 DIRECT_FB__PACKET_ENCODER_DESCR(op,RemoteFB__PSET02__P13__OpEncoder::encode__##op##__a)

const RemoteFB__PSET02__PacketEncoderDescr RemoteFB__PSET02__P13A__PacketStream::tag_data::sm_encoders[]=
{
 ...
 /*59*/ DIRECT_FB__PACKET_ENCODER_DESCR_P13_A(op_put_slice)
 ...
 /*63*/ DIRECT_FB__PACKET_ENCODER_DESCR_P13_A(op_execute)
 ...
 /*75*/ DIRECT_FB__PACKET_ENCODER_DESCR_P13_A(op_exec_immediate2)
 /*76*/ DIRECT_FB__PACKET_ENCODER_DESCR_P13_A(op_execute2)
...
STARTUP_CODE_EX__DEBUG(check_encoders,
                       RemoteFB__PSET02__P13A__PacketStream::Debug__CheckEncoders);

////////////////////////////////////////////////////////////////////////////////
//Распаковщики

#define DIRECT_FB__PACKET_DECODER_DESCR_P13_A(op)  \
 DIRECT_FB__PACKET_ENCODER_DESCR(op,RemoteFB__PSET02__P13__OpDecoder::decode__##op##__a)

const RemoteFB__PSET02__PacketDecoderDescr RemoteFB__PSET02__P13A__PacketStream::tag_data::sm_decoders[]=
{
 ...
 /*60*/ DIRECT_FB__PACKET_DECODER_DESCR_P13_A(op_slice)
 ...
 /*66*/ DIRECT_FB__PACKET_DECODER_DESCR_P13_A(op_fetch_response)
 ...
 /*78*/ DIRECT_FB__PACKET_DECODER_DESCR_P13_A(op_sql_response)
...
STARTUP_CODE_EX__DEBUG(check_decoders,
                       RemoteFB__PSET02__P13A__PacketStream::Debug__CheckDecoders);

////////////////////////////////////////////////////////////////////////////////
//class RemoteFB__PSET02__P13A__PacketStream

RemoteFB__PSET02__P13A__PacketStream RemoteFB__PSET02__P13A__PacketStream::Instance;

//------------------------------------------------------------------------
RemoteFB__PSET02__P13A__PacketStream::RemoteFB__PSET02__P13A__PacketStream()
{;}

//stream interface -------------------------------------------------------
void RemoteFB__PSET02__P13A__PacketStream::SendPacket
                                           (RemoteFB__PortOperationContext& op_ctx,
                                            const protocol::PACKET&         packet)const
{
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__PSET02__P13A__PacketStream::SendPacket";
...
//------------------------------------------------------------------------
void RemoteFB__PSET02__P13A__PacketStream::ReceivePacket
                                           (RemoteFB__PortOperationContext& op_ctx,
                                            protocol::PACKET&               packet)const
{
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__PSET02__P13A__PacketStream::ReceivePacket";
...
void RemoteFB__PSET02__P13A__PacketStream::Debug__CheckEncoders()
{
...
void RemoteFB__PSET02__P13A__PacketStream::Debug__CheckDecoders()
{
