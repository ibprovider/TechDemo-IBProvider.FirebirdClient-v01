...
class RemoteFB__PSET02__P13_INIT__PacketStream:public RemoteFB__PacketStream
{
 private:
  typedef RemoteFB__PSET02__P13_INIT__PacketStream    self_type;

  RemoteFB__PSET02__P13_INIT__PacketStream(const self_type&);
