...
/// <summary>
class RemoteFB__PSET02__P13A__PacketStream:public RemoteFB__PacketStream
{
 private:
  typedef RemoteFB__PSET02__P13A__PacketStream    self_type;

  RemoteFB__PSET02__P13A__PacketStream(const self_type&);
