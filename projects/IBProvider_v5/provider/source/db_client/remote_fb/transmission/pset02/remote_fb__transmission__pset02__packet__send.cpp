...
//! \file    remote_fb__transmission__pset02__packet__send.cpp
...
static void Helper__RemoteFB__SendPacket__ThrowBugCheck__UnkOp
                                           (const wchar_t*        const place,
                                            ...
                                            protocol::set02::P_OP const operationID)
{
 assert(place);
 assert(point);
                                  ...
                                  const RemoteFB__PSET02__PacketEncoderDescr* const pEncoders)
{
 ...
 const RemoteFB__PSET02__PacketEncoderDescr& descr=pEncoders[idx];
