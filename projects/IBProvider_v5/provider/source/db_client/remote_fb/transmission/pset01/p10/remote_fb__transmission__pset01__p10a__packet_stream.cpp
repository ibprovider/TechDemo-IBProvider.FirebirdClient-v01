...
//! \file    remote_fb__transmission__pset01__p10a__packet_stream.cpp
//! \brief   Поток пакетов асимметричного протокола v10.
...
////////////////////////////////////////////////////////////////////////////////
//struct RemoteFB__PSET01__P10A__PacketStream::tag_data

struct RemoteFB__PSET01__P10A__PacketStream::tag_data LCPI_CPP_CFG__CLASS__FINAL
{
 public:
  //упаковщики
...
const RemoteFB__PSET01__PacketEncoderDescr RemoteFB__PSET01__P10A__PacketStream::tag_data::sm_encoders[]=
{
...
STARTUP_CODE_EX__DEBUG(check_encoders,
                       RemoteFB__PSET01__P10A__PacketStream::Debug__CheckEncoders);
...
const RemoteFB__PSET01__PacketDecoderDescr RemoteFB__PSET01__P10A__PacketStream::tag_data::sm_decoders[]=
{
...
STARTUP_CODE_EX__DEBUG(check_decoders,
                       RemoteFB__PSET01__P10A__PacketStream::Debug__CheckDecoders);

////////////////////////////////////////////////////////////////////////////////
//class RemoteFB__PSET01__P10A__PacketStream

RemoteFB__PSET01__P10A__PacketStream RemoteFB__PSET01__P10A__PacketStream::Instance;

//------------------------------------------------------------------------
RemoteFB__PSET01__P10A__PacketStream::RemoteFB__PSET01__P10A__PacketStream()
{;}

//stream interface -------------------------------------------------------
void RemoteFB__PSET01__P10A__PacketStream::SendPacket
                                           (RemoteFB__PortOperationContext& op_ctx,
                                            const protocol::PACKET&         packet)const
{
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__PSET01__P10A__PacketStream::SendPacket";
...
//------------------------------------------------------------------------
void RemoteFB__PSET01__P10A__PacketStream::ReceivePacket
                                           (RemoteFB__PortOperationContext& op_ctx,
                                            protocol::PACKET&               packet)const
{
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__PSET01__P10A__PacketStream::ReceivePacket";
...
void RemoteFB__PSET01__P10A__PacketStream::Debug__CheckEncoders()
{
...
void RemoteFB__PSET01__P10A__PacketStream::Debug__CheckDecoders()
{
