...
/// <summary>
class RemoteFB__PSET01__P11A__PacketStream:public RemoteFB__PacketStream
{
 private:
  typedef RemoteFB__PSET01__P11A__PacketStream    self_type;

  RemoteFB__PSET01__P11A__PacketStream(const self_type&);
