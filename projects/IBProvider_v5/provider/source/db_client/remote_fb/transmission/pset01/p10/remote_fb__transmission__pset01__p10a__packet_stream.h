...
//! \file    remote_fb__transmission__pset01__p10a__packet_stream.h
//! \brief   Поток пакетов асимметричного протокола v10.
//! \author  Kovalenko Dmitry
//! \date    03.12.2015
#ifndef _remote_fb__transmission__pset01__p10a__packet_stream_H_
#define _remote_fb__transmission__pset01__p10a__packet_stream_H_
...
/// <summary>
///  Поток пакетов асимметричного протокола v10.
/// <summary>
class RemoteFB__PSET01__P10A__PacketStream LCPI_CPP_CFG__CLASS__FINAL
 :public RemoteFB__PacketStream
{
 private:
  using self_type=RemoteFB__PSET01__P10A__PacketStream;

  RemoteFB__PSET01__P10A__PacketStream(const self_type&)=delete;
  self_type& operator = (const self_type&)=delete;

  /// <summary>
  ///  Конструктор по-умолчанию.
  /// </summary>
  RemoteFB__PSET01__P10A__PacketStream();
