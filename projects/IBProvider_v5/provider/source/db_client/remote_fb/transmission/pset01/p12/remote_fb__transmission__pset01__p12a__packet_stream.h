...
/// <summary>
class RemoteFB__PSET01__P12A__PacketStream LCPI_CPP_CFG__CLASS__FINAL
 :public RemoteFB__PacketStream
{
 private:
  using self_type=RemoteFB__PSET01__P12A__PacketStream;

  RemoteFB__PSET01__P12A__PacketStream(const self_type&)=delete;
