...
//! \file    remote_fb__transmission__pset01__p12s__packet_stream.cpp
//! \brief   Поток пакетов симметричного протокола v12.
...
////////////////////////////////////////////////////////////////////////////////
//struct RemoteFB__PSET01__P12S__PacketStream::tag_data

struct RemoteFB__PSET01__P12S__PacketStream::tag_data LCPI_CPP_CFG__CLASS__FINAL
{
 public:
  //упаковщики
...
const RemoteFB__PSET01__PacketEncoderDescr RemoteFB__PSET01__P12S__PacketStream::tag_data::sm_encoders[]=
{
...
STARTUP_CODE_EX__DEBUG(check_encoders,
                       RemoteFB__PSET01__P12S__PacketStream::Debug__CheckEncoders);

////////////////////////////////////////////////////////////////////////////////
//Распаковщики

const RemoteFB__PSET01__PacketDecoderDescr RemoteFB__PSET01__P12S__PacketStream::tag_data::sm_decoders[]=
{
...
STARTUP_CODE_EX__DEBUG(check_decoders,
                       RemoteFB__PSET01__P12S__PacketStream::Debug__CheckDecoders);

////////////////////////////////////////////////////////////////////////////////
//class RemoteFB__PSET01__P12S__PacketStream

RemoteFB__PSET01__P12S__PacketStream RemoteFB__PSET01__P12S__PacketStream::Instance;

//------------------------------------------------------------------------
RemoteFB__PSET01__P12S__PacketStream::RemoteFB__PSET01__P12S__PacketStream()
{;}

//stream interface -------------------------------------------------------
void RemoteFB__PSET01__P12S__PacketStream::SendPacket
                                           (RemoteFB__PortOperationContext& op_ctx,
                                            const protocol::PACKET&         packet)const
{
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__PSET01__P12S__PacketStream::SendPacket";
...
//------------------------------------------------------------------------
void RemoteFB__PSET01__P12S__PacketStream::ReceivePacket
                                           (RemoteFB__PortOperationContext& op_ctx,
                                            protocol::PACKET&               packet)const
{
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__PSET01__P12S__PacketStream::ReceivePacket";
...
void RemoteFB__PSET01__P12S__PacketStream::Debug__CheckEncoders()
{
...
void RemoteFB__PSET01__P12S__PacketStream::Debug__CheckDecoders()
{
