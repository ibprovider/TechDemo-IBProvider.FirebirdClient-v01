...
//! \file    remote_fb__transmission__pset01__p11a__packet_stream.cpp
//! \brief   Поток пакетов асимметричного протокола v11.
...
////////////////////////////////////////////////////////////////////////////////
//struct RemoteFB__PSET01__P11A__PacketStream::tag_data

struct RemoteFB__PSET01__P11A__PacketStream::tag_data LCPI_CPP_CFG__CLASS__FINAL
{
 public:
  //упаковщики
...
#define DIRECT_FB__PACKET_ENCODER_DESCR_P12_A(op)  \
 DIRECT_FB__PACKET_ENCODER_DESCR(op,p12::RemoteFB__PSET01__P12__OpEncoder::encode__##op##__a)

const RemoteFB__PSET01__PacketEncoderDescr RemoteFB__PSET01__P11A__PacketStream::tag_data::sm_encoders[]=
{
 ...
 /*59*/ DIRECT_FB__PACKET_ENCODER_DESCR_P12_A(op_put_slice)
 ...
 /*63*/ DIRECT_FB__PACKET_ENCODER_DESCR_P12_A(op_execute)
 ...
 /*75*/ DIRECT_FB__PACKET_ENCODER_DESCR_P12_A(op_exec_immediate2)
 /*76*/ DIRECT_FB__PACKET_ENCODER_DESCR_P12_A(op_execute2)
 ...
 /*90*/ DIRECT_FB__PACKET_ENCODER_DESCR_STD_C(op_trusted_auth)
 /*91*/ DIRECT_FB__PACKET_ENCODER_NONE
};//sm_encoders

STARTUP_CODE_EX__DEBUG(check_encoders,
                       RemoteFB__PSET01__P11A__PacketStream::Debug__CheckEncoders);

////////////////////////////////////////////////////////////////////////////////
//Распаковщики

#define DIRECT_FB__PACKET_DECODER_DESCR_P12_A(op)  \
 DIRECT_FB__PACKET_ENCODER_DESCR(op,p12::RemoteFB__PSET01__P12__OpDecoder::decode__##op##__a)

const RemoteFB__PSET01__PacketDecoderDescr RemoteFB__PSET01__P11A__PacketStream::tag_data::sm_decoders[]=
{
 ...
 /*60*/ DIRECT_FB__PACKET_DECODER_DESCR_P12_A(op_slice)
 ...
 /*66*/ DIRECT_FB__PACKET_DECODER_DESCR_P12_A(op_fetch_response)
 ...
 /*78*/ DIRECT_FB__PACKET_DECODER_DESCR_P12_A(op_sql_response)
 ...
 /*90*/ DIRECT_FB__PACKET_DECODER_DESCR_STD_C(op_trusted_auth)
};//sm_decoders

STARTUP_CODE_EX__DEBUG(check_decoders,
                       RemoteFB__PSET01__P11A__PacketStream::Debug__CheckDecoders);

////////////////////////////////////////////////////////////////////////////////
//class RemoteFB__PSET01__P11A__PacketStream

RemoteFB__PSET01__P11A__PacketStream RemoteFB__PSET01__P11A__PacketStream::Instance;

//------------------------------------------------------------------------
RemoteFB__PSET01__P11A__PacketStream::RemoteFB__PSET01__P11A__PacketStream()
{;}

//stream interface -------------------------------------------------------
void RemoteFB__PSET01__P11A__PacketStream::SendPacket
                                           (RemoteFB__PortOperationContext& op_ctx,
                                            const protocol::PACKET&         packet)const
{
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__PSET01__P11A__PacketStream::SendPacket";
...
//------------------------------------------------------------------------
void RemoteFB__PSET01__P11A__PacketStream::ReceivePacket
                                           (RemoteFB__PortOperationContext& op_ctx,
                                            protocol::PACKET&               packet)const
{
 const wchar_t* const c_bugcheck_src
  =L"RemoteFB__PSET01__P11A__PacketStream::ReceivePacket";
...
void RemoteFB__PSET01__P11A__PacketStream::Debug__CheckEncoders()
{
...
void RemoteFB__PSET01__P11A__PacketStream::Debug__CheckDecoders()
{
