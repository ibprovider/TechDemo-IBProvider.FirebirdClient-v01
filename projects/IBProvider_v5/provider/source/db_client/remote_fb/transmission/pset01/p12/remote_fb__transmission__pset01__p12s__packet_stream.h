...
//! \file    remote_fb__transmission__pset01__p12s__packet_stream.h
//! \brief   Поток пакетов симметричного протокола v12.
//! \author  Kovalenko Dmitry
//! \date    15.02.2015.
#ifndef _remote_fb__transmission__pset01__p12s__packet_stream_H_
#define _remote_fb__transmission__pset01__p12s__packet_stream_H_
...
class RemoteFB__PSET01__P12S__PacketStream:public RemoteFB__PacketStream
{
 private:
  ...
  /// </summary>
  RemoteFB__PSET01__P12S__PacketStream();
