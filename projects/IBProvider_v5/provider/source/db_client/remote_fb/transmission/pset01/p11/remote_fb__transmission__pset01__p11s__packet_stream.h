...
/// <summary>
class RemoteFB__PSET01__P11S__PacketStream LCPI_CPP_CFG__CLASS__FINAL
 :public RemoteFB__PacketStream
{
 private:
  using self_type=RemoteFB__PSET01__P11S__PacketStream;

  RemoteFB__PSET01__P11S__PacketStream(const self_type&)=delete;
