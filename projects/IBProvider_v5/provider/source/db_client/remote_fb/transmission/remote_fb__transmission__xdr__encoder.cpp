...
//! \brief   ”тилиты дл€ упаковки данных в сетевой пакет.
                                            ...
                                            const protocol::P_UCHAR* const slice)
{
 ...
 //-----------------------------------------
 //—ценарий
 //1. Ќужно определить количество и тип передаваемых элементов массива
 //
 //   ƒл€ этого нужно обработать SDL.
 //
 //   ‘ормально, при этом мы можем проверить и размерность передаваемых данных.
 //
 //2. ќтправл€ем элементы массива в порт подключени€

 //----------------------------------------- 1.
 if(ArrSliceDescr.m_element_total_length==0)
 {
  //ERROR - [BUG CHECK] нулева€ длина элемента
 ...
 {
  //ERROR - Ќесогласованные размеры буфера и элемента массива
     ...
     pElement+=ArrSliceDescr.m_element_total_length)
 {
  switch(ArrSliceDescr.m_element_blr_typeid)
  {
   ...
   case isc_api::ibp_isc_blr_dtype__int64:
   {
    ...
    //провер€ем выравнивание. в 32-битном бинарнике может быть 4х байтное выравнивание.
