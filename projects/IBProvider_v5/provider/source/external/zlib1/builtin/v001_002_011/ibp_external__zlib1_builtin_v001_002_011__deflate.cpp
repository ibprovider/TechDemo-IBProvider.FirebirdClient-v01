...
//    IPos cur_match;                             /* current match */
{
    ...
    z_ibp__register Bytef *scan = s->window + s->strstart; /* current string */
    z_ibp__register Bytef *match;                      /* matched string */
    z_ibp__register int len;                           /* length of current match */
...
#else
    z_ibp__register Bytef *strend = s->window + s->strstart + MAX_MATCH;
    z_ibp__register Byte scan_end1  = scan[best_len-1];
    z_ibp__register Byte scan_end   = scan[best_len];
#endif
...
//    deflate_state *s;
{
    ...
    do {
        ...
        /* Deal with !@#$% 64K limit: */
        if z_ibp__constexpr_if (sizeof(int) <= 2) {
