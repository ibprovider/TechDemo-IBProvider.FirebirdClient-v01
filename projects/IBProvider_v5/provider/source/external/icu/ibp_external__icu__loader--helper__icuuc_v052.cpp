...
////////////////////////////////////////////////////////////////////////////////
//class ICU__Loader::tag_dll__icuuc_v052

#define DEF_ICU_POINT(func_name)                                          \
 ibp::os::ibp_os__dll_entry_point<icu::v052::api::t_fn_##func_name*> m_##func_name

class ICU__Loader::tag_dll__icuuc_v052 LCPI_CPP_CFG__CLASS__FINAL
 :public ICU__Loader::tag_dll
{
 private:
  using self_type=tag_dll__icuuc_v052;
  using inherited=ICU__Loader::tag_dll;

  tag_dll__icuuc_v052(const self_type&)=delete;
  self_type& operator = (const self_type&)=delete;

  virtual ~tag_dll__icuuc_v052();

 public:
  tag_dll__icuuc_v052(os::t_ibp_os__dll*  pDLL,
 ...
 private:
  ...
  {
   return ibp_subsystem__icu_api_v052;
  }//get_subsystem_id
...
const GUID ICU__Loader::tag_dll__icuuc_v052::sm_DllInitSvcObjID
...
ICU__Loader::tag_dll__icuuc_v052::tag_dll__icuuc_v052
...
//helper methods ---------------------------------------------------------
ICU__Loader::tag_dll__icuuc_v052::dll_init_mutex_ptr
 ICU__Loader::tag_dll__icuuc_v052::helper__get_dll_init_mutex(os::t_ibp_os__dll* const pDLL)
{
 assert(pDLL);

 const wchar_t* const c_bugcheck_src
  =L"ICU__Loader::tag_dll__icuuc_v052::helper__get_dll_init_mutex";
...
//------------------------------------------------------------------------
IBP_SmartObjectPtr ICU__Loader::tag_dll__icuuc_v052::helper__create_dll_init_mutex()
{
...
//------------------------------------------------------------------------
void ICU__Loader::tag_dll__icuuc_v052::helper__init_op()
{
 {
 ...
 //-----------------------------------------
 icu::v052::api::UErrorCode icu_status=icu::v052::api::U_ZERO_ERROR;

 m_u_init.point()(&icu_status);

 if(icu_status!=icu::v052::api::U_ZERO_ERROR)
 {
...
//------------------------------------------------------------------------
void ICU__Loader::tag_dll__icuuc_v052::helper__uninit_op()
{
 m_u_cleanup.point()();
}//helper__uninit_op
...
ICU__Loader::tag_dll_ptr ICU__Loader::helper__create_icuuc_v052
                              ...
                              const std::wstring&      dllVersion)
{
 ...
 return lib::structure::not_null_ptr
         (new tag_dll__icuuc_v052
           (pICUUC_DLL,
            dllVersion));
}//helper__create_icuuc_v052
