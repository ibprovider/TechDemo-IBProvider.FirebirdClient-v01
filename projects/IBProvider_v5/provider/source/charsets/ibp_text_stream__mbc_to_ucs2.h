////////////////////////////////////////////////////////////////////////////////
//! \ingroup ibp_charset
//! \file    ibp_text_stream__mbc_to_ucs2.h
//! \brief   Универсальный конвертор потока MultiByte-символов в поток UCS2-символов
//! \author  Kovalenko Dmitry
//! \date    08.12.2008
#ifndef _ibp_text_stream__mbc_to_ucs2_H_
#define _ibp_text_stream__mbc_to_ucs2_H_
 ...
 :public IBP_DEF_DB_INTERFACE_IMPL_DYNAMIC(db_obj::t_db_text_stream__ucs2)
{
 private:
  ...
  ///  Деструктор
  /// </summary>
  virtual ~t_ibp_text_stream__mbc_to_ucs2();
 ...
 public:
  ...
  //!  Not NULL
  t_ibp_text_stream__mbc_to_ucs2(const charset_type*            charset,
...
////////////////////////////////////////////////////////////////////////////////
#include "source/charsets/ibp_text_stream__mbc_to_ucs2.cc"
////////////////////////////////////////////////////////////////////////////////
#endif
