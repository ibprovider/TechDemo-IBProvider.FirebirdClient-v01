...
//! \file    ibp_cs_icu_v063__text_stream__mbc_to_ucs2.cpp
                                            ...
                                            size_type* const cb_readed)
{
 ...
 for(;;)
 {
   ...
   if(source==source_beg)
   {
    ...
    m_charset->Throw_BugCheck
     (m_charset->m_spICU->m_ucnv_toUnicode.point_name(),
      L"v063::t_ibp_cs_icu::tag_text_stream__mbc_to_ucs2::read_ucs2 #001");
   }//if
  ...
  if(!m_get_eof)
  {
   ...
   {
    IBP_ThrowBugCheck
     (L"v063::t_ibp_cs_icu::tag_text_stream__mbc_to_ucs2::read_ucs2",
      L"#002",
      L"internal error");
   }//if
