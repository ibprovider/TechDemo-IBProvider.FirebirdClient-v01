...
#include "source/charsets/cs_code/icu/v003/ibp_cs_icu_v003__text_stream__mbc_to_ucs2.h"
#include "source/charsets/cs_code/icu/v003/ibp_cs_icu_v003__text_stream__mbc_buffer_to_ucs2.h"
#include "source/charsets/cs_code/icu/v003/ibp_cs_icu_v003__text_stream__ucs2_to_mbc.h"
                                 ...
                                 structure::t_const_str_box const s)const
{
 ...
 //--------
 const api::int32_t
  isz=ibp_size_cast<api::int32_t>(s.len,L"v003::t_ibp_cs_icu::to_unicode_v2",L"sz");
  ...
  result_buf
    (ibp_size_cast<api::int32_t>
      (2*(s.len+m_cs_info.bytes_per_char),
       L"v003::t_ibp_cs_icu::to_unicode_v2",
       L"dest_buffer_sz"));
                                   ...
                                   structure::t_const_wstr_box const ws)const
{
 ...
 //--------
 const api::int32_t
  iwsz=ibp_size_cast<api::int32_t>(ws.len,L"v003::t_ibp_cs_icu::from_unicode_v2",L"wsz");
