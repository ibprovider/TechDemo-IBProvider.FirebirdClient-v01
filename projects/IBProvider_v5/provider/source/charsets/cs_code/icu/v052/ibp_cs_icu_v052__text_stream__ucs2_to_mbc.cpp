...
//! \file    ibp_cs_icu_v052__text_stream__ucs2_to_mbc.cpp
                         ...
                         size_type*                const cb_readed)
{
 ...
 for(;;)
 {
   ...
   if(source==source_beg)
   {
    ...
    m_charset->Throw_BugCheck
     (m_charset->m_spICU->m_ucnv_fromUnicode.point_name(),
      L"v052::t_ibp_cs_icu::tag_text_stream__ucs2_to_mbc::read_mbc #001");
   }//if
  ...
  if(!m_get_eof)
  {
   ...
   {
    IBP_ThrowBugCheck
     (L"v052::t_ibp_cs_icu::tag_text_stream__ucs2_to_mbc::read_ucs2",
      L"#002",
      L"internal error");
   }//if
