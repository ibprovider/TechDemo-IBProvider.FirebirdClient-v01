...
class t_ibp_text_stream__mbc_buffer_to_ucs2 LCPI_CPP_CFG__CLASS__FINAL
 :public IBP_DEF_DB_INTERFACE_IMPL_DYNAMIC(db_obj::t_db_text_stream__ucs2)
{
 private:
  using self_type=t_ibp_text_stream__mbc_buffer_to_ucs2<TCharset>;

  t_ibp_text_stream__mbc_buffer_to_ucs2(const self_type&)=delete;
