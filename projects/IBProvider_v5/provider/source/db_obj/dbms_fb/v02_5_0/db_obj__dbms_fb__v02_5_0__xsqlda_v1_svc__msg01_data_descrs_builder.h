...
//! \file    db_obj__dbms_fb__v02_5_0__xsqlda_v1_svc__msg01_data_descrs_builder.h
//! \brief   XSQLDA_V1 service for building MSG DATA DESCRS [v01].
//! \author  Kovalenko Dmitry
//! \date    23.08.2023
#ifndef _db_obj__dbms_fb__v02_5_0__xsqlda_v1_svc__msg01_data_descrs_builder_H_
#define _db_obj__dbms_fb__v02_5_0__xsqlda_v1_svc__msg01_data_descrs_builder_H_
...
class fb_v02_5_0__xsqlda_v1_svc__msg01_data_descrs_builder LCPI_CPP_CFG__CLASS__FINAL
 :public IBP_DEF_DB_INTERFACE_IMPL_STATIC(isc_base::t_isc_xsqlda_v1_svc__msg_data_descrs_builder)
{
 private:
  using self_type=fb_v02_5_0__xsqlda_v1_svc__msg01_data_descrs_builder;

  fb_v02_5_0__xsqlda_v1_svc__msg01_data_descrs_builder(const self_type&)=delete;
