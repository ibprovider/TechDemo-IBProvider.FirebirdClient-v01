...
//! \file    db_obj__dbms_fb__v02_5_0__xsqlda_v1_svc__msg_data-Build_XSQLDA_MSG_DATA.cpp
...
void fb_v02_5_0__xsqlda_v1_svc__msg_data::Build_XSQLDA_MSG_DATA
...
//------------------------------------------------------------------------
size_t fb_v02_5_0__xsqlda_v1_svc__msg_data::Helper__Build_XSQLDA_MSG_DATA__CalcBufSize
                                           (const isc_api::XSQLDA_V1* const pXSQLDA)
{
 assert(pXSQLDA!=nullptr);
 assert(pXSQLDA->version==isc_api::XSQLDA_V1::c_version_num);
...
//------------------------------------------------------------------------
void fb_v02_5_0__xsqlda_v1_svc__msg_data::Helper__Build_XSQLDA_MSG_DATA__FillBuf
                                           (const isc_api::XSQLDA_V1* const pXSQLDA,
                                            msg_data_buffer_type&           DataBuffer)
{
 assert(pXSQLDA!=nullptr);
...
//------------------------------------------------------------------------
size_t fb_v02_5_0__xsqlda_v1_svc__msg_data::Helper__Build_XSQLDA_MSG_DATA__FillBuf
                                           (const isc_api::XSQLVAR_V1* const pXSQLVAR,
                                            msg_data_buffer_type&            DataBuffer,
                                            size_t                           offset)
{
