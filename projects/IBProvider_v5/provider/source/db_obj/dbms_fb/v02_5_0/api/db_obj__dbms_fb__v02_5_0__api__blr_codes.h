...
//! \file    db_obj__dbms_fb__v02_5_0__api__blr_codes.h
//! \brief   Список BLR-кодов Firebird 2.5.
//! \author  Kovalenko Dmitry
//! \date    20.11.2015
#ifndef _db_obj__dbms_fb__v02_5_0__api__blr_codes_H_
#define _db_obj__dbms_fb__v02_5_0__api__blr_codes_H_

namespace lcpi{namespace ibp{namespace db_obj{namespace dbms_fb{namespace v02_5_0{namespace api{
////////////////////////////////////////////////////////////////////////////////
//struct fb_v02_5_0__blr_code
...
struct fb_v02_5_0__blr_code
{
 ...
 public:
  ...
  //count 2
  //static const code1_type c_count2                            = 32;
  ...
  static const code1_type c_parameter2_old                      = 44; /* Confusion */
  ...
  //static const code1_type c_stream                            = 65;
  //static const code1_type c_set_index                         = 66;
  ...
  static const code1_type c_prot_mask                           = 102;
  ...
  //static const code1_type c_bookmark                          = 109;
  //static const code1_type c_crack                             = 110;
  //static const code1_type c_force_crack                       = 111;
  static const code1_type c_seek                                = 112;
  //static const code1_type c_find                              = 113;

  /* these indicate directions for blr_seek and blr_find */

  static const code1_type c_continue                            = 0;
  static const code1_type c_forward                             = 1;
  static const code1_type c_backward                            = 2;
  static const code1_type c_bof_forward                         = 3;
  static const code1_type c_eof_backward                        = 4;

  //static const code1_type c_lock_relation                     = 114;
  //static const code1_type c_lock_record                       = 115;
  //static const code1_type c_set_bookmark                      = 116;
  //static const code1_type c_get_bookmark                      = 117;
  ...
  //static const code1_type c_begin_range                       = 121;
  //static const code1_type c_end_range                         = 122;
  //static const code1_type c_delete_range                      = 123;
  ...
  //static const code1_type c_release_lock                      = 132;
  //static const code1_type c_release_locks                     = 133;
  static const code1_type c_start_savepoint                     = 134;
  static const code1_type c_end_savepoint                       = 135;
  //static const code1_type c_find_dbkey                        = 136;
  //static const code1_type c_range_relation                    = 137;
  //static const code1_type c_delete_ranges                     = 138;
  ...
  //static const code1_type c_reset_stream                      = 148;
  //static const code1_type c_release_bookmark                  = 149;
  ...
  //static const code1_type c_cardinality                       = 153;

  static const code1_type c_record_version                      = 154;  /* get tid of record */
  static const code1_type c_stall                               = 155;  /* fake server stall */

  static const code1_type c_seek_no_warn                        = 156;
  static const code1_type c_find_dbkey_version                  = 157;  /* find dbkey with record version */
