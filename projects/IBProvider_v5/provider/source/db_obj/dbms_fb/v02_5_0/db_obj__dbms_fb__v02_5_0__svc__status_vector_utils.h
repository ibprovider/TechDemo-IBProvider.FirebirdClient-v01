...
//! \file    db_obj__dbms_fb__v02_5_0__svc__status_vector_utils.h
//! \brief   Реализация сервиса для работы со статус вектором.
//! \author  Kovalenko Dmitry
//! \date    07.08.2016
#ifndef _db_obj__dbms_fb__v02_5_0__svc__status_vector_utils_H_
#define _db_obj__dbms_fb__v02_5_0__svc__status_vector_utils_H_
...
class fb_v02_5_0__svc__status_vector_utils LCPI_CPP_CFG__CLASS__FINAL
 :public common::impl::fb_common_impl__svc__status_vector_utils__v1_set02
{
 private:
  typedef fb_v02_5_0__svc__status_vector_utils                               self_type;
  typedef common::impl::fb_common_impl__svc__status_vector_utils__v1_set02   inherited;

  fb_v02_5_0__svc__status_vector_utils(const self_type&);
 ...
 private:
  ...
  /// </summary>
  //! \param[in] pCsMng
  explicit fb_v02_5_0__svc__status_vector_utils(db_obj::t_db_charset_manager_v2* pCsMng);
