...
//! \file    db_obj__dbms_fb__v03_0_0__xsqlda_v1_svc__msg_data.h
//! \brief   XSQLDA_V1 service for working with message data.
//! \author  Kovalenko Dmitry
//! \date    22.08.2023
#ifndef _db_obj__dbms_fb__v03_0_0__xsqlda_v1_svc__msg_data_H_
#define _db_obj__dbms_fb__v03_0_0__xsqlda_v1_svc__msg_data_H_
...
/// </summary>
class fb_v03_0_0__xsqlda_v1_svc__msg_data LCPI_CPP_CFG__CLASS__FINAL
 :public IBP_DEF_DB_INTERFACE_IMPL_STATIC(isc_base::t_isc_xsqlda_v1_svc__msg_data)
{
 private:
  using self_type=fb_v03_0_0__xsqlda_v1_svc__msg_data;

  fb_v03_0_0__xsqlda_v1_svc__msg_data(const self_type&)=delete;
  self_type& operator = (const self_type&)=delete;

 private:
  fb_v03_0_0__xsqlda_v1_svc__msg_data();
