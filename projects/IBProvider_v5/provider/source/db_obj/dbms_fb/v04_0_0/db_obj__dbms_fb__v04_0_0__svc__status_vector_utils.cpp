...
db_obj::t_db_object_ptr create_svc__status_vector_utils(db_obj::t_db_charset_manager_v2* const pCsMng)
{
 return fb_v04_0_0__svc__status_vector_utils::create(pCsMng);
...
TIBP_MsgTableLoader
 const fb_v04_0_0__svc__status_vector_utils::sm_ErrMsgTableLoader
  (&ibp::_ResourceLoader,
...
common::fb_common__svc__status_vector_utils_ptr
 fb_v04_0_0__svc__status_vector_utils::create(db_obj::t_db_charset_manager_v2* const pCsMng)
{
 assert(pCsMng);
...
#define DEF_DESCR(errCode,ArgNumber,CsKind) \
 {db_obj::dbms_fb::v04_0_0::api::ibp_fb_v40_err__##errCode,ArgNumber,arg_cs_kind::##CsKind},

const fb_v04_0_0__svc__status_vector_utils::tag_arg_descr
 fb_v04_0_0__svc__status_vector_utils::sm_arg_descrs[]
{
...
//------------------------------------------------------------------------
fb_v04_0_0__svc__status_vector_utils::arg_cs_kind
 fb_v04_0_0__svc__status_vector_utils::internal__get_cs_for_arg
