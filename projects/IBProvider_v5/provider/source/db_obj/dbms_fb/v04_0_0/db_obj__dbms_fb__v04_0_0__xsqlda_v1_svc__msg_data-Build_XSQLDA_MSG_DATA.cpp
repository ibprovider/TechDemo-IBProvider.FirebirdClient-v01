...
//! \file    db_obj__dbms_fb__v04_0_0__xsqlda_v1_svc__msg_data-Build_XSQLDA_MSG_DATA.cpp
...
void fb_v04_0_0__xsqlda_v1_svc__msg_data::Build_XSQLDA_MSG_DATA
...
//------------------------------------------------------------------------
size_t fb_v04_0_0__xsqlda_v1_svc__msg_data::Helper__Build_XSQLDA_MSG_DATA__CalcBufSize
                                           (const isc_api::XSQLDA_V1* const pXSQLDA)
{
 assert(pXSQLDA!=nullptr);
 assert(pXSQLDA->version==isc_api::XSQLDA_V1::c_version_num);
 ...
 switch(pXSQLVAR->get_typeID())
 {
  ...
  case isc_api::ibp_fb040_sql_int128:
  {
   ...
   szMsg
    =IBP_Memory_Utils::AddMemLength
      (szMsg,
       /*data size*/sizeof(isc_api::t_ibp_fb040_int128),
  ...
  case isc_api::ibp_fb040_sql_decfloat16:
  {
   ...
   szMsg
    =IBP_Memory_Utils::AddMemLength
      (szMsg,
       /*data size*/sizeof(isc_api::t_ibp_fb040_decfloat16),
  ...
  case isc_api::ibp_fb040_sql_decfloat34:
  {
   ...
   szMsg
    =IBP_Memory_Utils::AddMemLength
      (szMsg,
       /*data size*/sizeof(isc_api::t_ibp_fb040_decfloat34),
  ...
  case isc_api::ibp_fb040_sql_time_with_tz:
  {
   ...
   szMsg
    =IBP_Memory_Utils::AddMemLength
      (szMsg,
       /*data size*/sizeof(isc_api::t_ibp_fb040_time_with_tz),
       /*align*/isc_api::ibp_fb040_type_align__time_with_tz,
       /*pcbResultAlign*/nullptr); //throw
...
//------------------------------------------------------------------------
void fb_v04_0_0__xsqlda_v1_svc__msg_data::Helper__Build_XSQLDA_MSG_DATA__FillBuf
                                           (const isc_api::XSQLDA_V1* const pXSQLDA,
                                            msg_data_buffer_type&           DataBuffer)
{
 assert(pXSQLDA!=nullptr);
...
//------------------------------------------------------------------------
size_t fb_v04_0_0__xsqlda_v1_svc__msg_data::Helper__Build_XSQLDA_MSG_DATA__FillBuf
                                           (const isc_api::XSQLVAR_V1* const pXSQLVAR,
                                            msg_data_buffer_type&            DataBuffer,
                                            size_t                           offset)
{
 ...
 switch(pXSQLVAR->get_typeID())
 {
  ...
  case isc_api::ibp_fb040_sql_int128:
  {
   ...
   typedef isc_api::t_ibp_fb040_int128 sqldata_type;
  ...
  case isc_api::ibp_fb040_sql_decfloat16:
  {
   ...
   typedef isc_api::t_ibp_fb040_decfloat16 sqldata_type;
  ...
  case isc_api::ibp_fb040_sql_decfloat34:
  {
   ...
   typedef isc_api::t_ibp_fb040_decfloat34 sqldata_type;
  ...
  case isc_api::ibp_fb040_sql_time_with_tz:
  {
   ...
   using sqldata_type=isc_api::t_ibp_fb040_time_with_tz;
