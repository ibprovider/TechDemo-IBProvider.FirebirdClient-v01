////////////////////////////////////////////////////////////////////////////////
//IBProvider resources. Firebird 4.0 Error Messages. English.
//Machine generated file [22.03.2023 13:24:19]
//                                                             Dmitry Kovalenko.
#include "ibp_msg_fb40_err_ids.rh"

////////////////////////////////////////////////////////////////////////////////
LanguageNames=(Eng=0x0000:IBP_MSG_FB40_ERR_ENG)
...
Language        =Eng
_MC("Invalid time zone region: %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__INVALID_TIMEZONE_ID
Language        =Eng
_MC("Invalid time zone ID: %1")
.
...
//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_DB_NAME
Language        =Eng
_MC("data base file name (%1) already given")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_INVALID_SW
Language        =Eng
_MC("invalid switch %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_INCMP_SW
Language        =Eng
_MC("incompatible switch combination")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_REPLAY_REQ
Language        =Eng
_MC("replay log pathname required")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_PGBUF_REQ
Language        =Eng
_MC("number of page buffers for cache required")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_VAL_REQ
Language        =Eng
_MC("numeric value required")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_PVAL_REQ
Language        =Eng
_MC("positive numeric value required")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_TRN_REQ
Language        =Eng
_MC("number of transactions per sweep required")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_FULL_REQ
Language        =Eng
_MC("\"full\" or \"reserve\" required")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_USRNAME_REQ
Language        =Eng
_MC("user name required")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_PASS_REQ
Language        =Eng
_MC("password required")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_SUBS_NAME
Language        =Eng
_MC("subsystem name")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_WAL_REQ
Language        =Eng
_MC("\"wal\" required")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_SEC_REQ
Language        =Eng
_MC("number of seconds required")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_NVAL_REQ
Language        =Eng
_MC("numeric value between 0 and 32767 inclusive required")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_TYPE_SHUT
Language        =Eng
_MC("must specify type of shutdown")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_RETRY
Language        =Eng
_MC("please retry, specifying an option")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_RETRY_DB
Language        =Eng
_MC("please retry, giving a database name")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_EXCEED_MAX
Language        =Eng
_MC("internal block exceeds maximum size")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_CORRUPT_POOL
Language        =Eng
_MC("corrupt pool")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_MEM_EXHAUSTED
Language        =Eng
_MC("virtual memory exhausted")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_BAD_POOL
Language        =Eng
_MC("bad pool id")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_TRN_NOT_VALID
Language        =Eng
_MC("Transaction state %1 not in valid range.")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_UNEXP_EOI
Language        =Eng
_MC("unexpected end of input")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_RECON_FAIL
Language        =Eng
_MC("failed to reconnect to a transaction in database %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_TRN_UNKNOWN
Language        =Eng
_MC("Transaction description item unknown")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_MODE_REQ
Language        =Eng
_MC("\"read_only\" or \"read_write\" required")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GFIX_PZVAL_REQ
Language        =Eng
...
//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_UNKNOWN_SWITCH
Language        =Eng
_MC("found unknown switch")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_PAGE_SIZE_MISSING
Language        =Eng
_MC("page size parameter missing")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_PAGE_SIZE_TOOBIG
Language        =Eng
_MC("Page size specified (%1) greater than limit (32768 bytes)")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_REDIR_OUPUT_MISSING
Language        =Eng
_MC("redirect location for output is not specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_SWITCHES_CONFLICT
Language        =Eng
_MC("conflicting switches for backup/restore")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_UNKNOWN_DEVICE
Language        =Eng
_MC("device type %1 not known")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_NO_PROTECTION
Language        =Eng
_MC("protection is not there yet")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_PAGE_SIZE_NOT_ALLOWED
Language        =Eng
_MC("page size is allowed only on restore or create")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_MULTI_SOURCE_DEST
Language        =Eng
_MC("multiple sources or destinations specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_FILENAME_MISSING
Language        =Eng
_MC("requires both input and output filenames")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_DUP_INOUT_NAMES
Language        =Eng
_MC("input and output have the same name.  Disallowed.")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_INV_PAGE_SIZE
Language        =Eng
_MC("expected page size, encountered \"%1\"")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_DB_SPECIFIED
Language        =Eng
_MC("REPLACE specified, but the first file %1 is a database")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_DB_EXISTS
Language        =Eng
_MC("database %1 already exists.  To replace it, use the -REP switch")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_UNK_DEVICE
Language        =Eng
_MC("device type not specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_BLOB_INFO_FAILED
Language        =Eng
_MC("gds_$blob_info failed")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_UNK_BLOB_ITEM
Language        =Eng
_MC("do not understand BLOB INFO item %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_GET_SEG_FAILED
Language        =Eng
_MC("gds_$get_segment failed")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_CLOSE_BLOB_FAILED
Language        =Eng
_MC("gds_$close_blob failed")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_OPEN_BLOB_FAILED
Language        =Eng
_MC("gds_$open_blob failed")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_PUT_BLR_GEN_ID_FAILED
Language        =Eng
_MC("Failed in put_blr_gen_id")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_UNK_TYPE
Language        =Eng
_MC("data type %1 not understood")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_COMP_REQ_FAILED
Language        =Eng
_MC("gds_$compile_request failed")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_START_REQ_FAILED
Language        =Eng
_MC("gds_$start_request failed")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_REC_FAILED
Language        =Eng
_MC("gds_$receive failed")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_REL_REQ_FAILED
Language        =Eng
_MC("gds_$release_request failed")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_DB_INFO_FAILED
Language        =Eng
_MC("gds_$database_info failed")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_NO_DB_DESC
Language        =Eng
_MC("Expected database description record")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_DB_CREATE_FAILED
Language        =Eng
_MC("failed to create database %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_DECOMP_LEN_ERROR
Language        =Eng
_MC("RESTORE: decompression length error")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_TBL_MISSING
Language        =Eng
_MC("cannot find table %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_BLOB_COL_MISSING
Language        =Eng
_MC("Cannot find column for BLOB")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_CREATE_BLOB_FAILED
Language        =Eng
_MC("gds_$create_blob failed")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_PUT_SEG_FAILED
Language        =Eng
_MC("gds_$put_segment failed")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_REC_LEN_EXP
Language        =Eng
_MC("expected record length")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_INV_REC_LEN
Language        =Eng
_MC("wrong length record, expected %1 encountered %2")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_EXP_DATA_TYPE
Language        =Eng
_MC("expected data attribute")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_GEN_ID_FAILED
Language        =Eng
_MC("Failed in store_blr_gen_id")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_UNK_REC_TYPE
Language        =Eng
_MC("do not recognize record type %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_INV_BKUP_VER
Language        =Eng
_MC("Expected backup version 1..10.  Found %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_MISSING_BKUP_DESC
Language        =Eng
_MC("expected backup description record")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_STRING_TRUNC
Language        =Eng
_MC("string truncated")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_CANT_REST_RECORD
Language        =Eng
_MC("warning -- record could not be restored")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_SEND_FAILED
Language        =Eng
_MC("gds_$send failed")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_NO_TBL_NAME
Language        =Eng
_MC("no table name for data")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_UNEXP_EOF
Language        =Eng
_MC("unexpected end of file on backup file")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_DB_FORMAT_TOO_OLD
Language        =Eng
_MC("database format %1 is too old to restore to")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_INV_ARRAY_DIM
Language        =Eng
_MC("array dimension for column %1 is invalid")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_XDR_LEN_EXPECTED
Language        =Eng
_MC("Expected XDR record length")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_OPEN_BKUP_ERROR
Language        =Eng
_MC("cannot open backup file %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_OPEN_ERROR
Language        =Eng
_MC("cannot open status and error output file %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_MISSING_BLOCK_FAC
Language        =Eng
_MC("blocking factor parameter missing")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_INV_BLOCK_FAC
Language        =Eng
_MC("expected blocking factor, encountered \"%1\"")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_BLOCK_FAC_SPECIFIED
Language        =Eng
_MC("a blocking factor may not be used in conjunction with device CT")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_MISSING_USERNAME
Language        =Eng
_MC("user name parameter missing")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_MISSING_PASSWORD
Language        =Eng
_MC("password parameter missing")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_MISSING_SKIPPED_BYTES
Language        =Eng
_MC("missing parameter for the number of bytes to be skipped")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_INV_SKIPPED_BYTES
Language        =Eng
_MC("expected number of bytes to be skipped, encountered \"%1\"")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_ERR_RESTORE_CHARSET
Language        =Eng
_MC("character set")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_ERR_RESTORE_COLLATION
Language        =Eng
_MC("collation")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_READ_ERROR
Language        =Eng
_MC("Unexpected I/O error while reading from backup file")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_WRITE_ERROR
Language        =Eng
_MC("Unexpected I/O error while writing to backup file")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_DB_IN_USE
Language        =Eng
_MC("could not drop database %1 (no privilege or database might be in use)")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_SYSMEMEX
Language        =Eng
_MC("System memory exhausted")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_RESTORE_ROLE_FAILED
Language        =Eng
_MC("SQL role")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_ROLE_OP_MISSING
Language        =Eng
_MC("SQL role parameter missing")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_PAGE_BUFFERS_MISSING
Language        =Eng
_MC("page buffers parameter missing")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_PAGE_BUFFERS_WRONG_PARAM
Language        =Eng
_MC("expected page buffers, encountered \"%1\"")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_PAGE_BUFFERS_RESTORE
Language        =Eng
_MC("page buffers is allowed only on restore or create")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_INV_SIZE
Language        =Eng
_MC("size specification either missing or incorrect for file %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_FILE_OUTOF_SEQUENCE
Language        =Eng
_MC("file %1 out of sequence")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_JOIN_FILE_MISSING
Language        =Eng
_MC("can't join -- one of the files missing")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_STDIN_NOT_SUPPTD
Language        =Eng
_MC("standard input is not supported when using join operation")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_STDOUT_NOT_SUPPTD
Language        =Eng
_MC("standard output is not supported when using split operation or in verbose mode")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_BKUP_CORRUPT
Language        =Eng
_MC("backup file %1 might be corrupt")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_UNK_DB_FILE_SPEC
Language        =Eng
_MC("database file specification missing")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_HDR_WRITE_FAILED
Language        =Eng
_MC("can't write a header record to file %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_DISK_SPACE_EX
Language        =Eng
_MC("free disk space exhausted")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_SIZE_LT_MIN
Language        =Eng
_MC("file size given (%1) is less than minimum allowed (%2)")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_SVC_NAME_MISSING
Language        =Eng
_MC("service name parameter missing")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_NOT_OWNR
Language        =Eng
_MC("Cannot restore over current database, must be SYSDBA or owner of the existing database.")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_MODE_REQ
Language        =Eng
_MC("\"read_only\" or \"read_write\" required")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_JUST_DATA
Language        =Eng
_MC("just data ignore all constraints etc.")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_DATA_ONLY
Language        =Eng
_MC("restoring data only ignoring foreign key, unique, not null & other constraints")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_MISSING_INTERVAL
Language        =Eng
_MC("verbose interval value parameter missing")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_WRONG_INTERVAL
Language        =Eng
_MC("verbose interval value cannot be smaller than %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_VERIFY_VERBINT
Language        =Eng
_MC("verify (verbose) and verbint options are mutually exclusive")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_OPTION_ONLY_RESTORE
Language        =Eng
_MC("option -%1 is allowed only on restore or create")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_OPTION_ONLY_BACKUP
Language        =Eng
_MC("option -%1 is allowed only on backup")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_OPTION_CONFLICT
Language        =Eng
_MC("options -%1 and -%2 are mutually exclusive")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_PARAM_CONFLICT
Language        =Eng
_MC("parameter for option -%1 was already specified with value \"%2\"")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_OPTION_REPEATED
Language        =Eng
_MC("option -%1 was already specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_MAX_DBKEY_RECURSION
Language        =Eng
_MC("dependency depth greater than %1 for view %2")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_MAX_DBKEY_LENGTH
Language        =Eng
_MC("value greater than %1 when calculating length of rdb$db_key for view %2")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_INVALID_METADATA
Language        =Eng
_MC("Invalid metadata detected. Use -FIX_FSS_METADATA option.")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_INVALID_DATA
Language        =Eng
_MC("Invalid data detected. Use -FIX_FSS_DATA option.")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_INV_BKUP_VER2
Language        =Eng
_MC("Expected backup version %2..%3.  Found %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GBAK_DB_FORMAT_TOO_OLD2
Language        =Eng
...
//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_CANT_OPEN_DB
Language        =Eng
_MC("unable to open database")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_SWITCHES_ERROR
Language        =Eng
_MC("error in switch specifications")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_NO_OP_SPEC
Language        =Eng
_MC("no operation specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_NO_USR_NAME
Language        =Eng
_MC("no user name specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_ERR_ADD
Language        =Eng
_MC("add record error")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_ERR_MODIFY
Language        =Eng
_MC("modify record error")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_ERR_FIND_MOD
Language        =Eng
_MC("find/modify record error")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_ERR_REC_NOT_FOUND
Language        =Eng
_MC("record not found for user: %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_ERR_DELETE
Language        =Eng
_MC("delete record error")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_ERR_FIND_DEL
Language        =Eng
_MC("find/delete record error")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_ERR_FIND_DISP
Language        =Eng
_MC("find/display record error")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_INV_PARAM
Language        =Eng
_MC("invalid parameter, no switch defined")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_OP_SPECIFIED
Language        =Eng
_MC("operation already specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_PW_SPECIFIED
Language        =Eng
_MC("password already specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_UID_SPECIFIED
Language        =Eng
_MC("uid already specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_GID_SPECIFIED
Language        =Eng
_MC("gid already specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_PROJ_SPECIFIED
Language        =Eng
_MC("project already specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_ORG_SPECIFIED
Language        =Eng
_MC("organization already specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_FNAME_SPECIFIED
Language        =Eng
_MC("first name already specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_MNAME_SPECIFIED
Language        =Eng
_MC("middle name already specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_LNAME_SPECIFIED
Language        =Eng
_MC("last name already specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_INV_SWITCH
Language        =Eng
_MC("invalid switch specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_AMB_SWITCH
Language        =Eng
_MC("ambiguous switch specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_NO_OP_SPECIFIED
Language        =Eng
_MC("no operation specified for parameters")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_PARAMS_NOT_ALLOWED
Language        =Eng
_MC("no parameters allowed for this operation")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_INCOMPAT_SWITCH
Language        =Eng
_MC("incompatible switches specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_INV_USERNAME
Language        =Eng
_MC("Invalid user name (maximum 31 bytes allowed)")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_INV_PW_LENGTH
Language        =Eng
_MC("Warning - maximum 8 significant bytes of password used")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_DB_SPECIFIED
Language        =Eng
_MC("database already specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_DB_ADMIN_SPECIFIED
Language        =Eng
_MC("database administrator name already specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_DB_ADMIN_PW_SPECIFIED
Language        =Eng
_MC("database administrator password already specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSEC_SQL_ROLE_SPECIFIED
Language        =Eng
_MC("SQL role name already specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSTAT_UNKNOWN_SWITCH
Language        =Eng
_MC("found unknown switch")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSTAT_RETRY
Language        =Eng
_MC("please retry, giving a database name")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSTAT_WRONG_ODS
Language        =Eng
_MC("Wrong ODS version, expected %1, encountered %2")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSTAT_UNEXPECTED_EOF
Language        =Eng
_MC("Unexpected end of database file.")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSTAT_OPEN_ERR
Language        =Eng
_MC("Can't open database file %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSTAT_READ_ERR
Language        =Eng
_MC("Can't read a database page")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__GSTAT_SYSMEMEX
Language        =Eng
_MC("System memory exhausted")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_BAD_AM
Language        =Eng
_MC("Wrong value for access mode")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_BAD_WM
Language        =Eng
_MC("Wrong value for write mode")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_BAD_RS
Language        =Eng
_MC("Wrong value for reserve space")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_INFO_ERR
Language        =Eng
_MC("Unknown tag (%1) in info_svr_db_info block after isc_svc_query()")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_QUERY_ERR
Language        =Eng
_MC("Unknown tag (%1) in isc_svc_query() results")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_SWITCH_UNKNOWN
Language        =Eng
_MC("Unknown switch \"%1\"")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_BAD_SM
Language        =Eng
_MC("Wrong value for shutdown mode")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_FP_OPEN
Language        =Eng
_MC("could not open file %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_FP_READ
Language        =Eng
_MC("could not read file %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_FP_EMPTY
Language        =Eng
_MC("empty file %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_BAD_ARG
Language        =Eng
_MC("Invalid or missing parameter for switch %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_INFO_LIMBO
Language        =Eng
_MC("Unknown tag (%1) in isc_info_svc_limbo_trans block after isc_svc_query()")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_LIMBO_STATE
Language        =Eng
_MC("Unknown tag (%1) in isc_spb_tra_state block after isc_svc_query()")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_LIMBO_ADVISE
Language        =Eng
_MC("Unknown tag (%1) in isc_spb_tra_advise block after isc_svc_query()")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__FBSVCMGR_BAD_RM
Language        =Eng
_MC("Wrong value for replica mode")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__UTL_TRUSTED_SWITCH
Language        =Eng
_MC("Switches trusted_user and trusted_role are not supported from command line")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_MISSING_PARAM
Language        =Eng
_MC("Missing parameter for switch %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ALLOWED_SWITCHES
Language        =Eng
_MC("Only one of -LOCK, -UNLOCK, -FIXUP, -BACKUP or -RESTORE should be specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_UNKNOWN_PARAM
Language        =Eng
_MC("Unrecognized parameter %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_UNKNOWN_SWITCH
Language        =Eng
_MC("Unknown switch %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_NOFETCHPW_SVC
Language        =Eng
_MC("Fetch password can't be used in service mode")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_PWFILE_ERROR
Language        =Eng
_MC("Error working with password file \"%1\"")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_SIZE_WITH_LOCK
Language        =Eng
_MC("Switch -SIZE can be used only with -LOCK")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_NO_SWITCH
Language        =Eng
_MC("None of -LOCK, -UNLOCK, -FIXUP, -BACKUP or -RESTORE specified")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_READ
Language        =Eng
_MC("IO error reading file: %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_WRITE
Language        =Eng
_MC("IO error writing file: %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_SEEK
Language        =Eng
_MC("IO error seeking file: %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_OPENDB
Language        =Eng
_MC("Error opening database file: %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_FADVICE
Language        =Eng
_MC("Error in posix_fadvise(%1) for database %2")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_CREATEDB
Language        =Eng
_MC("Error creating database file: %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_OPENBK
Language        =Eng
_MC("Error opening backup file: %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_CREATEBK
Language        =Eng
_MC("Error creating backup file: %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_EOFDB
Language        =Eng
_MC("Unexpected end of database file %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_FIXUP_WRONGSTATE
Language        =Eng
_MC("Database %1 is not in state (%2) to be safely fixed up")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_DB
Language        =Eng
_MC("Database error")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_USERPW_TOOLONG
Language        =Eng
_MC("Username or password is too long")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_LOSTREC_DB
Language        =Eng
_MC("Cannot find record for database \"%1\" backup level %2 in the backup history")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_LOSTGUID_DB
Language        =Eng
_MC("Internal error. History query returned null SCN or GUID")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_EOFHDRDB
Language        =Eng
_MC("Unexpected end of file when reading header of database file \"%1\" (stage %2)")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_DB_NOTLOCK
Language        =Eng
_MC("Internal error. Database file is not locked. Flags are %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_LOSTGUID_BK
Language        =Eng
_MC("Internal error. Cannot get backup guid clumplet")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_PAGE_CHANGED
Language        =Eng
_MC("Internal error. Database page %1 had been changed during backup (page SCN=%2, backup SCN=%3)")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_DBSIZE_INCONSISTENT
Language        =Eng
_MC("Database file size is not a multiple of page size")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_FAILED_LZBK
Language        =Eng
_MC("Level 0 backup is not restored")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_EOFHDRBK
Language        =Eng
_MC("Unexpected end of file when reading header of backup file: %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_INVALID_INCBK
Language        =Eng
_MC("Invalid incremental backup file: %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_UNSUPVERS_INCBK
Language        =Eng
_MC("Unsupported version %1 of incremental backup file: %2")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_INVLEVEL_INCBK
Language        =Eng
_MC("Invalid level %1 of incremental backup file: %2, expected %3")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_WRONG_ORDERBK
Language        =Eng
_MC("Wrong order of backup files or invalid incremental backup file detected, file: %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_EOFBK
Language        =Eng
_MC("Unexpected end of backup file: %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_COPY
Language        =Eng
_MC("Error creating database file: %1 via copying from: %2")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_ERR_EOFHDR_RESTDB
Language        =Eng
_MC("Unexpected end of file when reading header of restored database file (stage %1)")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_LOSTGUID_L0BK
Language        =Eng
_MC("Cannot get backup guid clumplet from L0 backup")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_SWITCHD_PARAMETER
Language        =Eng
_MC("Wrong parameter %1 for switch -D, need ON or OFF")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_USER_STOP
Language        =Eng
_MC("Terminated due to user request")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_DECO_PARSE
Language        =Eng
_MC("Too complex decompress command (> %1 arguments)")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_LOSTREC_GUID_DB
Language        =Eng
_MC("Cannot find record for database \"%1\" backup GUID %2 in the backup history")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_SEQ_MISUSE
Language        =Eng
_MC("Switch -SEQ(UENCE) can be used only with -FIXUP or -RESTORE")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_WRONG_PARAM
Language        =Eng
_MC("Wrong parameter value for switch %1")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_CLEAN_HIST_MISUSE
Language        =Eng
_MC("Switch -CLEAN_HISTORY can be used only with -BACKUP")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_CLEAN_HIST_MISSED
Language        =Eng
_MC("-KEEP can be used only with -CLEAN_HISTORY")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_KEEP_HIST_MISSED
Language        =Eng
_MC("-KEEP is required with -CLEAN_HISTORY")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__NBACKUP_SECOND_KEEP_SWITCH
Language        =Eng
_MC("-KEEP can be used one time only")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__TRACE_CONFLICT_ACTS
Language        =Eng
_MC("conflicting actions \"%1\" and \"%2\" found")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__TRACE_ACT_NOTFOUND
Language        =Eng
_MC("action switch not found")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__TRACE_SWITCH_ONCE
Language        =Eng
_MC("switch \"%1\" must be set only once")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__TRACE_PARAM_VAL_MISS
Language        =Eng
_MC("value for switch \"%1\" is missing")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__TRACE_PARAM_INVALID
Language        =Eng
_MC("invalid value (\"%1\") for switch \"%2\"")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__TRACE_SWITCH_UNKNOWN
Language        =Eng
_MC("unknown switch \"%1\" encountered")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__TRACE_SWITCH_SVC_ONLY
Language        =Eng
_MC("switch \"%1\" can be used by service only")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__TRACE_SWITCH_USER_ONLY
Language        =Eng
_MC("switch \"%1\" can be used by interactive user only")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__TRACE_SWITCH_PARAM_MISS
Language        =Eng
_MC("mandatory parameter \"%1\" for switch \"%2\" is missing")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__TRACE_PARAM_ACT_NOTCOMPAT
Language        =Eng
_MC("parameter \"%1\" is incompatible with action \"%2\"")
.

//------------------------------------------------------------------------
MessageId       =IBP_MCE_FB40__TRACE_MANDATORY_SWITCH_MISS
Language        =Eng
