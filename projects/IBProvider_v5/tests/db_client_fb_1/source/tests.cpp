...
const TTestCreatorDescr g_Tests[]=
{
 ...
 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P12__XSQLDA_Utilities___Build_XSQLDA_MSG_BLR::create),

 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P12__XSQLDA_Utilities___Build_XSQLDA_MSG_DATA::create),

 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P12__XSQLDA_Utilities___Build_XSQLDA_MSG_DATA_DESCRS::create),

 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P12__XSQLDA_Utilities___Parse_XSQLDA_MSG_DATA::create),

 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P12__XSQLDA_Utilities___Calc_XSQLDA_MAX_XDR_SIZE::create),

 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P12__ArraySlice_Utilities__ParseSDL::create),
 ...
 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P13__XSQLDA_Utilities___Build_XSQLDA_MSG_BLR::create),

 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P13__XSQLDA_Utilities___Build_XSQLDA_MSG_DATA::create),

 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P13__XSQLDA_Utilities___Build_XSQLDA_MSG_DATA_DESCRS::create),

 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P13__XSQLDA_Utilities___Parse_XSQLDA_MSG_DATA::create),

 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P13__XSQLDA_Utilities___Calc_XSQLDA_MAX_XDR_SIZE::create),

 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P13__XSQLDA_Utilities___Alloc_XSQLDA_MSG_NULLS::create),

 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P13__XSQLDA_Utilities___Build_XSQLDA_MSG_NULLS__001::create),

 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P13__XSQLDA_Utilities___Build_XSQLDA_MSG_NULLS__002::create),

 DEF_CREATOR_DESCR(TestsFor__RemoteFB__P13__ArraySlice_Utilities__ParseSDL::create),
