...
const TestsFor__P13_Legacy_Auth_003__connect_db::tagCryptModeDescr
 TestsFor__P13_Legacy_Auth_003__connect_db::sm_params__CryptModes[]=
{
...
const TestsFor__P13_Legacy_Auth_003__connect_db::tagCompressModeDescr
 TestsFor__P13_Legacy_Auth_003__connect_db::sm_params__CompressModes[]=
{
 DEF_DESCR2(default_,"default"),
 DEF_DESCR (disabled),
 DEF_DESCR (enabled),
...
////////////////////////////////////////////////////////////////////////////////
//class TestsFor__P13_Legacy_Auth_003__connect_db

TestsFor__P13_Legacy_Auth_003__connect_db::TestsFor__P13_Legacy_Auth_003__connect_db
 ...
 ,m_pfnExec(pfnExec)
{
 assert(m_spParams);
 assert(m_pfnExec);
}//TestsFor__P13_Legacy_Auth_003__connect_db
...
//------------------------------------------------------------------------
void TestsFor__P13_Legacy_Auth_003__connect_db::create(TTSO_PushTest*      const pTestPusher,
                                                       TTSO_GlobalContext* const pParams)
{
 assert(pTestPusher);
 assert(pParams);
 ...
 //------------------------------------
 structure::str_formatter ftestID("RemoteFB.protocol.v13.Legacy_Auth.003.connect_db.crypt__%1.compress__%2");
...
//------------------------------------------------------------------------
bool TestsFor__P13_Legacy_Auth_003__connect_db::can_exec()const
{
 return m_spParams->calc_expression("SRV>=FB-3");
}//can_exec

//------------------------------------------------------------------------
void TestsFor__P13_Legacy_Auth_003__connect_db::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
...
//helper methods ---------------------------------------------------------
void TestsFor__P13_Legacy_Auth_003__connect_db::Helper__Exec_Ok
                                           (TTSO_Tracer&  tracer,
...
//------------------------------------------------------------------------
void TestsFor__P13_Legacy_Auth_003__connect_db::Helper__Exec_Failed
                                           (TTSO_Tracer&  tracer,
                                            wstr_box_type hostName,
                                            wstr_box_type dbName,
                                            TestCnParams& params)
