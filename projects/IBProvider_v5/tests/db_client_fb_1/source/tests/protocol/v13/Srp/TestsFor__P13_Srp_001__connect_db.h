...
//                                                 Kovalenko Dmitry. 06.09.2016
#ifndef _TestsFor__P13_Srp_001__connect_db_H_
#define _TestsFor__P13_Srp_001__connect_db_H_
...
{
 private:
  typedef TestsFor__P13_Srp_001__connect_db              self_type;

  TestsFor__P13_Srp_001__connect_db(const self_type&);
 ...
 private:
  TestsFor__P13_Srp_001__connect_db(TTSO_GlobalContext* pParams,
                                    const char*         pTestID,
                                    const wchar_t*      pSrpName,
                                    CryptMode           cryptMode,
                                    CompressMode        compressMode);

  virtual ~TestsFor__P13_Srp_001__connect_db();
