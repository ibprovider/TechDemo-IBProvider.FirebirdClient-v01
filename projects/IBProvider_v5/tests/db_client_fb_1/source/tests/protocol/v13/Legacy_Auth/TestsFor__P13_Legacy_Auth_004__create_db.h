...
//                                                 Kovalenko Dmitry. 09.01.2020
#ifndef _TestsFor__P13_Legacy_Auth_004__create_db_H_
#define _TestsFor__P13_Legacy_Auth_004__create_db_H_
...
{
 private:
  typedef TestsFor__P13_Legacy_Auth_004__create_db              self_type;

  TestsFor__P13_Legacy_Auth_004__create_db(const self_type&);
 ...
 private:
  TestsFor__P13_Legacy_Auth_004__create_db(TTSO_GlobalContext* pParams,
                                            const char*        pTestID,
                                            CryptMode          cryptMode,
                                            CompressMode       compressMode,
                                            PFnExec            pfnExec);

  virtual ~TestsFor__P13_Legacy_Auth_004__create_db();
