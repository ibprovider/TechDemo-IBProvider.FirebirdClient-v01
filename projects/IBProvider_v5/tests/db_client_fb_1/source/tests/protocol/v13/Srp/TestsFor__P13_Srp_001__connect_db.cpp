...
const TestsFor__P13_Srp_001__connect_db::tagCryptModeDescr
 TestsFor__P13_Srp_001__connect_db::sm_params__CryptModes[]=
{
...
const TestsFor__P13_Srp_001__connect_db::tagCompressModeDescr
 TestsFor__P13_Srp_001__connect_db::sm_params__CompressModes[]=
{
 DEF_DESCR2(default_,"default"),
 DEF_DESCR (disabled),
 DEF_DESCR (enabled),
...
const wchar_t* const
 TestsFor__P13_Srp_001__connect_db::sm_params__srpNames[]=
{
 L"Srp",L"Srp224",L"Srp256",L"Srp384",L"Srp512",
};//sm_params__srpNames

////////////////////////////////////////////////////////////////////////////////
//class TestsFor__P13_Srp_001__connect_db

TestsFor__P13_Srp_001__connect_db::TestsFor__P13_Srp_001__connect_db
...
{
 assert(m_spParams);
}//TestsFor__P13_Srp_001__connect_db
...
//------------------------------------------------------------------------
void TestsFor__P13_Srp_001__connect_db::create(TTSO_PushTest*      const pTestPusher,
                                               TTSO_GlobalContext* const pParams)
{
 assert(pTestPusher);
 assert(pParams);
 ...
 //------------------------------------
 structure::str_formatter ftestID("RemoteFB.protocol.v13.Srp.001.connect_db.%1.crypt__%2.compress__%3");
...
//------------------------------------------------------------------------
bool TestsFor__P13_Srp_001__connect_db::can_exec()const
{
 return m_spParams->calc_expression("SRV>=FB-3");
}//can_exec

//------------------------------------------------------------------------
void TestsFor__P13_Srp_001__connect_db::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
