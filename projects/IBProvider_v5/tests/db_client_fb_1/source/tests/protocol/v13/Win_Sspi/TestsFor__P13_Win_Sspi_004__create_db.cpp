...
const TestsFor__P13_Win_Sspi_004__create_db::tagCryptModeDescr
 TestsFor__P13_Win_Sspi_004__create_db::sm_params__CryptModes[]=
{
...
const TestsFor__P13_Win_Sspi_004__create_db::tagCompressModeDescr
 TestsFor__P13_Win_Sspi_004__create_db::sm_params__CompressModes[]=
{
 DEF_DESCR2(default_,"default"),
 DEF_DESCR (disabled),
 DEF_DESCR (enabled),
...
////////////////////////////////////////////////////////////////////////////////
//class TestsFor__P13_Win_Sspi_004__create_db

TestsFor__P13_Win_Sspi_004__create_db::TestsFor__P13_Win_Sspi_004__create_db
 ...
 ,m_pfnExec(pfnExec)
{
 assert(m_spParams);
 assert(m_pfnExec);
}//TestsFor__P13_Win_Sspi_004__create_db
...
//------------------------------------------------------------------------
void TestsFor__P13_Win_Sspi_004__create_db::create(TTSO_PushTest*      const pTestPusher,
                                                   TTSO_GlobalContext* const pParams)
{
 assert(pTestPusher);
 assert(pParams);
 ...
 //------------------------------------
 structure::str_formatter ftestID("RemoteFB.protocol.v13.Win_Sspi.004.create_db.crypt__%1.compress__%2");
...
//------------------------------------------------------------------------
bool TestsFor__P13_Win_Sspi_004__create_db::can_exec()const
{
 return m_spParams->calc_expression("SRV>=FB-3");
}//can_exec

//------------------------------------------------------------------------
void TestsFor__P13_Win_Sspi_004__create_db::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
...
//helper methods ---------------------------------------------------------
void TestsFor__P13_Win_Sspi_004__create_db::Helper__Exec_Ok
                                           (TTSO_Tracer&  tracer,
                                            TestCnParams& params)
{
 typedef TestServices svc;
...
//------------------------------------------------------------------------
void TestsFor__P13_Win_Sspi_004__create_db::Helper__Exec_Failed
                                           (TTSO_Tracer&  tracer,
                                            TestCnParams& params)
{
 typedef TestServices svc;
