...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Array_Read_Test_003__bigint::tag_impl

class WORK_Array_Read_Test_003__bigint::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
 ...
 private:
  typedef db_obj::t_dbvalue__i8             element_type;

  static const short
   c_element_blrtypeid=isc_api::ibp_isc_blr_dtype__int64;
...
void WORK_Array_Read_Test_003__bigint::tag_impl::test_001
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 const element_type arrayData[3]={_I64_MIN,0,2i64*LONG_MAX};
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   "insert into TEST_ARRAY_DIM1 (COL_I8) values (?) returning TEST_ID;");
 ...
 structure::str_formatter fSQL("select COL_I8 from TEST_ARRAY_DIM1 where TEST_ID=%1");
...
void WORK_Array_Read_Test_003__bigint::tag_impl::test_002__dim2l
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 {
  element_type v(-123i64-LONG_MIN);
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   &hStmt,
   static_cast<remote_fb::protocol::P_USHORT>(cns.db_dialect_Ex.value()),
   "insert into TEST_ARRAY_DIM2L (COL_I8) values (?) returning TEST_ID;");
 ...
 //----------------------------------------- теперь провер€ем значени€ элементов массива
 structure::str_formatter fSQL("select COL_I8 from TEST_ARRAY_DIM2L where TEST_ID=%1");
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Array_Read_Test_003__bigint::tag_descr
...
struct WORK_Array_Read_Test_003__bigint::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Array_Read_Test_003__bigint::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Array_Read_Test_003__bigint::tag_impl::func},

const WORK_Array_Read_Test_003__bigint::tag_descr
 WORK_Array_Read_Test_003__bigint::sm_Tests[]=
{
 DEF_TEST_DESCR("001",
                test_001)
...
void WORK_Array_Read_Test_003__bigint::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Array.Read.003.bigint.ptype__%1.%2");
