...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Array_Write_Test_007__time::tag_impl

class WORK_Array_Write_Test_007__time::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
 ...
 private:
  typedef isc_api::t_ibp_isc_time           element_type;

  static const isc_api::XSQLVAR_V1::sqltype_type
   c_element_sqltypeid=isc_api::ibp_isc_sql_type_time;

  static const short
   c_element_blrtypeid=isc_api::ibp_isc_blr_dtype__sql_time;
...
void WORK_Array_Write_Test_007__time::tag_impl::test_001
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 const element_type arrayData[3]={1,2,3};
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   "insert into TEST_ARRAY_DIM1 (COL_TYPE_TIME) values (?) returning TEST_ID;");
 ...
 structure::str_formatter fSQL("select COL_TYPE_TIME[%%1] from TEST_ARRAY_DIM1 where TEST_ID=%1");
...
void WORK_Array_Write_Test_007__time::tag_impl::test_002__dim2l
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
...

 {
  ...
  for(size_t i=0;i!=nTotalCount;++i,v+=1237)
   arrayData[i]=v;
 }
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   &hStmt,
   static_cast<remote_fb::protocol::P_USHORT>(cns.db_dialect_Ex.value()),
   "insert into TEST_ARRAY_DIM2L (COL_TYPE_TIME) values (?) returning TEST_ID;");
 ...
 //----------------------------------------- теперь провер€ем значени€ элементов массива
 structure::str_formatter fSQL("select COL_TYPE_TIME[%%1,%%2] from TEST_ARRAY_DIM2L where TEST_ID=%1");
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Array_Write_Test_007__time::tag_descr
...
struct WORK_Array_Write_Test_007__time::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Array_Write_Test_007__time::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Array_Write_Test_007__time::tag_impl::func},

const WORK_Array_Write_Test_007__time::tag_descr
 WORK_Array_Write_Test_007__time::sm_Tests[]=
{
 DEF_TEST_DESCR("001",
                test_001)
...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Array_Write_Test_007__time

void WORK_Array_Write_Test_007__time::create(TTSO_PushTest*      const pTestPusher,
                                             TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Array.Write.007.time.ptype__%1.%2");
