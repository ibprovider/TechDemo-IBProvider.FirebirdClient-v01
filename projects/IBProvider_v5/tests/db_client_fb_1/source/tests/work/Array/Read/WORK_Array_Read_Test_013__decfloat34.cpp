...
class WORK_Array_Read_Test_013__decfloat34::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
 ...
 private:
  typedef db_obj::t_dbvalue__fb040_decfloat34   element_type;

  static const short
   c_element_blrtypeid=isc_api::ibp_fb040_blr_dtype__decfloat34;
...
void WORK_Array_Read_Test_013__decfloat34::tag_impl::test_001
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 const element_type arrayData[3]=
  {
   db_obj::make_fb040_decfloat34(0, 8935141660703064064), // NaN
   db_obj::make_fb040_decfloat34(1, 2452209997103235072), // 1
   db_obj::make_fb040_decfloat34(0, 2452209997103235072), // 0
  };
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   "insert into TEST_ARRAY_DIM1 (COL_DECFLOAT34) values (?) returning TEST_ID;");
 ...
 structure::str_formatter fSQL("select COL_DECFLOAT34 from TEST_ARRAY_DIM1 where TEST_ID=%1");
...
void WORK_Array_Read_Test_013__decfloat34::tag_impl::test_002__dim2l
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 {
  element_type v=db_obj::make_fb040_decfloat34(0, 2452209997103235072); // "0"

  for(size_t i=0;i!=nTotalCount;++i,++v.data.high)
   arrayData[i]=v;
 }
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   &hStmt,
   static_cast<remote_fb::protocol::P_USHORT>(cns.db_dialect_Ex.value()),
   "insert into TEST_ARRAY_DIM2L (COL_DECFLOAT34) values (?) returning TEST_ID;");
 ...
 //----------------------------------------- теперь провер€ем значени€ элементов массива
 structure::str_formatter fSQL("select COL_DECFLOAT34 from TEST_ARRAY_DIM2L where TEST_ID=%1");
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Array_Read_Test_013__decfloat34::tag_descr
...
struct WORK_Array_Read_Test_013__decfloat34::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Array_Read_Test_013__decfloat34::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Array_Read_Test_013__decfloat34::tag_impl::func},

const WORK_Array_Read_Test_013__decfloat34::tag_descr
 WORK_Array_Read_Test_013__decfloat34::sm_Tests[]=
{
 DEF_TEST_DESCR
  ("001",
   test_001)
