...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Array_Write_Test_009__char::tag_impl

class WORK_Array_Write_Test_009__char::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
 ...
 private:
  struct tag_element
  {
   ...
   public:
    ...
    {
     return memcmp(x.data,this->data,sizeof(this->data))==0;
    }
  ...
  typedef tag_element                       element_type;

  static const isc_api::XSQLVAR_V1::sqltype_type
   c_element_sqltypeid=isc_api::ibp_isc_sql_text;

  static const short
   c_element_blrtypeid=isc_api::ibp_isc_blr_dtype__text2;
...
void WORK_Array_Write_Test_009__char::tag_impl::test_001
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
...

 {
  ...
  writer_funcs::stuff_word_s(buf,1);
  writer_funcs::stuff_word_s(buf,10);
 }
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   "insert into TEST_ARRAY_DIM1 (COL_BINARY_10) values (?) returning TEST_ID;");
 ...
 structure::str_formatter fSQL("select COL_BINARY_10[%%1] from TEST_ARRAY_DIM1 where TEST_ID=%1");
...
void WORK_Array_Write_Test_009__char::tag_impl::test_002__dim2l
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
...

 {
  ...
  {
   for(size_t x=0;x!=_DIM_(v.data);++x)
   {
    ++v.data[x];
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   &hStmt,
   static_cast<remote_fb::protocol::P_USHORT>(cns.db_dialect_Ex.value()),
   "insert into TEST_ARRAY_DIM2L (COL_BINARY_10) values (?) returning TEST_ID;");
 ...
 //----------------------------------------- теперь провер€ем значени€ элементов массива
 structure::str_formatter fSQL("select COL_BINARY_10[%%1,%%2] from TEST_ARRAY_DIM2L where TEST_ID=%1");
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Array_Write_Test_009__char::tag_descr
...
struct WORK_Array_Write_Test_009__char::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Array_Write_Test_009__char::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Array_Write_Test_009__char::tag_impl::func},

const WORK_Array_Write_Test_009__char::tag_descr
 WORK_Array_Write_Test_009__char::sm_Tests[]=
{
 DEF_TEST_DESCR("001",
                test_001)
...
void WORK_Array_Write_Test_009__char::create(TTSO_PushTest*      const pTestPusher,
                                             TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Array.Write.009.char.ptype__%1.%2");
