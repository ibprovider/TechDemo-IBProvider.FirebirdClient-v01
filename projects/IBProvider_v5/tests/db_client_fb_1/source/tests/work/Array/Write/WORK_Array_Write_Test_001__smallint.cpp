...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Array_Write_Test_001__smallint::tag_impl

class WORK_Array_Write_Test_001__smallint::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
 ...
 private:
  typedef db_obj::t_dbvalue__i2             element_type;

  static const isc_api::XSQLVAR_V1::sqltype_type
   c_element_sqltypeid=isc_api::ibp_isc_sql_short;

  static const short
   c_element_blrtypeid=isc_api::ibp_isc_blr_dtype__short;
...
void WORK_Array_Write_Test_001__smallint::tag_impl::test_001
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   "insert into TEST_ARRAY_DIM1 (COL_I2) values (?) returning TEST_ID;");
 ...
 structure::str_formatter fSQL("select COL_I2[%%1] from TEST_ARRAY_DIM1 where TEST_ID=%1");
...
void WORK_Array_Write_Test_001__smallint::tag_impl::test_002__dim2l
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
...

 {
  ...
  for(size_t i=0;i!=nTotalCount;++i,++v)
   arrayData[i]=element_type(v%32117);
 }
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   &hStmt,
   static_cast<remote_fb::protocol::P_USHORT>(cns.db_dialect_Ex.value()),
   "insert into TEST_ARRAY_DIM2L (COL_I2) values (?) returning TEST_ID;");
 ...
 //----------------------------------------- теперь провер€ем значени€ элементов массива
 structure::str_formatter fSQL("select COL_I2[%%1,%%2] from TEST_ARRAY_DIM2L where TEST_ID=%1");
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Array_Write_Test_001__smallint::tag_descr
...
struct WORK_Array_Write_Test_001__smallint::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Array_Write_Test_001__smallint::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Array_Write_Test_001__smallint::tag_impl::func},

const WORK_Array_Write_Test_001__smallint::tag_descr
 WORK_Array_Write_Test_001__smallint::sm_Tests[]=
{
 DEF_TEST_DESCR("001",
                test_001)
...
void WORK_Array_Write_Test_001__smallint::create(TTSO_PushTest*      const pTestPusher,
                                                 TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.Array.Write.001.smallint.ptype__%1.%2");
