...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Array_Read_Test_011__int128::tag_impl

class WORK_Array_Read_Test_011__int128::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
 ...
 private:
  typedef db_obj::t_dbvalue__fb040_int128   element_type;

  static const short
   c_element_blrtypeid=isc_api::ibp_fb040_blr_dtype__int128;
...
void WORK_Array_Read_Test_011__int128::tag_impl::test_001
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 const element_type arrayData[3]=
  {
   db_obj::make_fb040_int128(1,2),
   db_obj::make_fb040_int128(3,4),
   db_obj::make_fb040_int128(5,6),
  };
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   "insert into TEST_ARRAY_DIM1 (COL_INT128) values (?) returning TEST_ID;");
 ...
 structure::str_formatter fSQL("select COL_INT128 from TEST_ARRAY_DIM1 where TEST_ID=%1");
...
void WORK_Array_Read_Test_011__int128::tag_impl::test_002__dim2l
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 {
  element_type v=db_obj::make_fb040_int128(1,20000);

  for(size_t i=0;i!=nTotalCount;++i,++v.data.low,++v.data.high)
   arrayData[i]=v;
 }
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   &hStmt,
   static_cast<remote_fb::protocol::P_USHORT>(cns.db_dialect_Ex.value()),
   "insert into TEST_ARRAY_DIM2L (COL_INT128) values (?) returning TEST_ID;");
 ...
 //----------------------------------------- теперь провер€ем значени€ элементов массива
 structure::str_formatter fSQL("select COL_INT128 from TEST_ARRAY_DIM2L where TEST_ID=%1");
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Array_Read_Test_011__int128::tag_descr
...
struct WORK_Array_Read_Test_011__int128::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Array_Read_Test_011__int128::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Array_Read_Test_011__int128::tag_impl::func},

const WORK_Array_Read_Test_011__int128::tag_descr
 WORK_Array_Read_Test_011__int128::sm_Tests[]=
{
 DEF_TEST_DESCR("001",
                test_001)
...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Array_Read_Test_011__int128

void WORK_Array_Read_Test_011__int128::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Array.Read.011.int128.ptype__%1.%2");
