...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Array_Write_Test_008__timestamp::tag_impl

class WORK_Array_Write_Test_008__timestamp::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
 ...
 private:
  typedef isc_api::t_ibp_isc_timestamp      element_type;

  static const isc_api::XSQLVAR_V1::sqltype_type
   c_element_sqltypeid=isc_api::ibp_isc_sql_timestamp;

  static const short
   c_element_blrtypeid=isc_api::ibp_isc_blr_dtype__timestamp;
...
void WORK_Array_Write_Test_008__timestamp::tag_impl::test_001
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 const element_type arrayData[3]={{1,2},{2,3},{4,5}};
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   "insert into TEST_ARRAY_DIM1 (COL_TS) values (?) returning TEST_ID;");
 ...
 structure::str_formatter fSQL("select COL_TS[%%1] from TEST_ARRAY_DIM1 where TEST_ID=%1");
...
void WORK_Array_Write_Test_008__timestamp::tag_impl::test_002__dim2l
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 {
  element_type v{-100000,123};

  for(size_t i=0;i!=nTotalCount;++i,++v.timestamp_date,v.timestamp_time+=1237)
   arrayData[i]=v;
 }
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   &hStmt,
   static_cast<remote_fb::protocol::P_USHORT>(cns.db_dialect_Ex.value()),
   "insert into TEST_ARRAY_DIM2L (COL_TS) values (?) returning TEST_ID;");
 ...
 //----------------------------------------- теперь провер€ем значени€ элементов массива
 structure::str_formatter fSQL("select COL_TS[%%1,%%2] from TEST_ARRAY_DIM2L where TEST_ID=%1");
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Array_Write_Test_008__timestamp::tag_descr
...
struct WORK_Array_Write_Test_008__timestamp::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Array_Write_Test_008__timestamp::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Array_Write_Test_008__timestamp::tag_impl::func},

const WORK_Array_Write_Test_008__timestamp::tag_descr
 WORK_Array_Write_Test_008__timestamp::sm_Tests[]=
{
 DEF_TEST_DESCR("001",
                test_001)
...
void WORK_Array_Write_Test_008__timestamp::create(TTSO_PushTest*      const pTestPusher,
                                             TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Array.Write.008.timestamp.ptype__%1.%2");
