...
void WORK_Array_Read_Test_012__decfloat16::create(TTSO_PushTest*      const pTestPusher,
                                              TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Array.Read.011.decfloat16.ptype__%1.%2");
