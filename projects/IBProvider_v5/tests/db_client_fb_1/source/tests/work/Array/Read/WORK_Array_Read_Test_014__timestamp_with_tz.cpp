...
class WORK_Array_Read_Test_014__timestamp_with_tz::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
 ...
 private:
  using element_type=isc_api::t_ibp_fb040_timestamp_with_tz;

  static const short
   c_element_blrtypeid=isc_api::ibp_fb040_blr_dtype__timestamp_with_tz;
...
void WORK_Array_Read_Test_014__timestamp_with_tz::tag_impl::test_001
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 const element_type arrayData[3]={{1,2,1439+180},{2,3,1439+181},{4,5,1439+182}};
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   "insert into TEST_ARRAY_DIM1 (COL_TS_WITH_TZ) values (?) returning TEST_ID;");
 ...
 structure::str_formatter fSQL("select COL_TS_WITH_TZ from TEST_ARRAY_DIM1 where TEST_ID=%1");
...
void WORK_Array_Read_Test_014__timestamp_with_tz::tag_impl::test_002__dim2l
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 {
  element_type v{-100000,123,65064};

  for(size_t i=0;i!=nTotalCount;++i,++v.utc_timestamp.timestamp_date,v.utc_timestamp.timestamp_time+=1237)
   arrayData[i]=v;
 }
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   &hStmt,
   static_cast<remote_fb::protocol::P_USHORT>(cns.db_dialect_Ex.value()),
   "insert into TEST_ARRAY_DIM2L (COL_TS_WITH_TZ) values (?) returning TEST_ID;");
 ...
 structure::str_formatter fSQL("select COL_TS_WITH_TZ from TEST_ARRAY_DIM2L where TEST_ID=%1");
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Array_Read_Test_014__timestamp_with_tz::tag_descr
...
struct WORK_Array_Read_Test_014__timestamp_with_tz::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Array_Read_Test_014__timestamp_with_tz::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Array_Read_Test_014__timestamp_with_tz::tag_impl::func},

const WORK_Array_Read_Test_014__timestamp_with_tz::tag_descr
 WORK_Array_Read_Test_014__timestamp_with_tz::sm_Tests[]=
{
 DEF_TEST_DESCR
  ("001",
   test_001)
