...
class WORK_Array_Write_Test_003__bigint::tag_impl
{
 ...
 private:
  ...
  static const isc_api::XSQLVAR_V1::sqltype_type
   c_element_sqltypeid=isc_api::ibp_isc_sql_int64;
...
void WORK_Array_Write_Test_003__bigint::tag_impl::test_001
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 structure::str_formatter fSQL("select COL_I8[%%1] from TEST_ARRAY_DIM1 where TEST_ID=%1");
...
void WORK_Array_Write_Test_003__bigint::tag_impl::test_002__dim2l
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 //----------------------------------------- теперь провер€ем значени€ элементов массива
 structure::str_formatter fSQL("select COL_I8[%%1,%%2] from TEST_ARRAY_DIM2L where TEST_ID=%1");
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Array_Write_Test_003__bigint::tag_descr
...
struct WORK_Array_Write_Test_003__bigint::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Array_Write_Test_003__bigint::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Array_Write_Test_003__bigint::tag_impl::func},

const WORK_Array_Write_Test_003__bigint::tag_descr
 WORK_Array_Write_Test_003__bigint::sm_Tests[]=
{
 DEF_TEST_DESCR("001",
                test_001)
...
void WORK_Array_Write_Test_003__bigint::create(TTSO_PushTest*      const pTestPusher,
                                                TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Array.Write.003.bigint.ptype__%1.%2");
