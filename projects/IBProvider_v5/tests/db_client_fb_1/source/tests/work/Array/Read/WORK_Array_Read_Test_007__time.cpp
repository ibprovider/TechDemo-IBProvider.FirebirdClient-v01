...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Array_Read_Test_007__time::tag_impl

class WORK_Array_Read_Test_007__time::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
...
void WORK_Array_Read_Test_007__time::tag_impl::test_001
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 structure::str_formatter fSQL("select COL_TYPE_TIME from TEST_ARRAY_DIM1 where TEST_ID=%1");
...
void WORK_Array_Read_Test_007__time::tag_impl::test_002__dim2l
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 //----------------------------------------- теперь провер€ем значени€ элементов массива
 structure::str_formatter fSQL("select COL_TYPE_TIME from TEST_ARRAY_DIM2L where TEST_ID=%1");
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Array_Read_Test_007__time::tag_descr
...
struct WORK_Array_Read_Test_007__time::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Array_Read_Test_007__time::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Array_Read_Test_007__time::tag_impl::func},

const WORK_Array_Read_Test_007__time::tag_descr
 WORK_Array_Read_Test_007__time::sm_Tests[]=
{
 DEF_TEST_DESCR("001",
                test_001)
...
void WORK_Array_Read_Test_007__time::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Array.Read.007.time.ptype__%1.%2");
