...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__Types__bigint_001::tag_impl

class WORK_StmtFetch_M__Types__bigint_001::tag_impl LCPI_CPP_CFG__CLASS__FINAL
...
WORK_StmtFetch_M__Types__bigint_001::tag_impl::tag_impl(TTSO_GlobalContext* const pParams,
...
//------------------------------------------------------------------------
WORK_StmtFetch_M__Types__bigint_001::tag_impl::~tag_impl()
{;}

//test interface ---------------------------------------------------------
std::string WORK_StmtFetch_M__Types__bigint_001::tag_impl::get_id()const
{
 return m_TestID;
}//get_id

//------------------------------------------------------------------------
bool WORK_StmtFetch_M__Types__bigint_001::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_StmtFetch_M__Types__bigint_001::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
 ...
 const char* const c_SQL
  ="execute block\n"
   ...
   "as\n"
   "begin\n"
     " X=-9223372036854775808;    suspend;\n"    // 0
     " X=NULL;                    suspend;\n"    // 1
     " X=-2147483648;             suspend;\n"    // 2
     " X=NULL;                    suspend;\n"    // 3
     " X=-32576;                  suspend;\n"    // 4
     " X=NULL;                    suspend;\n"    // 5
     " X=-1;                      suspend;\n"    // 6
     ...
     " X=32575;                   suspend;\n"    // 12
     " X=NULL;                    suspend;\n"    // 13
     " X=2147483647;              suspend;\n"    // 14
     " X=NULL;                    suspend;\n"    // 15
     " X=9223372036854775807;     suspend;\n"    // 16
    "end;";
...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__Types__bigint_001

void WORK_StmtFetch_M__Types__bigint_001::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch_M.Types.bigint.001.ptype__%1");
