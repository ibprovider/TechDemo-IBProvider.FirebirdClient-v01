...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__Types__bigint_002__check_align::tag_impl

class WORK_StmtFetch_M__Types__bigint_002__check_align::tag_impl LCPI_CPP_CFG__CLASS__FINAL
...
WORK_StmtFetch_M__Types__bigint_002__check_align::tag_impl::tag_impl
...
//test interface ---------------------------------------------------------
std::string WORK_StmtFetch_M__Types__bigint_002__check_align::tag_impl::get_id()const
{
 return m_TestID;
}//get_id

//------------------------------------------------------------------------
bool WORK_StmtFetch_M__Types__bigint_002__check_align::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_StmtFetch_M__Types__bigint_002__check_align::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
 ...
 db_obj::t_dbvalue__i8   columnValue=0;
 short                   columnInd=0;
 ...
 const std::array<unsigned char,22> OutMsg__BLR=
 {
  ...
  /* 11 */ isc_api::ibp_isc_blr_dtype__int64,  // data type
  /* 12 */ 0,                                  // data scale
 ...
 OutMsg__DATA_DESCRS[1].m_msg_blrtype            =isc_api::ibp_isc_blr_dtype__int64;
 OutMsg__DATA_DESCRS[1].m_xvar_sqltype           =isc_api::ibp_isc_sql_int64;
 OutMsg__DATA_DESCRS[1].m_xvar_sqlscale          =0;
 OutMsg__DATA_DESCRS[1].m_msg_value_block_size   =8;
 OutMsg__DATA_DESCRS[1].m_msg_value_block_offset =8;
 OutMsg__DATA_DESCRS[1].m_msg_sqlind_offset      =16;
 ...
 OutMsg__DATA_DESCRS[2].m_msg_value_block_offset =18;
 OutMsg__DATA_DESCRS[2].m_msg_sqlind_offset      =24;
 ...
 const char* const c_SQL
  ="execute block\n"
   "returns(A1 CHAR(3) CHARACTER SET NONE, X BIGINT, A2 CHAR(5) CHARACTER SET NONE)\n"
   "as\n"
   "begin\n"
     " A1='SD3';  X=-9223372036854775808; A2='SD3sd';  suspend;\n"    // 0
     " A1='D14';  X=NULL;                 A2='D14d1';  suspend;\n"    // 1
     " A1='125';  X=-2147483648;          A2='12512';  suspend;\n"    // 2
     " A1='236';  X=NULL;                 A2='23623';  suspend;\n"    // 3
     " A1='347';  X=-32576;               A2='34734';  suspend;\n"    // 4
     " A1='458';  X=NULL;                 A2='45845';  suspend;\n"    // 5
     " A1='569';  X=-1;                   A2='56956';  suspend;\n"    // 6
     " A1='670';  X=NULL;                 A2='67067';  suspend;\n"    // 7
     " A1='78X';  X=0;                    A2='78X78';  suspend;\n"    // 8
     " A1='89-';  X=NULL;                 A2='89-89';  suspend;\n"    // 9
     " A1='90W';  X=1;                    A2='90W90';  suspend;\n"    // 10
     " A1='0XE';  X=NULL;                 A2='0XE0x';  suspend;\n"    // 11
     " A1='X-R';  X=32575;                A2='X-Rx-';  suspend;\n"    // 12
     " A1='SD3';  X=NULL;                 A2='SD3sd';  suspend;\n"    // 13
     " A1='D14';  X=2147483647;           A2='D14d1';  suspend;\n"    // 14
     " A1='125';  X=NULL;                 A2='12512';  suspend;\n"    // 15
     " A1='236';  X=9223372036854775807;  A2='23623';  suspend;\n"    // 16
    "end;";
 ...
 struct tag_result
 {
  ...
  const results[]=
 {
  { 0,INT64_MIN  , "SD3", "SD3sd"},  // 0
  {-1,0          , "D14", "D14d1"},  // 1
  { 0,LONG_MIN   , "125", "12512"},  // 2
  {-1,0          , "236", "23623"},  // 3
  { 0,-32576     , "347", "34734"},  // 4
  {-1,0          , "458", "45845"},  // 5
  { 0,-1         , "569", "56956"},  // 6
  ...
  { 0,32575      , "X-R", "X-Rx-"},  // 12
  {-1,0          , "SD3", "SD3sd"},  // 13
  { 0,LONG_MAX   , "D14", "D14d1"},  // 14
  {-1,0          , "125", "12512"},  // 15
  { 0,INT64_MAX  , "236", "23623"},  // 16
 };//results
...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__Types__bigint_002__check_align

void WORK_StmtFetch_M__Types__bigint_002__check_align::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch_M.Types.bigint.002.check_align.ptype__%1");
