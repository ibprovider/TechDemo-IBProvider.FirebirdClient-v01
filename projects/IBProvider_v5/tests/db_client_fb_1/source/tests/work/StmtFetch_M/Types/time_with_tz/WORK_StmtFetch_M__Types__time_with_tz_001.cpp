...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__Types__time_with_tz_001::tag_impl

class WORK_StmtFetch_M__Types__time_with_tz_001::tag_impl LCPI_CPP_CFG__CLASS__FINAL
...
WORK_StmtFetch_M__Types__time_with_tz_001::tag_impl::tag_impl
...
//test interface ---------------------------------------------------------
const char* WORK_StmtFetch_M__Types__time_with_tz_001::tag_impl::get_id()const
{
 return m_TestID.c_str();
}//get_id

//------------------------------------------------------------------------
bool WORK_StmtFetch_M__Types__time_with_tz_001::tag_impl::can_exec()const
{
 assert(m_spParams);

 if(!m_spParams->calc_expression("NE__TIME_WITH_TZ"))
  return false;
...
//------------------------------------------------------------------------
void WORK_StmtFetch_M__Types__time_with_tz_001::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
 ...
 isc_api::t_ibp_fb040_time_with_tz columnValue={};
 short                                  columnInd=0;
 ...
 const char* const c_SQL
  ="execute block\n"
   "returns(X TIME WITH TIME ZONE)\n"
   "as\n"
   "begin\n"
     " X='10:02:30.0000 +03:00';         suspend;\n"    // 0
     " X=NULL;                           suspend;\n"    // 1
     " X='10:02:30.0001 Europe/Moscow';  suspend;\n"    // 2
     " X=NULL;                           suspend;\n"    // 3
     " X='10:02:30.0000 Europe/Moscow';  suspend;\n"    // 4
     " X=NULL;                           suspend;\n"    // 5
   "end;";
 ...
 {
  short                             sqlInd;
  isc_api::t_ibp_fb040_time_with_tz sqlValue;
 }
  const results[]=
 {
  { 0,{253500000, 3*60+1439}},              // 0
  {-1,{0,0}},                               // 1
  { 0,{253500001,     65064}},              // 2
  {-1,{0,0}},                               // 3
  { 0,{253500000,     65064}},              // 4
...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__Types__time_with_tz_001

void WORK_StmtFetch_M__Types__time_with_tz_001::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch_M.Types.time_with_tz.001.ptype__%1");
