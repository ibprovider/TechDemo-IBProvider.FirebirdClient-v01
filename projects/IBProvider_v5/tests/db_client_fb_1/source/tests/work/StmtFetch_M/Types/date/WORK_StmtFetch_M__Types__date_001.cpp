...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__Types__date_001::tag_impl

class WORK_StmtFetch_M__Types__date_001::tag_impl LCPI_CPP_CFG__CLASS__FINAL
...
WORK_StmtFetch_M__Types__date_001::tag_impl::tag_impl(TTSO_GlobalContext* const pParams,
...
//------------------------------------------------------------------------
WORK_StmtFetch_M__Types__date_001::tag_impl::~tag_impl()
{;}

//test interface ---------------------------------------------------------
std::string WORK_StmtFetch_M__Types__date_001::tag_impl::get_id()const
{
 return m_TestID;
}//get_id

//------------------------------------------------------------------------
bool WORK_StmtFetch_M__Types__date_001::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_StmtFetch_M__Types__date_001::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
 ...
 isc_api::t_ibp_isc_date columnValue=0;
 short                   columnInd=0;
 ...
 OutMsg__DATA_DESCRS[0].m_msg_blrtype            =isc_api::ibp_isc_blr_dtype__sql_date;
 OutMsg__DATA_DESCRS[0].m_xvar_sqltype           =isc_api::ibp_isc_sql_type_date;
 ...
 const char* const c_SQL
  ="execute block\n"
   ...
   "as\n"
   "begin\n"
     " X='18.11.1858';     suspend;\n"    // 0
     " X=NULL;             suspend;\n"    // 1
     " X='17.11.1858';     suspend;\n"    // 2
     " X=NULL;             suspend;\n"    // 3
     " X='16.11.1858';     suspend;\n"    // 4
     " X=NULL;             suspend;\n"    // 5
    "end;";
 ...
 {
  short                    sqlInd;
  isc_api::t_ibp_isc_date  sqlValue;
 }
  const results[]=
 {
  { 0,1},     // 0
...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__Types__date_001

void WORK_StmtFetch_M__Types__date_001::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch_M.Types.date.001.ptype__%1");
