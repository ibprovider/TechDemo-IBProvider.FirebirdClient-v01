...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__Types__double_001::tag_impl

class WORK_StmtFetch_M__Types__double_001::tag_impl LCPI_CPP_CFG__CLASS__FINAL
...
WORK_StmtFetch_M__Types__double_001::tag_impl::tag_impl(TTSO_GlobalContext* const pParams,
...
//------------------------------------------------------------------------
WORK_StmtFetch_M__Types__double_001::tag_impl::~tag_impl()
{;}

//test interface ---------------------------------------------------------
std::string WORK_StmtFetch_M__Types__double_001::tag_impl::get_id()const
{
 return m_TestID;
}//get_id

//------------------------------------------------------------------------
bool WORK_StmtFetch_M__Types__double_001::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_StmtFetch_M__Types__double_001::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
 ...
 db_obj::t_dbvalue__r8   columnValue=0;
 short                   columnInd=0;
 ...
 {
  short                  sqlInd;
  db_obj::t_dbvalue__r8  sqlValue;
 }
  const results[]=
 {
  { 0,-12345678901234.5},  // 0
  {-1,0},                  // 1
  { 0,-99999.5},           // 2
  {-1,0},                  // 3
  { 0,-32576},             // 4
...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__Types__double_001

void WORK_StmtFetch_M__Types__double_001::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch_M.Types.double.001.ptype__%1");
