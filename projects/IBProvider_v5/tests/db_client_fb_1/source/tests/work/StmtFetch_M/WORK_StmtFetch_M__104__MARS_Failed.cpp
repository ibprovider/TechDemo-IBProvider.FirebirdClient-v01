...
struct WORK_StmtFetch_M__104__MARS_Failed::tag_rs_descr
{
 size_t cBlocks;
 int    cRows;
};//WORK_StmtFetch_M__104__MARS_Failed::tag_rs_descr

////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__104__MARS_Failed::tag_impl
...
WORK_StmtFetch_M__104__MARS_Failed::tag_impl::tag_impl
...
//------------------------------------------------------------------------
bool WORK_StmtFetch_M__104__MARS_Failed::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_StmtFetch_M__104__MARS_Failed::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__104__MARS_Failed

void WORK_StmtFetch_M__104__MARS_Failed::create(TTSO_PushTest*      const pTestPusher,
                                          TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch_M.104.MARS_Failed.ptype__%1.CursorCount_%2.%3");
