...
struct WORK_StmtFetch_M__105__drop_stmt__v1_no_lazy::tag_rs_descr
{
 size_t cRows;
 size_t cFetch;
};//WORK_StmtFetch_M__105__drop_stmt__v1_no_lazy::tag_rs_descr

////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__105__drop_stmt__v1_no_lazy::tag_impl

class WORK_StmtFetch_M__105__drop_stmt__v1_no_lazy::tag_impl LCPI_CPP_CFG__CLASS__FINAL
...
WORK_StmtFetch_M__105__drop_stmt__v1_no_lazy::tag_impl::tag_impl
...
//------------------------------------------------------------------------
bool WORK_StmtFetch_M__105__drop_stmt__v1_no_lazy::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_StmtFetch_M__105__drop_stmt__v1_no_lazy::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
...
//helper methods ---------------------------------------------------------
const wchar_t*
 WORK_StmtFetch_M__105__drop_stmt__v1_no_lazy::tag_impl::helper__get_StmtFetch__bugcheck_src
...
void WORK_StmtFetch_M__105__drop_stmt__v1_no_lazy::create
                                            ...
                                            TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch_M.105.drop_stmt.v1.ptype__%1.%2");
