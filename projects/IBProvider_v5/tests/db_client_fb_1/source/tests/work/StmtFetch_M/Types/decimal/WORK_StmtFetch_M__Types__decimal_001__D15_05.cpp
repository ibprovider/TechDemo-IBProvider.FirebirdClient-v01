...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__Types__decimal_001__D15_05::tag_impl

class WORK_StmtFetch_M__Types__decimal_001__D15_05::tag_impl LCPI_CPP_CFG__CLASS__FINAL
...
WORK_StmtFetch_M__Types__decimal_001__D15_05::tag_impl::tag_impl
...
//test interface ---------------------------------------------------------
const char* WORK_StmtFetch_M__Types__decimal_001__D15_05::tag_impl::get_id()const
{
 return m_TestID.c_str();
}//get_id

//------------------------------------------------------------------------
bool WORK_StmtFetch_M__Types__decimal_001__D15_05::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_StmtFetch_M__Types__decimal_001__D15_05::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
 ...
 OutMsg__DATA_DESCRS[0].m_xvar_sqlscale          =-5;
 ...
 const char* const c_SQL
  ="execute block\n"
   "returns(X DECIMAL(15,5))\n"
   "as\n"
   "begin\n"
     " X=-1234567890.12345;    suspend;\n"    // 0
     " X=NULL;                 suspend;\n"    // 1
     " X=-99.9;                suspend;\n"    // 2
     " X=NULL;                 suspend;\n"    // 3
     " X=-1.5;                 suspend;\n"    // 4
...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__Types__decimal_001__D15_05

void WORK_StmtFetch_M__Types__decimal_001__D15_05::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch_M.Types.decimal.001.D15_5.ptype__%1");
