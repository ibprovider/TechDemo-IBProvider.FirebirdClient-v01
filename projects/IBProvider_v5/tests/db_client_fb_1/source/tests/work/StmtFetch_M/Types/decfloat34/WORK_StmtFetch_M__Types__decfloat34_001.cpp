...
namespace ibp_test{
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__Types__decfloat34_001::tag_impl

class WORK_StmtFetch_M__Types__decfloat34_001::tag_impl LCPI_CPP_CFG__CLASS__FINAL
...
WORK_StmtFetch_M__Types__decfloat34_001::tag_impl::tag_impl(TTSO_GlobalContext* const pParams,
...
//------------------------------------------------------------------------
WORK_StmtFetch_M__Types__decfloat34_001::tag_impl::~tag_impl()
{;}

//test interface ---------------------------------------------------------
std::string WORK_StmtFetch_M__Types__decfloat34_001::tag_impl::get_id()const
{
 return m_TestID;
}//get_id

//------------------------------------------------------------------------
bool WORK_StmtFetch_M__Types__decfloat34_001::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_StmtFetch_M__Types__decfloat34_001::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
 ...
 isc_api::t_ibp_fb040_decfloat34 columnValue=db_obj::make_fb040_decfloat34(0,0);
 short                           columnInd=0;
 ...
 {
  short                        sqlInd;
  isc_api::t_ibp_fb040_decfloat34  sqlValue;
 }
  const results[]=
 {
  { 0,db_obj::make_fb040_decfloat34(1332, 11675370927725477888)}, // 0
  {-1,db_obj::make_fb040_decfloat34(0,0)},                        // 1
  { 0,db_obj::make_fb040_decfloat34(0, 2452209997103235072)},     // 2
  {-1,db_obj::make_fb040_decfloat34(0,0)},                        // 3
  { 0,db_obj::make_fb040_decfloat34(1, 2452209997103235072)},     // 4
  { 0,db_obj::make_fb040_decfloat34(0, 2451928522126524416)},     // 5
 };//results
...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_M__Types__decfloat34_001

void WORK_StmtFetch_M__Types__decfloat34_001::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch_M.Types.decfloat34.001.ptype__%1");
