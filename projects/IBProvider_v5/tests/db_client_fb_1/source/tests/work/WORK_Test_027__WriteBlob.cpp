...
class WORK_Test_027__WriteBlob::tag_impl
{
 ...
 private:
  static const wchar_t* helper__get_write_blob_bugcheck_src
                          (remote_fb::RemoteFB__Connector* pConnector);

  static const wchar_t* helper__get_write_blob_subsystem_id
                          (remote_fb::RemoteFB__Connector* pConnector);
};//class WORK_Test_027__WriteBlob::tag_impl
...
#ifdef NDEBUG
void WORK_Test_027__WriteBlob::tag_impl::test_001__bug_check__zero_blob_handle
 ...
 for(;;)
 {
  ...
  catch(const ibp::t_ibp_error& exc)
  {
   ...
   errSvc::check_err_rec__blob_err__bug_check__bad_blob_handle
    (tracer,
     exc.get_record(0),
     helper__get_write_blob_bugcheck_src(spConnector),
     L"#001");
...
#ifdef NDEBUG
void WORK_Test_027__WriteBlob::tag_impl::test_002__bug_check__null_blob_id
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 for(;;)
 {
  ...
  catch(const ibp::t_ibp_error& exc)
  {
   ...
   errSvc::check_err_rec__blob_err__write_into_closed_blob
    (tracer,
     exc.get_record(0),
     helper__get_write_blob_subsystem_id(spConnector));
...
#ifdef NDEBUG
void WORK_Test_027__WriteBlob::tag_impl::test_003__bug_check__bad_owner_cn
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
...
void WORK_Test_027__WriteBlob::tag_impl::test_004__bug_check__write_to_open_blob
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
...
void WORK_Test_027__WriteBlob::tag_impl::test_100__err__hack_close_blob
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
...
const wchar_t* WORK_Test_027__WriteBlob::tag_impl::helper__get_write_blob_bugcheck_src
                                           (remote_fb::RemoteFB__Connector* const pConnector)
{
 ...
 switch(const auto v=pConnector->GetPort()->get_protocol_version())
 {
  ...
  case remote_fb::protocol::FB_PROTOCOL_VERSION12:
   return L"RemoteFB__API_P12__WriteBlob::exec";

  case remote_fb::protocol::FB_PROTOCOL_VERSION13:
   return L"RemoteFB__API_P13__WriteBlob::exec";
...
}//helper__get_write_blob_bugcheck_src

//------------------------------------------------------------------------
const wchar_t* WORK_Test_027__WriteBlob::tag_impl::helper__get_write_blob_subsystem_id
                                           (remote_fb::RemoteFB__Connector* const pConnector)
{
 assert(pConnector);
...
}//helper__get_write_blob_subsystem_id

////////////////////////////////////////////////////////////////////////////////
//struct WORK_Test_027__WriteBlob::tag_descr
...
struct WORK_Test_027__WriteBlob::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Test_027__WriteBlob::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Test_027__WriteBlob::tag_impl::func},

const WORK_Test_027__WriteBlob::tag_descr
 WORK_Test_027__WriteBlob::sm_Tests[]=
{
#ifdef NDEBUG
 DEF_TEST_DESCR
...
void WORK_Test_027__WriteBlob::create(TTSO_PushTest*      const pTestPusher,
                                      TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.027.WriteBlob.ptype__%1.%2");
