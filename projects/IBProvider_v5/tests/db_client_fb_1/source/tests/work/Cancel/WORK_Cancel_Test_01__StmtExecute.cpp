...
class WORK_Cancel_Test_01__StmtExecute::tag_thread LCPI_CPP_CFG__CLASS__FINAL
...
//thread interface -------------------------------------------------------
const char* WORK_Cancel_Test_01__StmtExecute::tag_thread::thread_name_impl()const
{
 return "thread";
}//thread_name_impl
...
class WORK_Cancel_Test_01__StmtExecute::tag_impl LCPI_CPP_CFG__CLASS__FINAL
...
//test interface ---------------------------------------------------------
const char* WORK_Cancel_Test_01__StmtExecute::tag_impl::get_id()const
{
