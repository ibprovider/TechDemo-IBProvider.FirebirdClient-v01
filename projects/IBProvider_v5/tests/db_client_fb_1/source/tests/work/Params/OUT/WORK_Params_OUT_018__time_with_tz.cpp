...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Params_OUT_018__time_with_tz::tag_impl

class WORK_Params_OUT_018__time_with_tz::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
...
};//class WORK_Params_OUT_018__time_with_tz

////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_OUT_018__time_with_tz::tag_impl::tag_data_005
...
struct WORK_Params_OUT_018__time_with_tz::tag_impl::tag_data_005
{
 public:
  ...
  isc_api::t_ibp_fb040_time_with_tz result_value;
  short                             result_sqlind;
};//struct WORK_Params_OUT_018__time_with_tz::tag_impl::tag_data_005

////////////////////////////////////////////////////////////////////////////////

#define DEF_DATA(sql,nullable,value_t,value_tz,sqlind) \
 {sql,nullable,{value_t,value_tz},sqlind},

//------------------------------------------------------------------------

const WORK_Params_OUT_018__time_with_tz::tag_impl::tag_data_005
 WORK_Params_OUT_018__time_with_tz::tag_impl::sm_data_005[]=
{
 DEF_DATA
  ("insert into TEST_MODIFY_ROW (COL_TIME_WITH_TZ) values(NULL) returning COL_TIME_WITH_TZ;",
   /*nullable*/ true,
   /*value*/    0,0,
   /*sqlind*/  -1)

 DEF_DATA
  ("insert into TEST_MODIFY_ROW (COL_TIME_WITH_TZ) values('10:02:30.9876 +03:00') returning COL_TIME_WITH_TZ;",
   /*nullable*/ true,
   /*value*/    253509876 , 3*60+1439,
   /*sqlind*/   0)

 DEF_DATA
  ("insert into TEST_MODIFY_ROW (COL_TIME_WITH_TZ) values('10:02:30.4321 Europe/Moscow') returning COL_TIME_WITH_TZ;",
   /*nullable*/ false,
   /*value*/    253504321,65064,
...
void WORK_Params_OUT_018__time_with_tz::tag_impl::test_005_generic
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 for(size_t iData=0;iData!=_DIM_(sm_data_005);++iData)
 {
  ...
  isc_api::t_ibp_fb040_time_with_tz xparam0_value={65897,54321};
  short                             xparam0_ind=c_test_005__dummy_sqlind;

  xsqlda->sqlvar[0].sqltype  =isc_api::ibp_fb040_sql_time_with_tz|(Data.nullable?1:0);
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_OUT_018__time_with_tz::tag_descr
...
struct WORK_Params_OUT_018__time_with_tz::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Params_OUT_018__time_with_tz::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Params_OUT_018__time_with_tz::tag_impl::func},

const WORK_Params_OUT_018__time_with_tz::tag_descr
 WORK_Params_OUT_018__time_with_tz::sm_Tests[]=
{
...
void WORK_Params_OUT_018__time_with_tz::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Params.OUT.018.time_with_tz.ptype__%1.%2");
