...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Params_OUT_001__short::tag_impl

class WORK_Params_OUT_001__short::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
...
void WORK_Params_OUT_001__short::tag_impl::test_001
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   "insert into TEST_MODIFY_ROW (COL_SMALLINT) values (1234) returning COL_SMALLINT;");
 ...
 signed __int16 xparam0_value=0;
...
void WORK_Params_OUT_001__short::tag_impl::test_002_null
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   &hStmt,
   (unsigned short)cns.db_dialect_Ex.value(),
   "insert into TEST_MODIFY_ROW (COL_SMALLINT) values (NULL) returning COL_SMALLINT;");
 ...
 signed __int16 xparam0_value=4321;
 short          xparam0_ind=-1234;
...
void WORK_Params_OUT_001__short::tag_impl::test_003_scale2
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   &hStmt,
   (unsigned short)cns.db_dialect_Ex.value(),
   "insert into NUM (N_3_2) values (1.23) returning N_3_2;");
...
void WORK_Params_OUT_001__short::tag_impl::test_004_scale3_null
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   &hStmt,
   (unsigned short)cns.db_dialect_Ex.value(),
   "insert into NUM (N_4_3) values (NULL) returning N_4_3;");
 ...
 signed __int16 xparam0_value=432;
 short          xparam0_ind=-1234;
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_OUT_001__short::tag_impl::tag_data_005
...
const WORK_Params_OUT_001__short::tag_impl::tag_data_005
 WORK_Params_OUT_001__short::tag_impl::sm_data_005[]=
{
 DEF_DATA("insert into NUM (N_1_0) values(NULL) returning N_1_0;",
           /*nullable*/ true,
           /*scale*/    0,
           /*value*/    0,
           /*sqlind*/  -1)

 DEF_DATA("insert into NUM (N_1_0) values(-3) returning N_1_0;",
           /*nullable*/ true,
           /*scale*/    0,
           /*value*/    -3,
           /*sqlind*/   0)
 ...
 DEF_DATA("insert into NUM (N_1_1) values(-0.4) returning N_1_1;",
           /*nullable*/ true,
           /*scale*/    -1,
           /*value*/    -4,
           /*sqlind*/   0)
...
void WORK_Params_OUT_001__short::tag_impl::test_005_generic
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 for(size_t iData=0;iData!=_DIM_(sm_data_005);++iData)
 {
  ...
  signed __int16 xparam0_value=-23431;
  short          xparam0_ind=c_test_005__dummy_sqlind;

  xsqlda->sqlvar[0].sqltype  =isc_api::ibp_isc_sql_short|(Data.nullable?1:0);
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_OUT_001__short::tag_descr
...
struct WORK_Params_OUT_001__short::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Params_OUT_001__short::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Params_OUT_001__short::tag_impl::func},

const WORK_Params_OUT_001__short::tag_descr
 WORK_Params_OUT_001__short::sm_Tests[]=
{
 DEF_TEST_DESCR("001",
                test_001)
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Params.OUT.001.short.ptype__%1.%2");
