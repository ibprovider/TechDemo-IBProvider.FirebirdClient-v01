...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Params_OUT_006__type_time::tag_impl

class WORK_Params_OUT_006__type_time::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_OUT_006__type_time::tag_impl::tag_data_005
...
struct WORK_Params_OUT_006__type_time::tag_impl::tag_data_005
{
 public:
  ...
  isc_api::t_ibp_isc_time result_value;
  short                   result_sqlind;
};//struct WORK_Params_OUT_006__type_time::tag_impl::tag_data_005
...
const WORK_Params_OUT_006__type_time::tag_impl::tag_data_005
 WORK_Params_OUT_006__type_time::tag_impl::sm_data_005[]=
{
 DEF_DATA("insert into TEST_MODIFY_ROW (COL_TYPE_TIME) values(NULL) returning COL_TYPE_TIME;",
           /*nullable*/ true,
           /*value*/    0,
           /*sqlind*/  -1)

 DEF_DATA("insert into TEST_MODIFY_ROW (COL_TYPE_TIME) values('23:17:32.4321') returning COL_TYPE_TIME;",
           /*nullable*/ true,
           /*value*/    4321+c_mult_sec*32+c_mult_min*17+c_mult_hour*23,
           /*sqlind*/   0)

 DEF_DATA("insert into TEST_MODIFY_ROW (COL_TYPE_TIME) values('21:17:32.4321') returning COL_TYPE_TIME;",
           /*nullable*/ false,
           /*value*/    4321+c_mult_sec*32+c_mult_min*17+c_mult_hour*21,
...
void WORK_Params_OUT_006__type_time::tag_impl::test_005_generic
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 for(size_t iData=0;iData!=_DIM_(sm_data_005);++iData)
 {
  ...
  isc_api::t_ibp_isc_time xparam0_value=-23431;
  short                   xparam0_ind=c_test_005__dummy_sqlind;

  xsqlda->sqlvar[0].sqltype  =isc_api::ibp_isc_sql_type_time|(Data.nullable?1:0);
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_OUT_006__type_time::tag_descr
...
struct WORK_Params_OUT_006__type_time::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Params_OUT_006__type_time::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Params_OUT_006__type_time::tag_impl::func},

const WORK_Params_OUT_006__type_time::tag_descr
 WORK_Params_OUT_006__type_time::sm_Tests[]=
{
...
void WORK_Params_OUT_006__type_time::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Params.OUT.006.type_time.ptype__%1.%2");
