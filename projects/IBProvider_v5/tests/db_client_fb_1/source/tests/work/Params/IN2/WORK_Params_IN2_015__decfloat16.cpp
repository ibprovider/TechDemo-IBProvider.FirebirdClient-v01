...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Params_IN2_015__decfloat16::tag_impl

class WORK_Params_IN2_015__decfloat16::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
 ...
 public:
  ...
  static const short c_xvalue_typeID=isc_api::ibp_fb040_sql_decfloat16;
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_IN2_015__decfloat16::tag_data_block

void WORK_Params_IN2_015__decfloat16::tag_impl::tag_data_block::check(const self_type& x)const
{
...
void WORK_Params_IN2_015__decfloat16::tag_impl::test_001
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   "execute block (IN1 DECFLOAT(16)=?, IN2 DECFLOAT(16)=?)\n"
   "returns (OUT1 DECFLOAT(16), OUT2 DECFLOAT(16))\n"
   "as\n"
   "BEGIN\n"
   " OUT1=IN1;\n"
   " OUT2=IN2;\n"
...

 {
  ...
  //----------------------------------------
  const isc_api::t_ibp_fb040_decfloat16 c_value1=db_obj::make_fb040_decfloat16(8592597888436471684);
  const isc_api::t_ibp_fb040_decfloat16 c_value2=db_obj::make_fb040_decfloat16(94331737550101941);

  //----------------------------------------
  memset(&in_data_block,c_guard_byte,sizeof(in_data_block));

  in_data_block.value1 =c_value1;
  in_data_block.sqlind1=0;

  in_data_block.value2 =c_value2;
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_IN2_015__decfloat16::tag_descr
...
struct WORK_Params_IN2_015__decfloat16::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Params_IN2_015__decfloat16::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Params_IN2_015__decfloat16::tag_impl::func},

const WORK_Params_IN2_015__decfloat16::tag_descr
 WORK_Params_IN2_015__decfloat16::sm_Tests[]=
{
 DEF_TEST_DESCR("001",
                test_001)
};//sm_Tests
...
void WORK_Params_IN2_015__decfloat16::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Params.IN2.014.decfloat16.ptype__%1.%2");
