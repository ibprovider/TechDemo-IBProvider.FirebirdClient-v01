...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Params_OUT_004__float::tag_impl

class WORK_Params_OUT_004__float::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_OUT_004__float::tag_impl::tag_data_005
...
const WORK_Params_OUT_004__float::tag_impl::tag_data_005
 WORK_Params_OUT_004__float::tag_impl::sm_data_005[]=
{
 DEF_DATA("insert into TEST_MODIFY_ROW (COL_FLOAT) values(NULL) returning COL_FLOAT;",
           /*nullable*/ true,
           /*value*/    0,
           /*sqlind*/  -1)

 DEF_DATA("insert into TEST_MODIFY_ROW (COL_FLOAT) values(-3) returning COL_FLOAT;",
           /*nullable*/ true,
           /*value*/    -3,
           /*sqlind*/   0)
 ...
 DEF_DATA("insert into TEST_MODIFY_ROW (COL_FLOAT) values(-0.5) returning COL_FLOAT;",
           /*nullable*/ true,
           /*value*/    -0.5F,
           /*sqlind*/   0)
};//sm_data_005
...
void WORK_Params_OUT_004__float::tag_impl::test_005_generic
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 for(size_t iData=0;iData!=_DIM_(sm_data_005);++iData)
 {
  ...
  float  xparam0_value=-23431;
  short  xparam0_ind=c_test_005__dummy_sqlind;

  xsqlda->sqlvar[0].sqltype  =isc_api::ibp_isc_sql_float|(Data.nullable?1:0);
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_OUT_004__float::tag_descr
...
struct WORK_Params_OUT_004__float::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Params_OUT_004__float::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Params_OUT_004__float::tag_impl::func},

const WORK_Params_OUT_004__float::tag_descr
 WORK_Params_OUT_004__float::sm_Tests[]=
{
...
void WORK_Params_OUT_004__float::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Params.OUT.004.float.ptype__%1.%2");
