...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Params_OUT_012__array::tag_impl

class WORK_Params_OUT_012__array::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
...
};//class WORK_Params_OUT_012__array

////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_OUT_012__array::tag_impl::tag_data_005
...
const WORK_Params_OUT_012__array::tag_impl::tag_data_005
 WORK_Params_OUT_012__array::tag_impl::sm_data_005[]=
{
...
void WORK_Params_OUT_012__array::tag_impl::test_005_generic
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 for(size_t iData=0;iData!=_DIM_(sm_data_005);++iData)
 {
  ...
  //----------------------------------------
  const db_obj::DB_IBARRAYID c_dummy_array_id={0xFFFFFFFE,0xFFFFFFFD};

  XSQLDA_V1_Wrapper xsqlda(1);

  xsqlda->sqld=1;

  db_obj::DB_IBARRAYID xparam0_value=c_dummy_array_id;
  short                xparam0_ind=c_test_005__dummy_sqlind;

  xsqlda->sqlvar[0].sqltype  =isc_api::ibp_isc_sql_array|(Data.nullable?1:0);
  ...
  //-----------------------------------------
  if(xparam0_value==c_dummy_array_id)
  {
  ...
  if(Data.result_sqlind==0 || !Data.nullable)
  {
   ...
   {
    tracer(tso_msg_error,-1)<<L"we waith the not zero result arrayID!"<<send;
   }
  }
  else
  if(xparam0_value!=db_obj::__null_ib_blob_id)
  {
   tracer(tso_msg_error,-1)<<L"we waith the zero result arrayID!"<<send;
  }//else
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_OUT_012__array::tag_descr
...
struct WORK_Params_OUT_012__array::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Params_OUT_012__array::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Params_OUT_012__array::tag_impl::func},

const WORK_Params_OUT_012__array::tag_descr
 WORK_Params_OUT_012__array::sm_Tests[]=
{
...
void WORK_Params_OUT_012__array::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Params.OUT.012.array.ptype__%1.%2");
