...
class WORK_Params_IN2_017__timestamp_with_tz::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
 ...
 public:
  ...
  using xvalue_type=isc_api::t_ibp_fb040_timestamp_with_tz;

  static const short c_xvalue_typeID=isc_api::ibp_fb040_sql_timestamp_with_tz;
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_IN2_017__timestamp_with_tz::tag_data_block

void WORK_Params_IN2_017__timestamp_with_tz::tag_impl::tag_data_block::check(const self_type& x)const
{
...
void WORK_Params_IN2_017__timestamp_with_tz::tag_impl::test_001
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   "execute block (IN1 TIMESTAMP WITH TIME ZONE=?, IN2 TIMESTAMP WITH TIME ZONE=?)\n"
   "returns (OUT1 TIMESTAMP WITH TIME ZONE, OUT2 TIMESTAMP WITH TIME ZONE)\n"
   "as\n"
   "BEGIN\n"
   " OUT1=IN1;\n"
   " OUT2=IN2;\n"
...

 {
  ...
  in_data_block.value1 ={1, 75671234   ,1439+180};  // 18.11.1858 05:06:07.1234 +3:00
  in_data_block.sqlind1=0;

  in_data_block.value2 ={-2, 773999999 ,65064}; // 15.11.1858 23:59:59.9999 Europe/Moscow
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_IN2_017__timestamp_with_tz::tag_descr
...
struct WORK_Params_IN2_017__timestamp_with_tz::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Params_IN2_017__timestamp_with_tz::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Params_IN2_017__timestamp_with_tz::tag_impl::func},

const WORK_Params_IN2_017__timestamp_with_tz::tag_descr
 WORK_Params_IN2_017__timestamp_with_tz::sm_Tests[]=
{
 DEF_TEST_DESCR("001",
                test_001)
};//sm_Tests
...
void WORK_Params_IN2_017__timestamp_with_tz::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Params.IN2.017.timestamp_with_tz.ptype__%1.%2");
