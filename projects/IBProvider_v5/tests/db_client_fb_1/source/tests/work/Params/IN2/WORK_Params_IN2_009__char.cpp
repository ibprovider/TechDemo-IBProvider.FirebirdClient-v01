...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Params_IN2_009__char::tag_impl

class WORK_Params_IN2_009__char::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
 ...
 public:
  ...
  struct tag_xvalue
  {
   ...
   public:
    ...
    {
     return memcmp(this->data,x.data,sizeof(x.data))==0;
    }
  };//struct tag_xvalue

  typedef tag_xvalue                        xvalue_type;

  static const short c_xvalue_typeID=isc_api::ibp_isc_sql_text;
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_IN2_009__char::tag_data_block

void WORK_Params_IN2_009__char::tag_impl::tag_data_block::check(const self_type& x)const
{
...
void WORK_Params_IN2_009__char::tag_impl::test_001
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 svc::RemoteFB_Connector__StmtPrepare
  (tracer,
   ...
   "execute block (IN1 CHAR(7) CHARACTER SET NONE=?, IN2 CHAR(7) CHARACTER SET NONE=?)\n"
   "returns (OUT1 CHAR(7) CHARACTER SET NONE, OUT2 CHAR(7) CHARACTER SET NONE)\n"
   "as\n"
   "BEGIN\n"
   " OUT1=IN1;\n"
   " OUT2=IN2;\n"
...

 {
  ...
  in_data_block.value1 ={'A','b','C','d','E','f',' '};
  in_data_block.sqlind1=0;

  in_data_block.value2 ={'q','R','p','O','g','W','z'};;
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_IN2_009__char::tag_descr
...
struct WORK_Params_IN2_009__char::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Params_IN2_009__char::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Params_IN2_009__char::tag_impl::func},

const WORK_Params_IN2_009__char::tag_descr
 WORK_Params_IN2_009__char::sm_Tests[]=
{
 DEF_TEST_DESCR("001",
                test_001)
};//sm_Tests
...
void WORK_Params_IN2_009__char::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Params.IN2.009.char.ptype__%1.%2");
