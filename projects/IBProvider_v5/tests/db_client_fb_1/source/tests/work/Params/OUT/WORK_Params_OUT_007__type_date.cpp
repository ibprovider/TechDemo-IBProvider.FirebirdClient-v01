...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Params_OUT_007__type_date::tag_impl

class WORK_Params_OUT_007__type_date::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_OUT_007__type_date::tag_impl::tag_data_005
...
struct WORK_Params_OUT_007__type_date::tag_impl::tag_data_005
{
 public:
  ...
  isc_api::t_ibp_isc_date result_value;
  short                   result_sqlind;
};//struct WORK_Params_OUT_007__type_date::tag_impl::tag_data_005
...
const WORK_Params_OUT_007__type_date::tag_impl::tag_data_005
 WORK_Params_OUT_007__type_date::tag_impl::sm_data_005[]=
{
 DEF_DATA("insert into TEST_MODIFY_ROW (COL_TYPE_DATE) values(NULL) returning COL_TYPE_DATE;",
           /*nullable*/ true,
           /*value*/    0,
           /*sqlind*/  -1)

 DEF_DATA("insert into TEST_MODIFY_ROW (COL_TYPE_DATE) values('18.11.1858') returning COL_TYPE_DATE;",
           /*nullable*/ true,
           /*value*/    1,
           /*sqlind*/   0)

 DEF_DATA("insert into TEST_MODIFY_ROW (COL_TYPE_DATE) values('16.11.1858') returning COL_TYPE_DATE;",
           /*nullable*/ false,
           /*value*/    -1,
...
void WORK_Params_OUT_007__type_date::tag_impl::test_005_generic
                                            ...
                                            const TTSO_TestData_v2&   Data)
{
 ...
 for(size_t iData=0;iData!=_DIM_(sm_data_005);++iData)
 {
  ...
  isc_api::t_ibp_isc_date xparam0_value=-23431;
  short                   xparam0_ind=c_test_005__dummy_sqlind;

  xsqlda->sqlvar[0].sqltype  =isc_api::ibp_isc_sql_type_date|(Data.nullable?1:0);
...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_Params_OUT_007__type_date::tag_descr
...
struct WORK_Params_OUT_007__type_date::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class WORK_Params_OUT_007__type_date::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,WORK_Params_OUT_007__type_date::tag_impl::func},

const WORK_Params_OUT_007__type_date::tag_descr
 WORK_Params_OUT_007__type_date::sm_Tests[]=
{
...
void WORK_Params_OUT_007__type_date::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 //-----------------------------------------
 structure::str_formatter ftestID("RemoteFB.WORK.Params.OUT.007.type_date.ptype__%1.%2");
