...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Params__001__nulls::tag_null_it
...
class  WORK_Params__001__nulls::tag_null_it
{
 ...
 public: //typedefs ------------------------------------------------------
  typedef structure::t_stl_vector
           <size_t,
            TTSO_MemoryAllocator>                     indexes_type;
...
WORK_Params__001__nulls::tag_null_it::tag_null_it(size_t const Size,
                                                  size_t const Bits)
 :m_Size(Size)
 ,m_Bits(Bits)
{
...
//------------------------------------------------------------------------
WORK_Params__001__nulls::tag_null_it::~tag_null_it()
{;}

//------------------------------------------------------------------------
const WORK_Params__001__nulls::tag_null_it::indexes_type&
 WORK_Params__001__nulls::tag_null_it::point()const
{
 return m_indexes;
}//point

//------------------------------------------------------------------------
bool WORK_Params__001__nulls::tag_null_it::ok()const
{
 assert(m_Bits>0);
 assert(m_Bits<=m_Size);
...
//------------------------------------------------------------------------
void WORK_Params__001__nulls::tag_null_it::next()
{
 assert(m_Bits>0);
 assert(m_Bits<=m_Size);
...
//------------------------------------------------------------------------
bool WORK_Params__001__nulls::tag_null_it::has(size_t const index)const
{
 return std::binary_search(m_indexes.cbegin(),m_indexes.cend(),index);
}//has

////////////////////////////////////////////////////////////////////////////////
//class WORK_Params__001__nulls::tag_impl
...
WORK_Params__001__nulls::tag_impl::tag_impl(TTSO_GlobalContext* const pParams,
...
//------------------------------------------------------------------------
WORK_Params__001__nulls::tag_impl::~tag_impl()
{;}
...
//------------------------------------------------------------------------
bool WORK_Params__001__nulls::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_Params__001__nulls::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
 ...
 try
 {
  for(;null_it.ok();null_it.next())
  {
   ...
   for(size_t i=0;i!=m_nFields;++i)
   {
    ...
    {
     fieldValues[i] =static_cast<db_obj::t_dbvalue__i4>(i);
     fieldSqlInds[i]=0;
    }
   }//for i
...
void WORK_Params__001__nulls::create(TTSO_PushTest*      const pTestPusher,
                                     TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.Params.001.nulls.%1.%2.fields_%3.nulls_%4");
