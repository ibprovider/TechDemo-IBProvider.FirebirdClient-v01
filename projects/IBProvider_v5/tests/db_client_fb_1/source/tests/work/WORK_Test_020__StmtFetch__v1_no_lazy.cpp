...
class WORK_Test_020__StmtFetch__v1_no_lazy::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
...
const wchar_t*
 WORK_Test_020__StmtFetch__v1_no_lazy::tag_impl::helper__get_fetch_bugcheck_src
                                           (remote_fb::RemoteFB__Connector* pConnector)
{
 assert(pConnector);
