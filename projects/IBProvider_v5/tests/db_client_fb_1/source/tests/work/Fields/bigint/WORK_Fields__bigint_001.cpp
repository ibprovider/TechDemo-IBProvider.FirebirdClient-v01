...
namespace ibp_test{
////////////////////////////////////////////////////////////////////////////////
//class WORK_Fields__bigint_001::tag_impl
...
WORK_Fields__bigint_001::tag_impl::tag_impl(TTSO_GlobalContext* const pParams,
...
//------------------------------------------------------------------------
WORK_Fields__bigint_001::tag_impl::~tag_impl()
{;}

//test interface ---------------------------------------------------------
std::string WORK_Fields__bigint_001::tag_impl::get_id()const
{
 return m_TestID;
}//get_id

//------------------------------------------------------------------------
bool WORK_Fields__bigint_001::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_Fields__bigint_001::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Fields__bigint_001

void WORK_Fields__bigint_001::create(TTSO_PushTest*      const pTestPusher,
                                     TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.Fields.bigint.001.ptype__%1");
