...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Test_006__Commit::tag_impl

class WORK_Test_006__Commit::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
 ...
 public:
  static void test_004__mult_trs
               (TTSO_GlobalContext*     pParams,
                context_type*           pCtx,
                const TTSO_TestData_v2& Data);
 ...
 private:
  static const wchar_t* helper__get_Commit_bugcheck_src
...
void WORK_Test_006__Commit::tag_impl::test_001
...
void WORK_Test_006__Commit::tag_impl::test_002__bug_check__zero_tr_handle
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 for(;;)
 {
  ...
  catch(const ibp::t_ibp_error& exc)
  {
   ...
   errSvc::check_err_rec__tr_err__bug_check__bad_tr_handle
    (tracer,
     exc.get_record(0),
     helper__get_Commit_bugcheck_src(spConnector),
     L"#001");
...
void WORK_Test_006__Commit::tag_impl::test_003__bug_check__bad_tr_owner
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 for(;;)
 {
  ...
  catch(const ibp::t_ibp_error& exc)
  {
   ...
   errSvc::check_err_rec__tr_err__bug_check__bad_tr_handle
    (tracer,
     exc.get_record(0),
     helper__get_Commit_bugcheck_src(spConnector1),
     L"#003");
...
void WORK_Test_006__Commit::tag_impl::test_004__mult_trs
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
 ...
 //-----------------------------------------
 structure::t_stl_vector
  <svc::remote_fb_tr_handle_type,
   TTSO_MemoryAllocator>                     handles;
...
void WORK_Test_006__Commit::tag_impl::test_005__err__bad_tr_handle
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx,
                                            const TTSO_TestData_v2&   Data)
{
...
const wchar_t* WORK_Test_006__Commit::tag_impl::helper__get_Commit_bugcheck_src
                                           (remote_fb::RemoteFB__Connector* const pConnector)
{
 ...
 switch(const auto v=pConnector->GetPort()->get_protocol_version())
 {
  ...
  case remote_fb::protocol::FB_PROTOCOL_VERSION12:
   return L"RemoteFB__API_P12__Commit::exec";

  case remote_fb::protocol::FB_PROTOCOL_VERSION13:
   return L"RemoteFB__API_P13__Commit::exec";
...
}//helper__get_Commit_bugcheck_src

////////////////////////////////////////////////////////////////////////////////
//struct WORK_Test_006__Commit::tag_descr
...
};//class WORK_Test_006__Commit::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR2(sign,func,exec_rules)                            \
 {sign,WORK_Test_006__Commit::tag_impl::func,exec_rules},

#define DEF_TEST_DESCR(sign,func)                                        \
 DEF_TEST_DESCR2(sign,func,nullptr)

const WORK_Test_006__Commit::tag_descr
 WORK_Test_006__Commit::sm_Tests[]=
{
 DEF_TEST_DESCR
  ("001",
   test_001)
...
void WORK_Test_006__Commit::create(TTSO_PushTest*      const pTestPusher,
                                   TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.006.Trans.Commit.ptype__%1.%2");
