...
////////////////////////////////////////////////////////////////////////////////
//class WORK_Blob_Test_01__WriteAndReadBinData__v1_no_lazy::tag_impl
...
WORK_Blob_Test_01__WriteAndReadBinData__v1_no_lazy::tag_impl::tag_impl
...
//------------------------------------------------------------------------
bool WORK_Blob_Test_01__WriteAndReadBinData__v1_no_lazy::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_Blob_Test_01__WriteAndReadBinData__v1_no_lazy::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
...
void WORK_Blob_Test_01__WriteAndReadBinData__v1_no_lazy::create
                                            ...
                                            TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.Blob.01.WriteAndReadBinData.v1.ptype__%1.Flush_%2.%3.BlobSize_%4.BlockSize_%5");
 ...
 it.add(0,_DIM_(g_TestCfg__RemoteFB__ProtocolTypes__no_lazy)-1);
...
//------------------------------------------------------------------------
void WORK_Blob_Test_01__WriteAndReadBinData__v1_no_lazy::helper__create
                                           (TTSO_PushTest*      const pTestPusher,
                                            TTSO_GlobalContext* const pParams,
...
//------------------------------------------------------------------------
void WORK_Blob_Test_01__WriteAndReadBinData__v1_no_lazy::helper__create_test
                                           (TTSO_PushTest*       const pTestPusher,
                                            TTSO_GlobalContext*  const pParams,
                                            structure::str_formatter&  ftestID,
                                            const TTSO_TestData_v2&   Data,
