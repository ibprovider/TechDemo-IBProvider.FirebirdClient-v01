...
struct WORK_StmtFetch_Test_107__commit::tag_rs_descr
{
 size_t cRows;
 size_t cFetch;
};//WORK_StmtFetch_Test_107__commit::tag_rs_descr

////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_Test_107__commit::tag_impl

class WORK_StmtFetch_Test_107__commit::tag_impl LCPI_CPP_CFG__CLASS__FINAL
...
WORK_StmtFetch_Test_107__commit::tag_impl::tag_impl
...
//test interface ---------------------------------------------------------
const char* WORK_StmtFetch_Test_107__commit::tag_impl::get_id()const
{
 return m_TestID.c_str();
}//get_id

//------------------------------------------------------------------------
bool WORK_StmtFetch_Test_107__commit::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_StmtFetch_Test_107__commit::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
...
void WORK_StmtFetch_Test_107__commit::create(TTSO_PushTest*      const pTestPusher,
                                            TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch.107.commit.ptype__%1.%2");
