...
namespace ibp_test{
////////////////////////////////////////////////////////////////////////////////
//struct WORK_StmtFetch_Test_13__sql_commit_retaining::tag_rs_descr

struct WORK_StmtFetch_Test_13__sql_commit_retaining::tag_rs_descr
{
 size_t cRows;
 size_t cFetch;
};//WORK_StmtFetch_Test_13__sql_commit_retaining::tag_rs_descr

////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_Test_13__sql_commit_retaining::tag_impl
...
WORK_StmtFetch_Test_13__sql_commit_retaining::tag_impl::tag_impl
...
//test interface ---------------------------------------------------------
std::string WORK_StmtFetch_Test_13__sql_commit_retaining::tag_impl::get_id()const
{
 return m_TestID;
}//get_id

//------------------------------------------------------------------------
bool WORK_StmtFetch_Test_13__sql_commit_retaining::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_StmtFetch_Test_13__sql_commit_retaining::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_Test_13__sql_commit_retaining

void WORK_StmtFetch_Test_13__sql_commit_retaining::create
                                            ...
                                            TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch.13.sql_commit_retaining.ptype__%1.%2");
