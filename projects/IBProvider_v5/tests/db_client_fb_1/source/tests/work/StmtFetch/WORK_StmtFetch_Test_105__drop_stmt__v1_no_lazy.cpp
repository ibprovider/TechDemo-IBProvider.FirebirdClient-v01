...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_StmtFetch_Test_105__drop_stmt__v1_no_lazy::tag_rs_descr

struct WORK_StmtFetch_Test_105__drop_stmt__v1_no_lazy::tag_rs_descr
{
 size_t cRows;
 size_t cFetch;
};//WORK_StmtFetch_Test_105__drop_stmt__v1_no_lazy::tag_rs_descr

////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_Test_105__drop_stmt__v1_no_lazy::tag_impl

class WORK_StmtFetch_Test_105__drop_stmt__v1_no_lazy::tag_impl LCPI_CPP_CFG__CLASS__FINAL
 :public structure::t_basic_smart_interface_impl__dynamic<TTSO_Test,TTSO_MemoryAllocator>
{
 ...
 private:
  static const wchar_t* helper__get_StmtFetch__bugcheck_src(remote_fb::RemoteFB__Connector* pConnector);
...
WORK_StmtFetch_Test_105__drop_stmt__v1_no_lazy::tag_impl::tag_impl
...
//test interface ---------------------------------------------------------
std::string WORK_StmtFetch_Test_105__drop_stmt__v1_no_lazy::tag_impl::get_id()const
{
 return m_TestID;
}//get_id

//------------------------------------------------------------------------
bool WORK_StmtFetch_Test_105__drop_stmt__v1_no_lazy::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_StmtFetch_Test_105__drop_stmt__v1_no_lazy::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
 ...
 for(;;)
 {
  ...
  catch(const ibp::t_ibp_error& exc)
  {
   ...
   errSvc::check_err_rec__stmt_err__bug_check__bad_stmt_handle
    (tracer,
     exc.get_record(0),
     helper__get_StmtFetch__bugcheck_src(spConnector),
     L"#001");
...
//helper methods ---------------------------------------------------------
const wchar_t*
 WORK_StmtFetch_Test_105__drop_stmt__v1_no_lazy::tag_impl::helper__get_StmtFetch__bugcheck_src
...
}//helper__get_StmtFetch__bugcheck_src

////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_Test_105__drop_stmt__v1_no_lazy

void WORK_StmtFetch_Test_105__drop_stmt__v1_no_lazy::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch.105.drop_stmt.v1.ptype__%1.%2");
 ...
 for(;it;++it)
 {
  ...
  Data.m_RemoteFB__ProtocolType=g_TestCfg__RemoteFB__ProtocolTypes__no_lazy[it[1]];
