...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch__Types__smallint_002__check_align::tag_impl

class WORK_StmtFetch__Types__smallint_002__check_align::tag_impl LCPI_CPP_CFG__CLASS__FINAL
...
WORK_StmtFetch__Types__smallint_002__check_align::tag_impl::tag_impl
...
//test interface ---------------------------------------------------------
const char* WORK_StmtFetch__Types__smallint_002__check_align::tag_impl::get_id()const
{
 return m_TestID.c_str();
}//get_id

//------------------------------------------------------------------------
bool WORK_StmtFetch__Types__smallint_002__check_align::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_StmtFetch__Types__smallint_002__check_align::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch__Types__smallint_002__check_align

void WORK_StmtFetch__Types__smallint_002__check_align::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch.Types.smallint.002.check_align.ptype__%1");
