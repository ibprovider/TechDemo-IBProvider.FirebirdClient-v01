...
////////////////////////////////////////////////////////////////////////////////
//struct WORK_StmtFetch_Test_105__drop_stmt__v2_lazy_send::tag_rs_descr

struct WORK_StmtFetch_Test_105__drop_stmt__v2_lazy_send::tag_rs_descr
{
 size_t cRows;
 size_t cFetch;
};//WORK_StmtFetch_Test_105__drop_stmt__v2_lazy_send::tag_rs_descr

////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_Test_105__drop_stmt__v2_lazy_send::tag_impl

class WORK_StmtFetch_Test_105__drop_stmt__v2_lazy_send::tag_impl LCPI_CPP_CFG__CLASS__FINAL
...
WORK_StmtFetch_Test_105__drop_stmt__v2_lazy_send::tag_impl::tag_impl
...
//test interface ---------------------------------------------------------
const char* WORK_StmtFetch_Test_105__drop_stmt__v2_lazy_send::tag_impl::get_id()const
{
 return m_TestID.c_str();
}//get_id

//------------------------------------------------------------------------
bool WORK_StmtFetch_Test_105__drop_stmt__v2_lazy_send::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_StmtFetch_Test_105__drop_stmt__v2_lazy_send::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
...
//helper methods ---------------------------------------------------------
const wchar_t*
 WORK_StmtFetch_Test_105__drop_stmt__v2_lazy_send::tag_impl::helper__get_StmtFetch__bugcheck_src
...
void WORK_StmtFetch_Test_105__drop_stmt__v2_lazy_send::create
                              ...
                              TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch.105.drop_stmt.v2.ptype__%1.%2");
