...
////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_Test_001__nulls::tag_null_it
...
WORK_StmtFetch_Test_001__nulls::tag_null_it::tag_null_it
                             (size_t const Size,
                              size_t const Bits)
 :m_Size(Size)
 ,m_Bits(Bits)
...
//------------------------------------------------------------------------
const WORK_StmtFetch_Test_001__nulls::tag_null_it::indexes_type&
 WORK_StmtFetch_Test_001__nulls::tag_null_it::point()const
{
 return m_indexes;
}//point

//------------------------------------------------------------------------
bool WORK_StmtFetch_Test_001__nulls::tag_null_it::ok()const
{
 assert(m_Bits>0);
 assert(m_Bits<=m_Size);
...
//------------------------------------------------------------------------
void WORK_StmtFetch_Test_001__nulls::tag_null_it::next()
{
 assert(m_Bits>0);
 assert(m_Bits<=m_Size);
...
//------------------------------------------------------------------------
bool WORK_StmtFetch_Test_001__nulls::tag_null_it::has(size_t const index)const
{
 return std::binary_search(m_indexes.cbegin(),m_indexes.cend(),index);
}//has

////////////////////////////////////////////////////////////////////////////////
//class WORK_StmtFetch_Test_001__nulls::tag_impl

class WORK_StmtFetch_Test_001__nulls::tag_impl LCPI_CPP_CFG__CLASS__FINAL
...
WORK_StmtFetch_Test_001__nulls::tag_impl::tag_impl(TTSO_GlobalContext* const pParams,
...
//------------------------------------------------------------------------
WORK_StmtFetch_Test_001__nulls::tag_impl::~tag_impl()
{;}

//test interface ---------------------------------------------------------
std::string WORK_StmtFetch_Test_001__nulls::tag_impl::get_id()const
{
 return m_TestID;
}//get_id

//------------------------------------------------------------------------
bool WORK_StmtFetch_Test_001__nulls::tag_impl::can_exec()const
{
 assert(m_spParams);
...
//------------------------------------------------------------------------
void WORK_StmtFetch_Test_001__nulls::tag_impl::run(context_type* const pCtx)const
{
 assert(pCtx);
 assert(m_spParams);
...
void WORK_StmtFetch_Test_001__nulls::create(TTSO_PushTest*      const pTestPusher,
                                     TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter
  ftestID("RemoteFB.WORK.StmtFetch.001.nulls.%1.%2.fields_%3.nulls_%4");
