...
class INET_PortFactory_Test_003__Analyze_v3__inet4::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
...
//------------------------------------------------------------------------
const INET_PortFactory_Test_003__Analyze_v3__inet4::tag_impl::tag_data_vx_001
 INET_PortFactory_Test_003__Analyze_v3__inet4::tag_impl::sm_data__001[]=
{
 DEF_DATA(nullptr,
          false,
          L"",
 ...
 DEF_DATA(L"inet4://localhost/base",
          true,
          L"localhost",
          L"",
          L"base")
...
//------------------------------------------------------------------------
void INET_PortFactory_Test_003__Analyze_v3__inet4::tag_impl::test__001
                                            ...
                                            context_type*       const pCtx)
{
 ...
 for(const tag_data_vx_001& Data : sm_data__001)
 {
  ...
  const bool result=remote_fb_inet_factory::RemoteFB__PortFactory__INET::Analyze_v3__inet4
                                           (Data.src,
                                            &result__hostName,
                                            &result__portName,
                                            &result__dbName);
...
//------------------------------------------------------------------------
const INET_PortFactory_Test_003__Analyze_v3__inet4::tag_impl::tag_data_vx_002
 INET_PortFactory_Test_003__Analyze_v3__inet4::tag_impl::sm_data__002[]=
{
 DEF_DATA(L"inet4:// :/ ",
          L" ")
 DEF_DATA(L"inet4:// : / ",
...
//------------------------------------------------------------------------
void INET_PortFactory_Test_003__Analyze_v3__inet4::tag_impl::test__002__err_no_port
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
 ...
 for(const tag_data_vx_002& Data : sm_data__002)
 {
  ...
  try
  {
   remote_fb_inet_factory::RemoteFB__PortFactory__INET::Analyze_v3__inet4
                                           (Data.src,
                                            &result__hostName,
                                            &result__portName,
                                            &result__dbName);
...
//------------------------------------------------------------------------
const INET_PortFactory_Test_003__Analyze_v3__inet4::tag_impl::tag_data_vx_003
 INET_PortFactory_Test_003__Analyze_v3__inet4::tag_impl::sm_data__003[]=
{
 DEF_DATA(L"inet4://")
 DEF_DATA(L"inet4:///")
 DEF_DATA(L"inet4://:p/")
 ...
 DEF_DATA(L"inet4://[]sssss/")
 DEF_DATA(L"inet4://[]sssss:p/")
};//sm_data_v3__002
...
//------------------------------------------------------------------------
void INET_PortFactory_Test_003__Analyze_v3__inet4::tag_impl::test__003__err_bad_format
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
////////////////////////////////////////////////////////////////////////////////
//struct INET_PortFactory_Test_003__Analyze_v3__inet4::tag_descr
...
struct INET_PortFactory_Test_003__Analyze_v3__inet4::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class INET_PortFactory_Test_003__Analyze_v3__inet4::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                                         \
 {sign,INET_PortFactory_Test_003__Analyze_v3__inet4::tag_impl::func},

const INET_PortFactory_Test_003__Analyze_v3__inet4::tag_descr
 INET_PortFactory_Test_003__Analyze_v3__inet4::sm_Tests[]=
{
 DEF_TEST_DESCR
  ("001",
   test__001)
...
void INET_PortFactory_Test_003__Analyze_v3__inet4::create
                                            ...
                                            TTSO_GlobalContext* const pParams)
{
 ...
 structure::str_formatter ftestID("RemoteFB.INET.RemotePortFactory.003.Analyze_v3__inet4.%1");
