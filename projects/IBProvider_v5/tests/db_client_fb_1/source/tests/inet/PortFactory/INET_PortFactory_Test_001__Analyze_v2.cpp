...
//------------------------------------------------------------------------
const INET_PortFactory_Test_001__Analyze_v2::tag_impl::tag_data_vx_001
 INET_PortFactory_Test_001__Analyze_v2::tag_impl::sm_data__001[]=
{
 DEF_DATA(nullptr,
          false,
          L"",
 ...
 DEF_DATA(L" : ", //host name with one char
          false,
          L"",
          L"",
          L"")
...
//------------------------------------------------------------------------
void INET_PortFactory_Test_001__Analyze_v2::tag_impl::test__001
                                            ...
                                            context_type*       const pCtx)
{
 ...
 for(const tag_data_vx_001& Data : sm_data__001)
 {
  ...
  const bool result=remote_fb_inet_factory::RemoteFB__PortFactory__INET::Analyze_v2
                                           (Data.src,
                                            &result__hostName,
                                            &result__portName,
                                            &result__dbName);
...
//------------------------------------------------------------------------
const INET_PortFactory_Test_001__Analyze_v2::tag_impl::tag_data_vx_002
 INET_PortFactory_Test_001__Analyze_v2::tag_impl::sm_data__002[]=
{
 DEF_DATA(L" /: ",
          L" ")
 DEF_DATA(L" / : ",
...
//------------------------------------------------------------------------
void INET_PortFactory_Test_001__Analyze_v2::tag_impl::test__002__err_no_port
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
 ...
 for(const tag_data_vx_002& Data : sm_data__002)
 {
  ...
  try
  {
   remote_fb_inet_factory::RemoteFB__PortFactory__INET::Analyze_v2
                                           (Data.src,
                                            &result__hostName,
                                            &result__portName,
                                            &result__dbName);
...
//------------------------------------------------------------------------
const INET_PortFactory_Test_001__Analyze_v2::tag_impl::tag_data_vx_003
 INET_PortFactory_Test_001__Analyze_v2::tag_impl::sm_data__003[]=
{
 DEF_DATA(L"[]asd:")
 DEF_DATA(L"[]asd:base")

 DEF_DATA(L"[]asd/p:base")
};//sm_data_v2__002
...
//------------------------------------------------------------------------
void INET_PortFactory_Test_001__Analyze_v2::tag_impl::test__003__err_bad_format
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
////////////////////////////////////////////////////////////////////////////////
//struct INET_PortFactory_Test_001__Analyze_v2::tag_descr
...
struct INET_PortFactory_Test_001__Analyze_v2::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class INET_PortFactory_Test_001__Analyze_v2::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                                         \
 {sign,INET_PortFactory_Test_001__Analyze_v2::tag_impl::func},

const INET_PortFactory_Test_001__Analyze_v2::tag_descr
 INET_PortFactory_Test_001__Analyze_v2::sm_Tests[]=
{
 DEF_TEST_DESCR
  ("001",
   test__001)
...
void INET_PortFactory_Test_001__Analyze_v2::create(TTSO_PushTest*      pTestPusher,
                                   TTSO_GlobalContext* pParams)
{
 assert(pTestPusher!=nullptr);
 assert(pParams!=nullptr);

 structure::str_formatter ftestID("RemoteFB.INET.RemotePortFactory.001.Analyze_v2.%1");
