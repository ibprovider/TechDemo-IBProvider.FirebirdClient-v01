...
////////////////////////////////////////////////////////////////////////////////
//struct INET_Socket_Test_003__inet4::tag_impl::tag_data_02

struct INET_Socket_Test_003__inet4::tag_impl::tag_data_02
{
 public:
  const wchar_t* host;
};//struct INET_Socket_Test_003__inet4::tag_data_02

////////////////////////////////////////////////////////////////////////////////

struct INET_Socket_Test_003__inet4::tag_impl::tag_data_02wp
{
 public:
  const wchar_t* host;
  const wchar_t* port;
};//struct INET_Socket_Test_003__inet4::tag_data_02wp

////////////////////////////////////////////////////////////////////////////////
//TEST 11

void INET_Socket_Test_003__inet4::tag_impl::test_11__connect2
...
void INET_Socket_Test_003__inet4::tag_impl::test_11__connect2__ip6
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
const INET_Socket_Test_003__inet4::tag_impl::tag_data_02
 INET_Socket_Test_003__inet4::tag_impl::sm_data_12[]=
{
...
//------------------------------------------------------------------------
void INET_Socket_Test_003__inet4::tag_impl::test_12__connect2_to_localhost
...
const INET_Socket_Test_003__inet4::tag_impl::tag_data_02wp
 INET_Socket_Test_003__inet4::tag_impl::sm_data_12wp[]=
{
...
//------------------------------------------------------------------------
void INET_Socket_Test_003__inet4::tag_impl::test_12__connect2_to_localhost_with_port
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
void INET_Socket_Test_003__inet4::tag_impl::test_13__connect2__fail__unk_host
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
void INET_Socket_Test_003__inet4::tag_impl::test_14__clone_connection
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
////////////////////////////////////////////////////////////////////////////////
//struct INET_Socket_Test_003__inet4::tag_data_15

#define DEF_DATA(host,port_name) {host,port_name},

const INET_Socket_Test_003__inet4::tag_impl::tag_data_02wp
 INET_Socket_Test_003__inet4::tag_impl::sm_data_15[]=
{
 DEF_DATA(L"localhost",
          L"yyyy")
 DEF_DATA(L"localhost",
...
//------------------------------------------------------------------------
void INET_Socket_Test_003__inet4::tag_impl::test_15__connect2__bad_ports
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
//------------------------------------------------------------------------
void INET_Socket_Test_003__inet4::tag_impl::test_16__connect2__failed_to_connect
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
//------------------------------------------------------------------------
void INET_Socket_Test_003__inet4::tag_impl::test_17__connect2__failed_to_connect__ip4
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
//------------------------------------------------------------------------
void INET_Socket_Test_003__inet4::tag_impl::test_18__connect2__failed_to_connect__ip6
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
////////////////////////////////////////////////////////////////////////////////
//struct INET_Socket_Test_003__inet4::tag_descr
...
struct INET_Socket_Test_003__inet4::tag_descr
{
 ...
 public:
  ...
  func_type   Func;
};//class INET_Socket_Test_003__inet4::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR(sign,func)                            \
 {sign,INET_Socket_Test_003__inet4::tag_impl::func},

const INET_Socket_Test_003__inet4::tag_descr
 INET_Socket_Test_003__inet4::sm_Tests[]=
{
 //-----------------------------------------
 DEF_TEST_DESCR
  ("11.connect2",
...
void INET_Socket_Test_003__inet4::create(TTSO_PushTest*      const pTestPusher,
                                         TTSO_GlobalContext* const pParams)
{
 assert(pTestPusher!=nullptr);
 assert(pParams!=nullptr);

 structure::str_formatter ftestID("RemoteFB.INET.Socket.003.inet4.%1");
