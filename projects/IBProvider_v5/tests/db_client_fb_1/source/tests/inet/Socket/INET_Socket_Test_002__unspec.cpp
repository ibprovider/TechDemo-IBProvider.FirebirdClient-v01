...
////////////////////////////////////////////////////////////////////////////////
//class INET_Socket_Test_002__unspec::tag_impl

class INET_Socket_Test_002__unspec::tag_impl LCPI_CPP_CFG__CLASS__FINAL
{
 private:
 ...
 public:
  ...
  static void test_11__connect2__ip6
               (TTSO_GlobalContext* pParams,
                context_type*       pCtx);
...
////////////////////////////////////////////////////////////////////////////////
//struct INET_Socket_Test_002__unspec::tag_impl::tag_data_02

struct INET_Socket_Test_002__unspec::tag_impl::tag_data_02
{
 public:
  const wchar_t* host;
};//struct INET_Socket_Test_002__unspec::tag_data_02

////////////////////////////////////////////////////////////////////////////////

struct INET_Socket_Test_002__unspec::tag_impl::tag_data_02wp
{
 public:
  const wchar_t* host;
  const wchar_t* port;
};//struct INET_Socket_Test_002__unspec::tag_data_02wp

////////////////////////////////////////////////////////////////////////////////
//TEST 11

void INET_Socket_Test_002__unspec::tag_impl::test_11__connect2
...
void INET_Socket_Test_002__unspec::tag_impl::test_11__connect2__ip6
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
const INET_Socket_Test_002__unspec::tag_impl::tag_data_02
 INET_Socket_Test_002__unspec::tag_impl::sm_data_12[]=
{
 DEF_DATA(L"localhost")
 DEF_DATA(L"127.0.0.1")
 DEF_DATA(L"")
};//sm_data_12
...
//------------------------------------------------------------------------
void INET_Socket_Test_002__unspec::tag_impl::test_12__connect2_to_localhost
...
const INET_Socket_Test_002__unspec::tag_impl::tag_data_02wp
 INET_Socket_Test_002__unspec::tag_impl::sm_data_12wp[]=
{
 DEF_DATA(L"localhost",L"3050")
 DEF_DATA(L"127.0.0.1",L"3050")
 DEF_DATA(L"",L"3050")
 DEF_DATA(L"localhost",L"gds_db")
 DEF_DATA(L"127.0.0.1",L"gds_db")
 DEF_DATA(L"",L"gds_db")
};//sm_data_12wp
...
//------------------------------------------------------------------------
void INET_Socket_Test_002__unspec::tag_impl::test_12__connect2_to_localhost_with_port
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
void INET_Socket_Test_002__unspec::tag_impl::test_13__connect2__fail__unk_host
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
void INET_Socket_Test_002__unspec::tag_impl::test_14__clone_connection
                                           (TTSO_GlobalContext* const pParams,
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
////////////////////////////////////////////////////////////////////////////////
//struct INET_Socket_Test_002__unspec::tag_data_15

#define DEF_DATA(host,port_name) {host,port_name},

const INET_Socket_Test_002__unspec::tag_impl::tag_data_02wp
 INET_Socket_Test_002__unspec::tag_impl::sm_data_15[]=
{
 DEF_DATA(L"localhost",
          L"yyyy")
 DEF_DATA(L"localhost",
...
//------------------------------------------------------------------------
void INET_Socket_Test_002__unspec::tag_impl::test_15__connect2__bad_ports
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
//------------------------------------------------------------------------
void INET_Socket_Test_002__unspec::tag_impl::test_16__connect2__failed_to_connect
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
 ...
 for(;;)
 {
  ...
  catch(const ibp::t_ibp_error& exc)
  {
   ...
   _TSO_CHECK(exc.get_record_count()==2);
...
//------------------------------------------------------------------------
void INET_Socket_Test_002__unspec::tag_impl::test_17__connect2__failed_to_connect__ip4
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
//------------------------------------------------------------------------
void INET_Socket_Test_002__unspec::tag_impl::test_18__connect2__failed_to_connect__ip6
                                           (TTSO_GlobalContext* const DEBUG_CODE(pParams),
                                            context_type*       const pCtx)
{
 assert(pParams!=nullptr);
...
////////////////////////////////////////////////////////////////////////////////
//struct INET_Socket_Test_002__unspec::tag_descr
...
};//class INET_Socket_Test_002__unspec::tag_descr

////////////////////////////////////////////////////////////////////////////////

#define DEF_TEST_DESCR2(sign,func,exec_rules)                            \
 {sign,INET_Socket_Test_002__unspec::tag_impl::func,exec_rules},

#define DEF_TEST_DESCR(sign,func)                                        \
 DEF_TEST_DESCR2(sign,func,nullptr)

const INET_Socket_Test_002__unspec::tag_descr
 INET_Socket_Test_002__unspec::sm_Tests[]=
{
 DEF_TEST_DESCR
  ("11.connect2",
   test_11__connect2)
...
void INET_Socket_Test_002__unspec::create(TTSO_PushTest*      const pTestPusher,
                                          TTSO_GlobalContext* const pParams)
{
 assert(pTestPusher!=nullptr);
 assert(pParams!=nullptr);

 structure::str_formatter ftestID("RemoteFB.INET.Socket.002.unspec.%1");
 ...
 for(const tag_descr& d : sm_Tests)
 {
  ...
  const TTSO_TestPtr
   spTest(new TTSO_TestFunc(pParams,
                            ftestID.c_str(),
                            d.Func,
                            d.pExecRules));
