...
@SET TEST_PARAMS=/thread_count 8 /auto /log_dir "_logs\fb04-0" /log_file_prefix fb04-0 /inet_host HOME4 /db d:\database\FB_04_0_0\ibp_test_fb40_d3.gdb /db_user GAMER /db_password vermut /new_db_dir d:\database\ram\ /isc_api_library fbclient_40.dll /cn_str "remote:protocol=12" /dbms "FB-4" %*
