...
@SET TEST_PARAMS=/thread_count 4 /auto /log_dir _log\fb02-5-6 /log_file_prefix "fb02-5-6" /inet_host vxp2-fb02-5-6 /db e:\database\ibp_test_fb02-5-6_d3.gdb /db_user GAMER /db_password vermut /new_db_dir e:\database\ /isc_api_library fbclient.dll /cn_str "remote:protocol=12;remote:protocol_arch=symmetric,generic"/dbms "FB-2.5" %*
